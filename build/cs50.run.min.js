...
* Copyright (c) 2012 AUTHORS.txt; Licensed MIT, GPL */
(function(d,c){d.effects.transfer=function(a){return this.queue(function(){var m=d(this),l=d(a.options.to),k=l.offset(),j={top:k.top,left:k.left,height:l.innerHeight(),width:l.innerWidth()},i=m.offset(),b=d('<div class="ui-effects-transfer"></div>').appendTo(document.body).addClass(a.options.className).css({top:i.top,left:i.left,height:m.innerHeight(),width:m.innerWidth(),position:"absolute"}).animate(j,a.duration,a.options.easing,function(){b.remove(),a.callback&&a.callback.apply(m[0],arguments),m.dequeue()})})}})(jQuery);(function(){function af(b,n,m){if(b===n){return 0!==b||1/b==1/n}if(null==b||null==n){return b===n}b._chain&&(b=b._wrapped);n._chain&&(n=n._wrapped);if(b.isEqual&&at.isFunction(b.isEqual)){return b.isEqual(n)}if(n.isEqual&&at.isFunction(n.isEqual)){return n.isEqual(b)}var l=ao.call(b);if(l!=ao.call(n)){return !1}switch(l){case"[object String]":return b==""+n;case"[object Number]":return b!=+b?n!=+n:0==b?1/b==1/n:b==+n;case"[object Date]":case"[object Boolean]":return +b==+n;case"[object RegExp]":return b.source==n.source&&b.global==n.global&&b.multiline==n.multiline&&b.ignoreCase==n.ignoreCase}if("object"!=typeof b||"object"!=typeof n){return !1}for(var k=m.length;k--;){if(m[k]==b){return !0}}m.push(b);var k=0,j=!0;if("[object Array]"==l){if(k=b.length,j=k==n.length){for(;k--&&(j=k in b==k in n&&af(b[k],n[k],m));){}}}else{if("constructor" in b!="constructor" in n||b.constructor!=n.constructor){return !1}for(var i in b){if(at.has(b,i)&&(k++,!(j=at.has(n,i)&&af(b[i],n[i],m)))){break}}if(j){for(i in n){if(at.has(n,i)&&!k--){break}}j=!k}}m.pop();return j}var ae=this,U=ae._,al={},ap=Array.prototype,aj=Object.prototype,ar=ap.slice,S=ap.unshift,ao=aj.toString,Q=aj.hasOwnProperty,R=ap.forEach,h=ap.map,ak=ap.reduce,ai=ap.reduceRight,ag=ap.filter,ad=ap.every,ac=ap.some,ah=ap.indexOf,aa=ap.lastIndexOf,aj=Array.isArray,f=Object.keys,ab=Function.prototype.bind,at=function(b){return new an(b)};"undefined"!==typeof exports?("undefined"!==typeof module&&module.exports&&(exports=module.exports=at),exports._=at):ae._=at;at.VERSION="1.3.3";var aq=at.each=at.forEach=function(b,l,k){if(b!=null){if(R&&b.forEach===R){b.forEach(l,k)}else{if(b.length===+b.length){for(var j=0,i=b.length;j<i;j++){if(j in b&&l.call(k,b[j],j,b)===al){break}}}else{for(j in b){if(at.has(b,j)&&l.call(k,b[j],j,b)===al){break}}}}}};at.map=at.collect=function(j,l,i){var k=[];if(j==null){return k}if(h&&j.map===h){return j.map(l,i)}aq(j,function(b,n,m){k[k.length]=l.call(i,b,n,m)});if(j.length===+j.length){k.length=j.length}return k};at.reduce=at.foldl=at.inject=function(b,l,k,j){var i=arguments.length>2;b==null&&(b=[]);if(ak&&b.reduce===ak){j&&(l=at.bind(l,j));return i?b.reduce(l,k):b.reduce(l)}aq(b,function(n,m,o){if(i){k=l.call(j,k,n,m,o)}else{k=n;i=true}});if(!i){throw new TypeError("Reduce of empty array with no initial value")}return k};at.reduceRight=at.foldr=function(b,m,l,k){var j=arguments.length>2;b==null&&(b=[]);if(ai&&b.reduceRight===ai){k&&(m=at.bind(m,k));return j?b.reduceRight(m,l):b.reduceRight(m)}var i=at.toArray(b).reverse();k&&!j&&(m=at.bind(m,k));return j?at.reduce(i,m,l,k):at.reduce(i,m)};at.find=at.detect=function(j,l,i){var k;Y(j,function(b,n,m){if(l.call(i,b,n,m)){k=b;return true}});return k};at.filter=at.select=function(j,l,i){var k=[];if(j==null){return k}if(ag&&j.filter===ag){return j.filter(l,i)}aq(j,function(b,n,m){l.call(i,b,n,m)&&(k[k.length]=b)});return k};at.reject=function(j,l,i){var k=[];if(j==null){return k}aq(j,function(b,n,m){l.call(i,b,n,m)||(k[k.length]=b)});return k};at.every=at.all=function(j,l,i){var k=true;if(j==null){return k}if(ad&&j.every===ad){return j.every(l,i)}aq(j,function(b,n,m){if(!(k=k&&l.call(i,b,n,m))){return al}});return !!k};var Y=at.some=at.any=function(b,k,j){k||(k=at.identity);var i=false;if(b==null){return i}if(ac&&b.some===ac){return b.some(k,j)}aq(b,function(m,l,n){if(i||(i=k.call(j,m,l,n))){return al}});return !!i};at.include=at.contains=function(j,k){var i=false;if(j==null){return i}if(ah&&j.indexOf===ah){return j.indexOf(k)!=-1}return i=Y(j,function(b){return b===k})};at.invoke=function(b,j){var i=ar.call(arguments,2);return at.map(b,function(k){return(at.isFunction(j)?j||k:k[j]).apply(k,i)})};at.pluck=function(b,i){return at.map(b,function(j){return j[i]})};at.max=function(b,k,j){if(!k&&at.isArray(b)&&b[0]===+b[0]){return Math.max.apply(Math,b)}if(!k&&at.isEmpty(b)){return -Infinity}var i={computed:-Infinity};aq(b,function(m,l,n){l=k?k.call(j,m,l,n):m;l>=i.computed&&(i={value:m,computed:l})});return i.value};at.min=function(b,k,j){if(!k&&at.isArray(b)&&b[0]===+b[0]){return Math.min.apply(Math,b)}if(!k&&at.isEmpty(b)){return Infinity}var i={computed:Infinity};aq(b,function(m,l,n){l=k?k.call(j,m,l,n):m;l<i.computed&&(i={value:m,computed:l})});return i.value};at.shuffle=function(j){var i=[],k;aq(j,function(b,l){k=Math.floor(Math.random()*(l+1));i[l]=i[k];i[k]=b});return i};at.sortBy=function(b,k,j){var i=at.isFunction(k)?k:function(l){return l[k]};return at.pluck(at.map(b,function(m,l,n){return{value:m,criteria:i.call(j,m,l,n)}}).sort(function(m,l){var o=m.criteria,n=l.criteria;return o===void 0?1:n===void 0?-1:o<n?-1:o>n?1:0}),"value")};at.groupBy=function(b,k){var j={},i=at.isFunction(k)?k:function(l){return l[k]};aq(b,function(m,l){var n=i(m,l);(j[n]||(j[n]=[])).push(m)});return j};at.sortedIndex=function(b,m,l){l||(l=at.identity);for(var k=0,j=b.length;k<j;){var i=k+j>>1;l(b[i])<l(m)?k=i+1:j=i}return k};at.toArray=function(b){return !b?[]:at.isArray(b)||at.isArguments(b)?ar.call(b):b.toArray&&at.isFunction(b.toArray)?b.toArray():at.values(b)};at.size=function(b){return at.isArray(b)?b.length:at.keys(b).length};at.first=at.head=at.take=function(j,i,k){return i!=null&&!k?ar.call(j,0,i):j[0]};at.initial=function(j,i,k){return ar.call(j,0,j.length-(i==null||k?1:i))};at.last=function(j,i,k){return i!=null&&!k?ar.call(j,Math.max(j.length-i,0)):j[j.length-1]};at.rest=at.tail=function(j,i,k){return ar.call(j,i==null||k?1:i)};at.compact=function(b){return at.filter(b,function(i){return !!i})};at.flatten=function(b,i){return at.reduce(b,function(j,k){if(at.isArray(k)){return j.concat(i?k:at.flatten(k))}j[j.length]=k;return j},[])};at.without=function(b){return at.difference(b,ar.call(arguments,1))};at.uniq=at.unique=function(b,k,j){var j=j?at.map(b,j):b,i=[];b.length<3&&(k=true);at.reduce(j,function(n,m,l){if(k?at.last(n)!==m||!n.length:!at.include(n,m)){n.push(m);i.push(b[l])}return n},[]);return i};at.union=function(){return at.uniq(at.flatten(arguments,true))};at.intersection=at.intersect=function(b){var i=ar.call(arguments,1);return at.filter(at.uniq(b),function(j){return at.every(i,function(k){return at.indexOf(k,j)>=0})})};at.difference=function(b){var i=at.flatten(ar.call(arguments,1),true);return at.filter(b,function(j){return !at.include(i,j)})};at.zip=function(){for(var b=ar.call(arguments),k=at.max(at.pluck(b,"length")),j=Array(k),i=0;i<k;i++){j[i]=at.pluck(b,""+i)}return j};at.indexOf=function(b,k,j){if(b==null){return -1}var i;if(j){j=at.sortedIndex(b,k);return b[j]===k?j:-1}if(ah&&b.indexOf===ah){return b.indexOf(k)}j=0;for(i=b.length;j<i;j++){if(j in b&&b[j]===k){return j}}return -1};at.lastIndexOf=function(j,i){if(j==null){return -1}if(aa&&j.lastIndexOf===aa){return j.lastIndexOf(i)}for(var k=j.length;k--;){if(k in j&&j[k]===i){return k}}return -1};at.range=function(j,i,n){if(arguments.length<=1){i=j||0;j=0}for(var n=arguments[2]||1,m=Math.max(Math.ceil((i-j)/n),0),l=0,k=Array(m);l<m;){k[l++]=j;j=j+n}return k};var W=function(){};at.bind=function(b,k){var j,i;if(b.bind===ab&&ab){return ab.apply(b,ar.call(arguments,1))}if(!at.isFunction(b)){throw new TypeError}i=ar.call(arguments,2);return j=function(){if(!(this instanceof j)){return b.apply(k,i.concat(ar.call(arguments)))}W.prototype=b.prototype;var l=new W,m=b.apply(l,i.concat(ar.call(arguments)));return Object(m)===m?m:l}};at.bindAll=function(b){var i=ar.call(arguments,1);i.length==0&&(i=at.functions(b));aq(i,function(j){b[j]=at.bind(b[j],b)});return b};at.memoize=function(b,j){var i={};j||(j=at.identity);return function(){var k=j.apply(this,arguments);return at.has(i,k)?i[k]:i[k]=b.apply(this,arguments)}};at.delay=function(j,i){var k=ar.call(arguments,2);return setTimeout(function(){return j.apply(null,k)},i)};at.defer=function(b){return at.delay.apply(at,[b,1].concat(ar.call(arguments,1)))};at.throttle=function(s,q){var p,o,n,m,l,k,b=at.debounce(function(){l=m=false},q);return function(){p=this;o=arguments;n||(n=setTimeout(function(){n=null;l&&s.apply(p,o);b()},q));m?l=true:k=s.apply(p,o);b();m=true;return k}};at.debounce=function(j,i,l){var k;return function(){var m=this,b=arguments;l&&!k&&j.apply(m,b);clearTimeout(k);k=setTimeout(function(){k=null;l||j.apply(m,b)},i)}};at.once=function(j){var i=false,k;return function(){if(i){return k}i=true;return k=j.apply(this,arguments)}};at.wrap=function(j,i){return function(){var b=[j].concat(ar.call(arguments,0));return i.apply(this,b)}};at.compose=function(){var b=arguments;return function(){for(var i=arguments,j=b.length-1;j>=0;j--){i=[b[j].apply(this,i)]}return i[0]}};at.after=function(j,i){return j<=0?i():function(){if(--j<1){return i.apply(this,arguments)}}};at.keys=f||function(b){if(b!==Object(b)){throw new TypeError("Invalid object")}var j=[],i;for(i in b){at.has(b,i)&&(j[j.length]=i)}return j};at.values=function(b){return at.map(b,at.identity)};at.functions=at.methods=function(b){var j=[],i;for(i in b){at.isFunction(b[i])&&j.push(i)}return j.sort()};at.extend=function(b){aq(ar.call(arguments,1),function(i){for(var j in i){b[j]=i[j]}});return b};at.pick=function(b){var i={};aq(at.flatten(ar.call(arguments,1)),function(j){j in b&&(i[j]=b[j])});return i};at.defaults=function(b){aq(ar.call(arguments,1),function(i){for(var j in i){b[j]==null&&(b[j]=i[j])}});return b};at.clone=function(b){return !at.isObject(b)?b:at.isArray(b)?b.slice():at.extend({},b)};at.tap=function(j,i){i(j);return j};at.isEqual=function(j,i){return af(j,i,[])};at.isEmpty=function(b){if(b==null){return true}if(at.isArray(b)||at.isString(b)){return b.length===0}for(var i in b){if(at.has(b,i)){return false}}return true};at.isElement=function(b){return !!(b&&b.nodeType==1)};at.isArray=aj||function(b){return ao.call(b)=="[object Array]"};at.isObject=function(b){return b===Object(b)};at.isArguments=function(b){return ao.call(b)=="[object Arguments]"};at.isArguments(arguments)||(at.isArguments=function(b){return !(!b||!at.has(b,"callee"))});at.isFunction=function(b){return ao.call(b)=="[object Function]"};at.isString=function(b){return ao.call(b)=="[object String]"};at.isNumber=function(b){return ao.call(b)=="[object Number]"};at.isFinite=function(b){return at.isNumber(b)&&isFinite(b)};at.isNaN=function(b){return b!==b};at.isBoolean=function(b){return b===true||b===false||ao.call(b)=="[object Boolean]"};at.isDate=function(b){return ao.call(b)=="[object Date]"};at.isRegExp=function(b){return ao.call(b)=="[object RegExp]"};at.isNull=function(b){return b===null};at.isUndefined=function(b){return b===void 0};at.has=function(j,i){return Q.call(j,i)};at.noConflict=function(){ae._=U;return this};at.identity=function(b){return b};at.times=function(j,i,l){for(var k=0;k<j;k++){i.call(l,k)}};at.escape=function(b){return(""+b).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;").replace(/\//g,"&#x2F;")};at.result=function(b,j){if(b==null){return null}var i=b[j];return at.isFunction(i)?i.call(b):i};at.mixin=function(b){aq(at.functions(b),function(i){e(i,at[i]=b[i])})};var d=0;at.uniqueId=function(j){var i=d++;return j?j+i:i};at.templateSettings={evaluate:/<%([\s\S]+?)%>/g,interpolate:/<%=([\s\S]+?)%>/g,escape:/<%-([\s\S]+?)%>/g};var Z=/.^/,am={"\\":"\\","'":"'",r:"\r",n:"\n",t:"\t",u2028:"\u2028",u2029:"\u2029"},X;for(X in am){am[am[X]]=X}var c=/\\|'|\r|\n|\t|\u2028|\u2029/g,a=/\\(\\|'|r|n|t|u2028|u2029)/g,V=function(b){return b.replace(a,function(j,i){return am[i]})};at.template=function(b,k,j){j=at.defaults(j||{},at.templateSettings);b="__p+='"+b.replace(c,function(l){return"\\"+am[l]}).replace(j.escape||Z,function(m,l){return"'+\n_.escape("+V(l)+")+\n'"}).replace(j.interpolate||Z,function(m,l){return"'+\n("+V(l)+")+\n'"}).replace(j.evaluate||Z,function(m,l){return"';\n"+V(l)+"\n;__p+='"})+"';\n";j.variable||(b="with(obj||{}){\n"+b+"}\n");var b="var __p='';var print=function(){__p+=Array.prototype.join.call(arguments, '')};\n"+b+"return __p;\n",i=new Function(j.variable||"obj","_",b);if(k){return i(k,at)}k=function(l){return i.call(this,l,at)};k.source="function("+(j.variable||"obj")+"){\n"+b+"}";return k};at.chain=function(b){return at(b).chain()};var an=function(b){this._wrapped=b};at.prototype=an.prototype;var T=function(b,i){return i?at(b).chain():b},e=function(b,i){an.prototype[b]=function(){var j=ar.call(arguments);S.call(j,this._wrapped);return T(i.apply(at,j),this._chain)}};at.mixin(at);aq("pop,push,reverse,shift,sort,splice,unshift".split(","),function(j){var i=ap[j];an.prototype[j]=function(){var k=this._wrapped;i.apply(k,arguments);var b=k.length;(j=="shift"||j=="splice")&&b===0&&delete k[0];return T(k,this._chain)}});aq(["concat","join","slice"],function(j){var i=ap[j];an.prototype[j]=function(){return T(i.apply(this._wrapped,arguments),this._chain)}});an.prototype.chain=function(){this._chain=true;return this};an.prototype.value=function(){return this._wrapped}}).call(this);if(!Date.CultureInfo){Date.CultureInfo={name:"en-US",englishName:"English (United States)",nativeName:"English (United States)",dayNames:["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],abbreviatedDayNames:["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],shortestDayNames:["Su","Mo","Tu","We","Th","Fr","Sa"],firstLetterDayNames:["S","M","T","W","T","F","S"],monthNames:["January","February","March","April","May","June","July","August","September","October","November","December"],abbreviatedMonthNames:["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],amDesignator:"AM",pmDesignator:"PM",firstDayOfWeek:0,twoDigitYearMax:2029,dateElementOrder:"mdy",formatPatterns:{shortDate:"M/d/yyyy",longDate:"dddd, MMMM dd, yyyy",shortTime:"h:mm tt",longTime:"h:mm:ss tt",fullDateTime:"dddd, MMMM dd, yyyy h:mm:ss tt",sortableDateTime:"yyyy-MM-ddTHH:mm:ss",universalSortableDateTime:"yyyy-MM-dd HH:mm:ssZ",rfc1123:"ddd, dd MMM yyyy HH:mm:ss GMT",monthDay:"MMMM dd",yearMonth:"MMMM, yyyy"},regexPatterns:{jan:/^jan(uary)?/i,feb:/^feb(ruary)?/i,mar:/^mar(ch)?/i,apr:/^apr(il)?/i,may:/^may/i,jun:/^jun(e)?/i,jul:/^jul(y)?/i,aug:/^aug(ust)?/i,sep:/^sep(t(ember)?)?/i,oct:/^oct(ober)?/i,nov:/^nov(ember)?/i,dec:/^dec(ember)?/i,sun:/^su(n(day)?)?/i,mon:/^mo(n(day)?)?/i,tue:/^tu(e(s(day)?)?)?/i,wed:/^we(d(nesday)?)?/i,thu:/^th(u(r(s(day)?)?)?)?/i,fri:/^fr(i(day)?)?/i,sat:/^sa(t(urday)?)?/i,future:/^next/i,past:/^last|past|prev(ious)?/i,add:/^(\+|aft(er)?|from|hence)/i,subtract:/^(\-|bef(ore)?|ago)/i,yesterday:/^yes(terday)?/i,today:/^t(od(ay)?)?/i,tomorrow:/^tom(orrow)?/i,now:/^n(ow)?/i,millisecond:/^ms|milli(second)?s?/i,second:/^sec(ond)?s?/i,minute:/^mn|min(ute)?s?/i,hour:/^h(our)?s?/i,week:/^w(eek)?s?/i,month:/^m(onth)?s?/i,day:/^d(ay)?s?/i,year:/^y(ear)?s?/i,shortMeridian:/^(a|p)/i,longMeridian:/^(a\.?m?\.?|p\.?m?\.?)/i,timezone:/^((e(s|d)t|c(s|d)t|m(s|d)t|p(s|d)t)|((gmt)?\s*(\+|\-)\s*\d\d\d\d?)|gmt|utc)/i,ordinalSuffix:/^\s*(st|nd|rd|th)/i,timeContext:/^\s*(\:|a(?!u|p)|p)/i},timezones:[{name:"UTC",offset:"-000"},{name:"GMT",offset:"-000"},{name:"EST",offset:"-0500"},{name:"EDT",offset:"-0400"},{name:"CST",offset:"-0600"},{name:"CDT",offset:"-0500"},{name:"MST",offset:"-0700"},{name:"MDT",offset:"-0600"},{name:"PST",offset:"-0800"},{name:"PDT",offset:"-0700"}]};(function(){var b=Date,a=b.prototype,d=b.CultureInfo,h=function(j,i){if(!i){i=2}return("000"+j).slice(i*-1)};a.clearTime=function(){this.setHours(0);this.setMinutes(0);this.setSeconds(0);this.setMilliseconds(0);return this};a.setTimeToNow=function(){var i=new Date();this.setHours(i.getHours());this.setMinutes(i.getMinutes());this.setSeconds(i.getSeconds());this.setMilliseconds(i.getMilliseconds());return this};b.today=function(){return new Date().clearTime()};b.compare=function(j,i){if(isNaN(j)||isNaN(i)){throw new Error(j+" - "+i)}else{if(j instanceof Date&&i instanceof Date){return(j<i)?-1:(j>i)?1:0}else{throw new TypeError(j+" - "+i)}}};b.equals=function(j,i){return(j.compareTo(i)===0)};b.getDayNumberFromName=function(k){var t=d.dayNames,j=d.abbreviatedDayNames,q=d.shortestDayNames,p=k.toLowerCase();for(var l=0;l<t.length;l++){if(t[l].toLowerCase()==p||j[l].toLowerCase()==p||q[l].toLowerCase()==p){return l}}return -1};b.getMonthNumberFromName=function(k){var p=d.monthNames,j=d.abbreviatedMonthNames,o=k.toLowerCase();for(var l=0;l<p.length;l++){if(p[l].toLowerCase()==o||j[l].toLowerCase()==o){return l}}return -1};b.isLeapYear=function(i){return((i%4===0&&i%100!==0)||i%400===0)};b.getDaysInMonth=function(i,j){return[31,(b.isLeapYear(i)?29:28),31,30,31,30,31,31,30,31,30,31][j]};b.getTimezoneAbbreviation=function(m){var l=d.timezones,k;for(var j=0;j<l.length;j++){if(l[j].offset===m){return l[j].name}}return null};b.getTimezoneOffset=function(j){var m=d.timezones,l;for(var k=0;k<m.length;k++){if(m[k].name===j.toUpperCase()){return m[k].offset}}return null};a.clone=function(){return new Date(this.getTime())};a.compareTo=function(i){return Date.compare(this,i)};a.equals=function(i){return Date.equals(this,i||new Date())};a.between=function(j,i){return this.getTime()>=j.getTime()&&this.getTime()<=i.getTime()};a.isAfter=function(i){return this.compareTo(i||new Date())===1};a.isBefore=function(i){return(this.compareTo(i||new Date())===-1)};a.isToday=function(){return this.isSameDay(new Date())};a.isSameDay=function(i){return this.clone().clearTime().equals(i.clone().clearTime())};a.addMilliseconds=function(i){this.setMilliseconds(this.getMilliseconds()+i);return this};a.addSeconds=function(i){return this.addMilliseconds(i*1000)};a.addMinutes=function(i){return this.addMilliseconds(i*60000)};a.addHours=function(i){return this.addMilliseconds(i*3600000)};a.addDays=function(i){this.setDate(this.getDate()+i);return this};a.addWeeks=function(i){return this.addDays(i*7)};a.addMonths=function(i){var j=this.getDate();this.setDate(1);this.setMonth(this.getMonth()+i);this.setDate(Math.min(j,b.getDaysInMonth(this.getFullYear(),this.getMonth())));return this};a.addYears=function(i){return this.addMonths(i*12)};a.add=function(j){if(typeof j=="number"){this._orient=j;return this}var i=j;if(i.milliseconds){this.addMilliseconds(i.milliseconds)}if(i.seconds){this.addSeconds(i.seconds)}if(i.minutes){this.addMinutes(i.minutes)}if(i.hours){this.addHours(i.hours)}if(i.weeks){this.addWeeks(i.weeks)}if(i.months){this.addMonths(i.months)}if(i.years){this.addYears(i.years)}if(i.days){this.addDays(i.days)}return this};var e,f,c;a.getWeek=function(){var q,p,o,m,l,k,j,i,u,t;e=(!e)?this.getFullYear():e;f=(!f)?this.getMonth()+1:f;c=(!c)?this.getDate():c;if(f<=2){q=e-1;p=(q/4|0)-(q/100|0)+(q/400|0);o=((q-1)/4|0)-((q-1)/100|0)+((q-1)/400|0);u=p-o;l=0;k=c-1+(31*(f-1))}else{q=e;p=(q/4|0)-(q/100|0)+(q/400|0);o=((q-1)/4|0)-((q-1)/100|0)+((q-1)/400|0);u=p-o;l=u+1;k=c+((153*(f-3)+2)/5)+58+u}j=(q+p)%7;m=(k+j-l)%7;i=(k+3-m)|0;if(i<0){t=53-((j-u)/5|0)}else{if(i>364+u){t=1}else{t=(i/7|0)+1}}e=f=c=null;return t};a.getISOWeek=function(){e=this.getUTCFullYear();f=this.getUTCMonth()+1;c=this.getUTCDate();return h(this.getWeek())};a.setWeek=function(i){return this.moveToDayOfWeek(1).addWeeks(i-this.getWeek())};b._validate=function(l,k,i,j){if(typeof l=="undefined"){return false}else{if(typeof l!="number"){throw new TypeError(l+" is not a Number.")}else{if(l<k||l>i){throw new RangeError(l+" is not a valid value for "+j+".")}}}return true};b.validateMillisecond=function(i){return b._validate(i,0,999,"millisecond")};b.validateSecond=function(i){return b._validate(i,0,59,"second")};b.validateMinute=function(i){return b._validate(i,0,59,"minute")};b.validateHour=function(i){return b._validate(i,0,23,"hour")};b.validateDay=function(j,i,k){return b._validate(j,1,b.getDaysInMonth(i,k),"day")};b.validateMonth=function(i){return b._validate(i,0,11,"month")};b.validateYear=function(i){return b._validate(i,0,9999,"year")};a.set=function(i){if(b.validateMillisecond(i.millisecond)){this.addMilliseconds(i.millisecond-this.getMilliseconds())}if(b.validateSecond(i.second)){this.addSeconds(i.second-this.getSeconds())}if(b.validateMinute(i.minute)){this.addMinutes(i.minute-this.getMinutes())}if(b.validateHour(i.hour)){this.addHours(i.hour-this.getHours())}if(b.validateMonth(i.month)){this.addMonths(i.month-this.getMonth())}if(b.validateYear(i.year)){this.addYears(i.year-this.getFullYear())}if(b.validateDay(i.day,this.getFullYear(),this.getMonth())){this.addDays(i.day-this.getDate())}if(i.timezone){this.setTimezone(i.timezone)}if(i.timezoneOffset){this.setTimezoneOffset(i.timezoneOffset)}if(i.week&&b._validate(i.week,0,53,"week")){this.setWeek(i.week)}return this};a.moveToFirstDayOfMonth=function(){return this.set({day:1})};a.moveToLastDayOfMonth=function(){return this.set({day:b.getDaysInMonth(this.getFullYear(),this.getMonth())})};a.moveToNthOccurrence=function(j,k){var i=0;if(k>0){i=k-1}else{if(k===-1){this.moveToLastDayOfMonth();if(this.getDay()!==j){this.moveToDayOfWeek(j,-1)}return this}}return this.moveToFirstDayOfMonth().addDays(-1).moveToDayOfWeek(j,+1).addWeeks(i)};a.moveToDayOfWeek=function(j,i){var k=(j-this.getDay()+7*(i||+1))%7;return this.addDays((k===0)?k+=7*(i||+1):k)};a.moveToMonth=function(k,i){var j=(k-this.getMonth()+12*(i||+1))%12;return this.addMonths((j===0)?j+=12*(i||+1):j)};a.getOrdinalNumber=function(){return Math.ceil((this.clone().clearTime()-new Date(this.getFullYear(),0,1))/86400000)+1};a.getTimezone=function(){return b.getTimezoneAbbreviation(this.getUTCOffset())};a.setTimezoneOffset=function(k){var i=this.getTimezoneOffset(),j=Number(k)*-6/10;return this.addMinutes(j-i)};a.setTimezone=function(i){return this.setTimezoneOffset(b.getTimezoneOffset(i))};a.hasDaylightSavingTime=function(){return(Date.today().set({month:0,day:1}).getTimezoneOffset()!==Date.today().set({month:6,day:1}).getTimezoneOffset())};a.isDaylightSavingTime=function(){return(this.hasDaylightSavingTime()&&new Date().getTimezoneOffset()===Date.today().set({month:6,day:1}).getTimezoneOffset())};a.getUTCOffset=function(){var j=this.getTimezoneOffset()*-10/6,i;if(j<0){i=(j-10000).toString();return i.charAt(0)+i.substr(2)}else{i=(j+10000).toString();return"+"+i.substr(1)}};a.getElapsed=function(i){return(i||new Date())-this};if(!a.toISOString){a.toISOString=function(){function i(j){return j<10?"0"+j:j}return'"'+this.getUTCFullYear()+"-"+i(this.getUTCMonth()+1)+"-"+i(this.getUTCDate())+"T"+i(this.getUTCHours())+":"+i(this.getUTCMinutes())+":"+i(this.getUTCSeconds())+'Z"'}}a._toString=a.toString;a.toString=function(l){var i=this;if(l&&l.length==1){var k=d.formatPatterns;i.t=i.toString;switch(l){case"d":return i.t(k.shortDate);case"D":return i.t(k.longDate);case"F":return i.t(k.fullDateTime);case"m":return i.t(k.monthDay);case"r":return i.t(k.rfc1123);case"s":return i.t(k.sortableDateTime);case"t":return i.t(k.shortTime);case"T":return i.t(k.longTime);case"u":return i.t(k.universalSortableDateTime);case"y":return i.t(k.yearMonth)}}var j=function(m){switch(m*1){case 1:case 21:case 31:return"st";case 2:case 22:return"nd";case 3:case 23:return"rd";default:return"th"}};return l?l.replace(/(\\)?(dd?d?d?|MM?M?M?|yy?y?y?|hh?|HH?|mm?|ss?|tt?|S)/g,function(n){if(n.charAt(0)==="\\"){return n.replace("\\","")}i.h=i.getHours;switch(n){case"hh":return h(i.h()<13?(i.h()===0?12:i.h()):(i.h()-12));case"h":return i.h()<13?(i.h()===0?12:i.h()):(i.h()-12);case"HH":return h(i.h());case"H":return i.h();case"mm":return h(i.getMinutes());case"m":return i.getMinutes();case"ss":return h(i.getSeconds());case"s":return i.getSeconds();case"yyyy":return h(i.getFullYear(),4);case"yy":return h(i.getFullYear());case"dddd":return d.dayNames[i.getDay()];case"ddd":return d.abbreviatedDayNames[i.getDay()];case"dd":return h(i.getDate());case"d":return i.getDate();case"MMMM":return d.monthNames[i.getMonth()];case"MMM":return d.abbreviatedMonthNames[i.getMonth()];case"MM":return h((i.getMonth()+1));case"M":return i.getMonth()+1;case"t":return i.h()<12?d.amDesignator.substring(0,1):d.pmDesignator.substring(0,1);case"tt":return i.h()<12?d.amDesignator:d.pmDesignator;case"S":return j(i.getDate());default:return n}}):this._toString()}}());(function(){var w=Date,n=w.prototype,x=w.CultureInfo,p=Number.prototype;n._orient=+1;n._nth=null;n._is=false;n._same=false;n._isSecond=false;p._dateElement="day";n.next=function(){this._orient=+1;return this};w.next=function(){return w.today().next()};n.last=n.prev=n.previous=function(){this._orient=-1;return this};w.last=w.prev=w.previous=function(){return w.today().last()};n.is=function(){this._is=true;return this};n.same=function(){this._same=true;this._isSecond=false;return this};n.today=function(){return this.same().day()};n.weekday=function(){if(this._is){this._is=false;return(!this.is().sat()&&!this.is().sun())}return false};n.at=function(i){return(typeof i==="string")?w.parse(this.toString("d")+" "+i):this.set(i)};p.fromNow=p.after=function(i){var j={};j[this._dateElement]=this;return((!i)?new Date():i.clone()).add(j)};p.ago=p.before=function(i){var j={};j[this._dateElement]=this*-1;return((!i)?new Date():i.clone()).add(j)};var f=("sunday monday tuesday wednesday thursday friday saturday").split(/\s/),m=("january february march april may june july august september october november december").split(/\s/),o=("Millisecond Second Minute Hour Day Week Month Year").split(/\s/),q=("Milliseconds Seconds Minutes Hours Date Week Month FullYear").split(/\s/),b=("final first second third fourth fifth").split(/\s/),z;n.toObject=function(){var k={};for(var j=0;j<o.length;j++){k[o[j].toLowerCase()]=this["get"+q[j]]()}return k};w.fromObject=function(i){i.week=null;return Date.today().set(i)};var y=function(i){return function(){if(this._is){this._is=false;return this.getDay()==i}if(this._nth!==null){if(this._isSecond){this.addSeconds(this._orient*-1)}this._isSecond=false;var k=this._nth;this._nth=null;var j=this.clone().moveToLastDayOfMonth();this.moveToNthOccurrence(i,k);if(this>j){throw new RangeError(w.getDayName(i)+" does not occur "+k+" times in the month of "+w.getMonthName(j.getMonth())+" "+j.getFullYear()+".")}return this}return this.moveToDayOfWeek(i,this._orient)}};var e=function(i){return function(){var k=w.today(),j=i-k.getDay();if(i===0&&x.firstDayOfWeek===1&&k.getDay()!==0){j=j+7}return k.addDays(j)}};for(var v=0;v<f.length;v++){w[f[v].toUpperCase()]=w[f[v].toUpperCase().substring(0,3)]=v;w[f[v]]=w[f[v].substring(0,3)]=e(v);n[f[v]]=n[f[v].substring(0,3)]=y(v)}var A=function(i){return function(){if(this._is){this._is=false;return this.getMonth()===i}return this.moveToMonth(i,this._orient)}};var h=function(i){return function(){return w.today().set({month:i,day:1})}};for(var u=0;u<m.length;u++){w[m[u].toUpperCase()]=w[m[u].toUpperCase().substring(0,3)]=u;w[m[u]]=w[m[u].substring(0,3)]=h(u);n[m[u]]=n[m[u].substring(0,3)]=A(u)}var c=function(i){return function(){if(this._isSecond){this._isSecond=false;return this}if(this._same){this._same=this._is=false;var D=this.toObject(),C=(arguments[0]||new Date()).toObject(),B="",l=i.toLowerCase();for(var j=(o.length-1);j>-1;j--){B=o[j].toLowerCase();if(D[B]!=C[B]){return false}if(l==B){break}}return true}if(i.substring(i.length-1)!="s"){i+="s"}return this["add"+i](this._orient)}};var d=function(i){return function(){this._dateElement=i;return this}};for(var t=0;t<o.length;t++){z=o[t].toLowerCase();n[z]=n[z+"s"]=c(o[t]);p[z]=p[z+"s"]=d(z)}n._ss=c("Second");var a=function(i){return function(j){if(this._same){return this._ss(arguments[0])}if(j||j===0){return this.moveToNthOccurrence(j,i)}this._nth=i;if(i===2&&(j===undefined||j===null)){this._isSecond=true;return this.addSeconds(this._orient)}return this}};for(var s=0;s<b.length;s++){n[b[s]]=(s===0)?a(-1):a(s)}}());(function(){Date.Parsing={Exception:function(i){this.message="Parse error at '"+i.substring(0,10)+" ...'"}};var a=Date.Parsing;var c=a.Operators={rtoken:function(i){return function(j){var l=j.match(i);if(l){return([l[0],j.substring(l[0].length)])}else{throw new a.Exception(j)}}},token:function(i){return function(j){return c.rtoken(new RegExp("^s*"+j+"s*"))(j)}},stoken:function(i){return c.rtoken(new RegExp("^"+i))},until:function(i){return function(j){var l=[],n=null;while(j.length){try{n=i.call(this,j)}catch(m){l.push(n[0]);j=n[1];continue}break}return[l,j]}},many:function(i){return function(j){var n=[],l=null;while(j.length){try{l=i.call(this,j)}catch(m){return[n,j]}n.push(l[0]);j=l[1]}return[n,j]}},optional:function(i){return function(j){var l=null;try{l=i.call(this,j)}catch(m){return[null,j]}return[l[0],l[1]]}},not:function(i){return function(j){try{i.call(this,j)}catch(l){return[null,j]}throw new a.Exception(j)}},ignore:function(i){return i?function(j){var l=null;l=i.call(this,j);return[null,l[1]]}:null},product:function(){var l=arguments[0],m=Array.prototype.slice.call(arguments,1),n=[];for(var j=0;j<l.length;j++){n.push(c.each(l[j],m))}return n},cache:function(l){var i={},j=null;return function(m){try{j=i[m]=(i[m]||l.call(this,m))}catch(n){j=i[m]=n}if(j instanceof a.Exception){throw j}else{return j}}},any:function(){var i=arguments;return function(l){var m=null;for(var j=0;j<i.length;j++){if(i[j]==null){continue}try{m=(i[j].call(this,l))}catch(n){m=null}if(m){return m}}throw new a.Exception(l)}},each:function(){var i=arguments;return function(l){var o=[],m=null;for(var j=0;j<i.length;j++){if(i[j]==null){continue}try{m=(i[j].call(this,l))}catch(n){throw new a.Exception(l)}o.push(m[0]);l=m[1]}return[o,l]}},all:function(){var j=arguments,i=i;return i.each(i.optional(j))},sequence:function(i,j,l){j=j||c.rtoken(/^\s*/);l=l||null;if(i.length==1){return i[0]}return function(p){var t=null,u=null;var w=[];for(var o=0;o<i.length;o++){try{t=i[o].call(this,p)}catch(v){break}w.push(t[0]);try{u=j.call(this,t[1])}catch(n){u=null;break}p=u[1]}if(!t){throw new a.Exception(p)}if(u){throw new a.Exception(u[1])}if(l){try{t=l.call(this,t[1])}catch(m){throw new a.Exception(t[1])}}return[w,(t?t[1]:p)]}},between:function(j,l,i){i=i||j;var m=c.each(c.ignore(j),l,c.ignore(i));return function(n){var o=m.call(this,n);return[[o[0][0],r[0][2]],o[1]]}},list:function(i,j,l){j=j||c.rtoken(/^\s*/);l=l||null;return(i instanceof Array?c.each(c.product(i.slice(0,-1),c.ignore(j)),i.slice(-1),c.ignore(l)):c.each(c.many(c.each(i,c.ignore(j))),px,c.ignore(l)))},set:function(i,j,l){j=j||c.rtoken(/^\s*/);l=l||null;return function(C){var m=null,t=null,n=null,o=null,u=[[],C],B=false;for(var w=0;w<i.length;w++){n=null;t=null;m=null;B=(i.length==1);try{m=i[w].call(this,C)}catch(z){continue}o=[[m[0]],m[1]];if(m[1].length>0&&!B){try{n=j.call(this,m[1])}catch(A){B=true}}else{B=true}if(!B&&n[1].length===0){B=true}if(!B){var x=[];for(var v=0;v<i.length;v++){if(w!=v){x.push(i[v])}}t=c.set(x,j).call(this,n[1]);if(t[0].length>0){o[0]=o[0].concat(t[0]);o[1]=t[1]}}if(o[1].length<u[1].length){u=o}if(u[1].length===0){break}}if(u[0].length===0){return u}if(l){try{n=l.call(this,u[1])}catch(y){throw new a.Exception(u[1])}u[1]=n[1]}return u}},forward:function(i,j){return function(l){return i[j].call(this,l)}},replace:function(j,i){return function(l){var m=j.call(this,l);return[i,m[1]]}},process:function(j,i){return function(l){var m=j.call(this,l);return[i.call(this,m[0]),m[1]]}},min:function(i,j){return function(l){var m=j.call(this,l);if(m[0].length<i){throw new a.Exception(l)}return m}}};var k=function(i){return function(){var j=null,n=[];if(arguments.length>1){j=Array.prototype.slice.call(arguments)}else{if(arguments[0] instanceof Array){j=arguments[0]}}if(j){for(var m=0,l=j.shift();m<l.length;m++){j.unshift(l[m]);n.push(i.apply(null,j));j.shift();return n}}else{return i.apply(null,arguments)}}};var h="optional not ignore cache".split(/\s/);for(var d=0;d<h.length;d++){c[h[d]]=k(c[h[d]])}var f=function(i){return function(){if(arguments[0] instanceof Array){return i.apply(null,arguments[0])}else{return i.apply(null,arguments)}}};var e="each any all".split(/\s/);for(var b=0;b<e.length;b++){c[e[b]]=f(c[e[b]])}}());(function(){var e=Date,l=e.prototype,h=e.CultureInfo;var b=function(n){var o=[];for(var m=0;m<n.length;m++){if(n[m] instanceof Array){o=o.concat(b(n[m]))}else{if(n[m]){o.push(n[m])}}}return o};e.Grammar={};e.Translator={hour:function(m){return function(){this.hour=Number(m)}},minute:function(m){return function(){this.minute=Number(m)}},second:function(m){return function(){this.second=Number(m)}},meridian:function(m){return function(){this.meridian=m.slice(0,1).toLowerCase()}},timezone:function(m){return function(){var o=m.replace(/[^\d\+\-]/g,"");if(o.length){this.timezoneOffset=Number(o)}else{this.timezone=m.toLowerCase()}}},day:function(m){var n=m[0];return function(){this.day=Number(n.match(/\d+/)[0])}},month:function(m){return function(){this.month=(m.length==3)?"jan feb mar apr may jun jul aug sep oct nov dec".indexOf(m)/4:Number(m)-1}},year:function(m){return function(){var o=Number(m);this.year=((m.length>2)?o:(o+(((o+2000)<h.twoDigitYearMax)?2000:1900)))}},rday:function(m){return function(){switch(m){case"yesterday":this.days=-1;break;case"tomorrow":this.days=1;break;case"today":this.days=0;break;case"now":this.days=0;this.now=true;break}}},finishExact:function(m){m=(m instanceof Array)?m:[m];for(var o=0;o<m.length;o++){if(m[o]){m[o].call(this)}}var n=new Date();if((this.hour||this.minute)&&(!this.month&&!this.year&&!this.day)){this.day=n.getDate()}if(!this.year){this.year=n.getFullYear()}if(!this.month&&this.month!==0){this.month=n.getMonth()}if(!this.day){this.day=1}if(!this.hour){this.hour=0}if(!this.minute){this.minute=0}if(!this.second){this.second=0}if(this.meridian&&this.hour){if(this.meridian=="p"&&this.hour<12){this.hour=this.hour+12}else{if(this.meridian=="a"&&this.hour==12){this.hour=0}}}if(this.day>e.getDaysInMonth(this.year,this.month)){throw new RangeError(this.day+" is not a valid value for days.")}var p=new Date(this.year,this.month,this.day,this.hour,this.minute,this.second);if(this.timezone){p.set({timezone:this.timezone})}else{if(this.timezoneOffset){p.set({timezoneOffset:this.timezoneOffset})}}return p},finish:function(m){m=(m instanceof Array)?b(m):[m];if(m.length===0){return null}for(var s=0;s<m.length;s++){if(typeof m[s]=="function"){m[s].call(this)}}var o=e.today();if(this.now&&!this.unit&&!this.operator){return new Date()}else{if(this.now){o=new Date()}}var t=!!(this.days&&this.days!==null||this.orient||this.operator);var u,q,p;p=((this.orient=="past"||this.operator=="subtract")?-1:1);if(!this.now&&"hour minute second".indexOf(this.unit)!=-1){o.setTimeToNow()}if(this.month||this.month===0){if("year day hour minute second".indexOf(this.unit)!=-1){this.value=this.month+1;this.month=null;t=true}}if(!t&&this.weekday&&!this.day&&!this.days){var n=Date[this.weekday]();this.day=n.getDate();if(!this.month){this.month=n.getMonth()}this.year=n.getFullYear()}if(t&&this.weekday&&this.unit!="month"){this.unit="day";u=(e.getDayNumberFromName(this.weekday)-o.getDay());q=7;this.days=u?((u+(p*q))%q):(p*q)}if(this.month&&this.unit=="day"&&this.operator){this.value=(this.month+1);this.month=null}if(this.value!=null&&this.month!=null&&this.year!=null){this.day=this.value*1}if(this.month&&!this.day&&this.value){o.set({day:this.value*1});if(!t){this.day=this.value*1}}if(!this.month&&this.value&&this.unit=="month"&&!this.now){this.month=this.value;t=true}if(t&&(this.month||this.month===0)&&this.unit!="year"){this.unit="month";u=(this.month-o.getMonth());q=12;this.months=u?((u+(p*q))%q):(p*q);this.month=null}if(!this.unit){this.unit="day"}if(!this.value&&this.operator&&this.operator!==null&&this[this.unit+"s"]&&this[this.unit+"s"]!==null){this[this.unit+"s"]=this[this.unit+"s"]+((this.operator=="add")?1:-1)+(this.value||0)*p}else{if(this[this.unit+"s"]==null||this.operator!=null){if(!this.value){this.value=1}this[this.unit+"s"]=this.value*p}}if(this.meridian&&this.hour){if(this.meridian=="p"&&this.hour<12){this.hour=this.hour+12}else{if(this.meridian=="a"&&this.hour==12){this.hour=0}}}if(this.weekday&&!this.day&&!this.days){var n=Date[this.weekday]();this.day=n.getDate();if(n.getMonth()!==o.getMonth()){this.month=n.getMonth()}}if((this.month||this.month===0)&&!this.day){this.day=1}if(!this.orient&&!this.operator&&this.unit=="week"&&this.value&&!this.day&&!this.month){return Date.today().setWeek(this.value)}if(t&&this.timezone&&this.day&&this.days){this.day=this.days}return(t)?o.add(this):o.set(this)}};var i=e.Parsing.Operators,f=e.Grammar,k=e.Translator,c;f.datePartDelimiter=i.rtoken(/^([\s\-\.\,\/\x27]+)/);f.timePartDelimiter=i.stoken(":");f.whiteSpace=i.rtoken(/^\s*/);f.generalDelimiter=i.rtoken(/^(([\s\,]|at|@|on)+)/);var a={};f.ctoken=function(q){var p=a[q];if(!p){var s=h.regexPatterns;var o=q.split(/\s+/),n=[];for(var m=0;m<o.length;m++){n.push(i.replace(i.rtoken(s[o[m]]),o[m]))}p=a[q]=i.any.apply(null,n)}return p};f.ctoken2=function(m){return i.rtoken(h.regexPatterns[m])};f.h=i.cache(i.process(i.rtoken(/^(0[0-9]|1[0-2]|[1-9])/),k.hour));f.hh=i.cache(i.process(i.rtoken(/^(0[0-9]|1[0-2])/),k.hour));f.H=i.cache(i.process(i.rtoken(/^([0-1][0-9]|2[0-3]|[0-9])/),k.hour));f.HH=i.cache(i.process(i.rtoken(/^([0-1][0-9]|2[0-3])/),k.hour));f.m=i.cache(i.process(i.rtoken(/^([0-5][0-9]|[0-9])/),k.minute));f.mm=i.cache(i.process(i.rtoken(/^[0-5][0-9]/),k.minute));f.s=i.cache(i.process(i.rtoken(/^([0-5][0-9]|[0-9])/),k.second));f.ss=i.cache(i.process(i.rtoken(/^[0-5][0-9]/),k.second));f.hms=i.cache(i.sequence([f.H,f.m,f.s],f.timePartDelimiter));f.t=i.cache(i.process(f.ctoken2("shortMeridian"),k.meridian));f.tt=i.cache(i.process(f.ctoken2("longMeridian"),k.meridian));f.z=i.cache(i.process(i.rtoken(/^((\+|\-)\s*\d\d\d\d)|((\+|\-)\d\d\:?\d\d)/),k.timezone));f.zz=i.cache(i.process(i.rtoken(/^((\+|\-)\s*\d\d\d\d)|((\+|\-)\d\d\:?\d\d)/),k.timezone));f.zzz=i.cache(i.process(f.ctoken2("timezone"),k.timezone));f.timeSuffix=i.each(i.ignore(f.whiteSpace),i.set([f.tt,f.zzz]));f.time=i.each(i.optional(i.ignore(i.stoken("T"))),f.hms,f.timeSuffix);f.d=i.cache(i.process(i.each(i.rtoken(/^([0-2]\d|3[0-1]|\d)/),i.optional(f.ctoken2("ordinalSuffix"))),k.day));f.dd=i.cache(i.process(i.each(i.rtoken(/^([0-2]\d|3[0-1])/),i.optional(f.ctoken2("ordinalSuffix"))),k.day));f.ddd=f.dddd=i.cache(i.process(f.ctoken("sun mon tue wed thu fri sat"),function(m){return function(){this.weekday=m}}));f.M=i.cache(i.process(i.rtoken(/^(1[0-2]|0\d|\d)/),k.month));f.MM=i.cache(i.process(i.rtoken(/^(1[0-2]|0\d)/),k.month));f.MMM=f.MMMM=i.cache(i.process(f.ctoken("jan feb mar apr may jun jul aug sep oct nov dec"),k.month));f.y=i.cache(i.process(i.rtoken(/^(\d\d?)/),k.year));f.yy=i.cache(i.process(i.rtoken(/^(\d\d)/),k.year));f.yyy=i.cache(i.process(i.rtoken(/^(\d\d?\d?\d?)/),k.year));f.yyyy=i.cache(i.process(i.rtoken(/^(\d\d\d\d)/),k.year));c=function(){return i.each(i.any.apply(null,arguments),i.not(f.ctoken2("timeContext")))};f.day=c(f.d,f.dd);f.month=c(f.M,f.MMM);f.year=c(f.yyyy,f.yy);f.orientation=i.process(f.ctoken("past future"),function(m){return function(){this.orient=m}});f.operator=i.process(f.ctoken("add subtract"),function(m){return function(){this.operator=m}});f.rday=i.process(f.ctoken("yesterday tomorrow today now"),k.rday);f.unit=i.process(f.ctoken("second minute hour day week month year"),function(m){return function(){this.unit=m}});f.value=i.process(i.rtoken(/^\d\d?(st|nd|rd|th)?/),function(m){return function(){this.value=m.replace(/\D/g,"")}});f.expression=i.set([f.rday,f.operator,f.value,f.unit,f.orientation,f.ddd,f.MMM]);c=function(){return i.set(arguments,f.datePartDelimiter)};f.mdy=c(f.ddd,f.month,f.day,f.year);f.ymd=c(f.ddd,f.year,f.month,f.day);f.dmy=c(f.ddd,f.day,f.month,f.year);f.date=function(m){return((f[h.dateElementOrder]||f.mdy).call(this,m))};f.format=i.process(i.many(i.any(i.process(i.rtoken(/^(dd?d?d?|MM?M?M?|yy?y?y?|hh?|HH?|mm?|ss?|tt?|zz?z?)/),function(m){if(f[m]){return f[m]}else{throw e.Parsing.Exception(m)}}),i.process(i.rtoken(/^[^dMyhHmstz]+/),function(m){return i.ignore(i.stoken(m))}))),function(m){return i.process(i.each.apply(null,m),k.finishExact)});var j={};var d=function(m){return j[m]=(j[m]||f.format(m)[0])};f.formats=function(n){if(n instanceof Array){var o=[];for(var m=0;m<n.length;m++){o.push(d(n[m]))}return i.any.apply(null,o)}else{return d(n)}};f._formats=f.formats(['"yyyy-MM-ddTHH:mm:ssZ"',"yyyy-MM-ddTHH:mm:ssZ","yyyy-MM-ddTHH:mm:ssz","yyyy-MM-ddTHH:mm:ss","yyyy-MM-ddTHH:mmZ","yyyy-MM-ddTHH:mmz","yyyy-MM-ddTHH:mm","ddd, MMM dd, yyyy H:mm:ss tt","ddd MMM d yyyy HH:mm:ss zzz","MMddyyyy","ddMMyyyy","Mddyyyy","ddMyyyy","Mdyyyy","dMyyyy","yyyy","Mdyy","dMyy","d"]);f._start=i.process(i.set([f.date,f.time,f.expression],f.generalDelimiter,f.whiteSpace),k.finish);f.start=function(m){try{var n=f._formats.call({},m);if(n[1].length===0){return n}}catch(o){}return f._start.call({},m)};e._parse=e.parse;e.parse=function(m){var n=null;if(!m){return null}if(m instanceof Date){return m}try{n=e.Grammar.start.call({},m.replace(/^\s*(\S*(\s+\S+)*)\s*$/,"$1"))}catch(o){return null}return((n[1].length===0)?n[0]:null)};e.getParseFunction=function(n){var m=e.Grammar.formats(n);return function(o){var p=null;try{p=m.call({},o)}catch(q){return null}return((p[1].length===0)?p[0]:null)}};e.parseExact=function(m,n){return e.getParseFunction(n)(m)}}());var relativeDate=function(u){function k(a,w){!w&&(w=(new Date).getTime());w instanceof Date&&(w=w.getTime());a instanceof Date&&(a=a.getTime());var v=w-a,j,i,h;for(i=-1,h=l.length;++i<h;){j=l[i];if(v<j[0]){return j[2]==u?j[1]:Math.round(v/j[2])+" "+j[1]}}}var t=1000,s=60*t,q=60*s,p=24*q,o=7*p,n=p*365,m=n/12;var l=[[0.7*s,"just now"],[1.5*s,"a minute ago"],[60*s,"minutes ago",s],[1.5*q,"an hour ago"],[p,"hours ago",q],[2*p,"yesterday"],[7*p,"days ago",p],[1.5*o,"a week ago"],[m,"weeks ago",o],[1.5*m,"a month ago"],[n,"months ago",m],[1.5*n,"a year ago"],[Number.MAX_VALUE,"years ago",n]];return k}();if(typeof module!="undefined"&&module.exports){module.exports=relativeDate}}var CodeMirror=(function(){function P(aP,c5){var bA={},bz=P.defaults;for(var aI in bz){if(bz.hasOwnProperty(aI)){bA[aI]=(c5&&c5.hasOwnProperty(aI)?c5:bz)[aI]}}var aM=document.createElement("div");aM.className="CodeMirror"+(bA.lineWrapping?" CodeMirror-wrap":"");aM.innerHTML='<div style="overflow: hidden; position: relative; width: 3px; height: 0px;"><textarea style="position: absolute; padding: 0; width: 1px; height: 1em" wrap="off" autocorrect="off" autocapitalize="off"></textarea></div><div class="CodeMirror-scrollbar"><div class="CodeMirror-scrollbar-inner"></div></div><div class="CodeMirror-scroll" tabindex="-1"><div style="position: relative"><div style="position: relative"><div class="CodeMirror-gutter"><div class="CodeMirror-gutter-text"></div></div><div class="CodeMirror-lines"><div style="position: relative; z-index: 0"><div style="position: absolute; width: 100%; height: 0; overflow: hidden; visibility: hidden;"></div><pre class="CodeMirror-cursor">&#160;</pre><pre class="CodeMirror-cursor" style="visibility: hidden">&#160;</pre><div style="position: relative; z-index: -1"></div><div></div></div></div></div></div></div>';if(aP.appendChild){aP.appendChild(aM)}else{aP(aM)}var cj=aM.firstChild,bD=cj.firstChild,cm=aM.lastChild,b7=cm.firstChild,cG=b7.firstChild,c8=cG.firstChild,cK=c8.firstChild,b9=c8.nextSibling.firstChild,az=b9.firstChild,cs=az.nextSibling,br=cs.nextSibling,co=br.nextSibling,au=co.nextSibling,aQ=cj.nextSibling,bf=aQ.firstChild;cW();a6();if(L){bD.style.width="0px"}if(!ai){cm.draggable=true}b9.style.outline="none";if(bA.tabindex!=null){bD.tabIndex=bA.tabindex}if(bA.autofocus){b2()}if(!bA.gutter&&!bA.lineNumbers){c8.style.display="none"}if(x){cj.style.height="1px",cj.style.position="absolute"}if(ah){aQ.className+=(bP()?" cm-sb-overlap":" cm-sb-nonoverlap")}else{if(G){aQ.className+=" cm-sb-ie7"}}try{a7("x")}catch(cz){if(cz.message.match(/runtime/i)){cz=new Error("A CodeMirror inside a P-style element does not work in Internet Explorer. (innerHTML bug)")}throw cz}var cy=new N(),dg=new N(),aN;var cB,cT=new q([new b([new j("")])]),cF,bi;cg();var dh={from:{line:0,ch:0},to:{line:0,ch:0},inverted:false};var bj,bK,bd,b5=0,cr=0,ct,bb=false,cO=false;var ba,bp,aK,aS,aW,bv,a1,a2;var cq=0,da=0,bO=0,b8=0;var cv;var bX="",aZ=false,cf=true;var ay={};av(function(){a9(bA.value||"");ba=false})();var bs=new ae();H(cm,"mousedown",av(cH));H(cm,"dblclick",av(bC));H(b9,"selectstart",t);if(!aa){H(cm,"contextmenu",bh)}H(cm,"scroll",b6);H(aQ,"scroll",b6);H(aQ,"mousedown",function(){setTimeout(b2,0)});H(cm,"mousewheel",aD);H(cm,"DOMMouseScroll",aD);H(window,"resize",function(){cD(true)});H(bD,"keyup",av(be));H(bD,"input",aY);H(bD,"keydown",av(cC));H(bD,"keypress",av(ch));H(bD,"focus",aH);H(bD,"blur",c9);if(bA.dragDrop){H(cm,"dragstart",c7);function bV(di){if(bA.onDragEvent&&bA.onDragEvent(cA,w(di))){return}R(di)}H(cm,"dragenter",bV);H(cm,"dragover",bV);H(cm,"drop",av(aB))}H(cm,"paste",function(){b2();aY()});H(bD,"paste",aY);H(bD,"cut",av(function(){if(!bA.readOnly){bL("")}}));if(x){H(b7,"mouseup",function(){if(document.activeElement==bD){bD.blur()}b2()})}var cR;try{cR=(document.activeElement==bD)}catch(cz){}if(cR||bA.autofocus){setTimeout(aH,20)}else{c9()}function cd(di){return di>=0&&di<cT.size}var cA=aM.CodeMirror={getValue:cn,setValue:av(a9),getSelection:bx,replaceSelection:av(bL),focus:function(){window.focus();b2();aH();aY()},setOption:function(di,dk){var dj=bA[di];bA[di]=dk;if(di=="mode"||di=="indentUnit"){cg()}else{if(di=="readOnly"&&dk=="nocursor"){c9();bD.blur()}else{if(di=="readOnly"&&!dk){a0(true)}else{if(di=="theme"){cW()}else{if(di=="lineWrapping"&&dj!=dk){av(cY)()}else{if(di=="tabSize"){cD(true)}else{if(di=="keyMap"){a6()}}}}}}}if(di=="lineNumbers"||di=="gutter"||di=="firstLineNumber"||di=="theme"){cp();cD(true)}},getOption:function(di){return bA[di]},undo:av(dd),redo:av(c1),indentLine:av(function(dj,di){if(typeof di!="string"){if(di==null){di=bA.smartIndent?"smart":"prev"}else{di=di?"add":"subtract"}}if(cd(dj)){bR(dj,di)}}),indentSelection:av(cV),historySize:function(){return{undo:bs.done.length,redo:bs.undone.length}},clearHistory:function(){bs=new ae()},matchBrackets:av(function(){bm(true)}),getTokenAt:av(function(di){di=a3(di);return aX(di.line).getTokenAt(cB,cP(di.line),di.ch)}),getStateAfter:function(di){di=ci(di==null?cT.size-1:di);return cP(di+1)},cursorCoords:function(dj,di){if(dj==null){dj=dh.inverted}return this.charCoords(dj?dh.from:dh.to,di)},charCoords:function(dj,di){dj=a3(dj);if(di=="local"){return db(dj,false)}if(di=="div"){return db(dj,true)}return at(dj)},coordsChar:function(di){var dj=an(b9);return bY(di.x-dj.left,di.y-dj.top)},markText:av(bW),setBookmark:cQ,findMarksAt:bG,setMarker:av(bF),clearMarker:av(ar),setLineClass:av(cl),hideLine:av(function(di){return aU(di,true)}),showLine:av(function(di){return aU(di,false)}),onDeleteLine:function(di,dj){if(typeof di=="number"){if(!cd(di)){return null}di=aX(di)}(di.handlers||(di.handlers=[])).push(dj);return di},lineInfo:a8,addWidget:function(dn,di,dq,dk,dr){dn=db(a3(dn));var dm=dn.yBot,dj=dn.x;di.style.position="absolute";b7.appendChild(di);if(dk=="over"){dm=dn.y}else{if(dk=="near"){var dl=Math.max(cm.offsetHeight,cT.height*ca()),dp=Math.max(b7.clientWidth,b9.clientWidth)-cx();if(dn.yBot+di.offsetHeight>dl&&dn.y>di.offsetHeight){dm=dn.y-di.offsetHeight}if(dj+di.offsetWidth>dp){dj=dp-di.offsetWidth}}}di.style.top=(dm+cN())+"px";di.style.left=di.style.right="";if(dr=="right"){dj=b7.clientWidth-di.offsetWidth;di.style.right="0px"}else{if(dr=="left"){dj=0}else{if(dr=="middle"){dj=(b7.clientWidth-di.offsetWidth)/2}}di.style.left=(dj+cx())+"px"}if(dq){aJ(dj,dm,dj+di.offsetWidth,dm+di.offsetHeight)}},lineCount:function(){return cT.size},clipPos:a3,getCursor:function(di){if(di==null){di=dh.inverted}return aj(di?dh.from:dh.to)},somethingSelected:function(){return !al(dh.from,dh.to)},setCursor:av(function(di,dk,dj){if(dk==null&&typeof di.line=="number"){bq(di.line,di.ch,dj)}else{bq(di,dk,dj)}}),setSelection:av(function(dk,dj,di){(di?b3:b4)(a3(dk),a3(dj||dk))}),getLine:function(di){if(cd(di)){return aX(di).text}},getLineHandle:function(di){if(cd(di)){return aX(di)}},setLine:av(function(di,dj){if(cd(di)){cc(dj,{line:di,ch:0},{line:di,ch:aX(di).text.length})}}),removeLine:av(function(di){if(cd(di)){cc("",{line:di,ch:0},a3({line:di+1,ch:0}))}}),replaceRange:av(cc),getRange:function(dj,di){return c4(a3(dj),a3(di))},triggerOnKeyDown:av(cC),execCommand:function(di){return z[di](cA)},moveH:av(cX),deleteH:av(cI),moveV:av(cS),toggleOverwrite:function(){if(bb){bb=false;cs.className=cs.className.replace(" CodeMirror-overwrite","")}else{bb=true;cs.className+=" CodeMirror-overwrite"}},posFromIndex:function(dk){var dj=0,di;cT.iter(0,cT.size,function(dl){var dm=dl.text.length+1;if(dm>dk){di=dk;return true}dk-=dm;++dj});return a3({line:dj,ch:di})},indexFromPos:function(di){if(di.line<0||di.ch<0){return 0}var dj=di.ch;cT.iter(0,di.line,function(dk){dj+=dk.text.length+1});return dj},scrollTo:function(di,dj){if(di!=null){cm.scrollLeft=di}if(dj!=null){aQ.scrollTop=dj}cD([])},getScrollInfo:function(){return{x:cm.scrollLeft,y:aQ.scrollTop,height:aQ.scrollHeight,width:cm.scrollWidth}},operation:function(di){return av(di)()},compoundChange:function(di){return bM(di)},refresh:function(){cD(true);if(aQ.scrollHeight>b5){aQ.scrollTop=b5}},getInputField:function(){return bD},getWrapperElement:function(){return aM},getScrollerElement:function(){return cm},getGutterElement:function(){return c8}};function aX(di){return T(cT,di)}function cE(di,dj){a1=true;var dk=dj-di.height;for(var dl=di;dl;dl=dl.parent){dl.height+=dk}}function a9(di){var dj={line:0,ch:0};c0(dj,{line:cT.size-1,ch:aX(cT.size-1).text.length},K(di),dj,dj);ba=true}function cn(){var di=[];cT.iter(0,cT.size,function(dj){di.push(dj.text)});return di.join("\n")}function b6(di){if(b5!=aQ.scrollTop||cr!=cm.scrollLeft){b5=aQ.scrollTop;cr=cm.scrollLeft;cD([]);if(bA.fixedGutter){c8.style.left=cm.scrollLeft+"px"}if(bA.onScroll){bA.onScroll(cA)}}}function cH(dt){bn(O(dt,"shiftKey"));for(var dp=p(dt);dp!=aM;dp=dp.parentNode){if(dp.parentNode==b7&&dp!=cG){return}}for(var dp=p(dt);dp!=aM;dp=dp.parentNode){if(dp.parentNode==cK){if(bA.onGutterClick){bA.onGutterClick(cA,F(cK.childNodes,dp)+da,dt)}return t(dt)}}var dk=bk(dt);switch(S(dt)){case 3:if(aa&&!Z){bh(dt)}return;case 2:if(dk){bq(dk.line,dk.ch,true)}setTimeout(b2,20);t(dt);return}if(!dk){if(p(dt)==cm){t(dt)}return}if(!bi){aH()}var dj=+new Date;if(bd&&bd.time>dj-400&&al(bd.pos,dk)){t(dt);setTimeout(b2,20);return c6(dk.line)}else{if(bK&&bK.time>dj-400&&al(bK.pos,dk)){bd={time:dj,pos:dk};t(dt);return bT(dk)}else{bK={time:dj,pos:dk}}}var du=dk,dl;if(bA.dragDrop&&V&&!bA.readOnly&&!al(dh.from,dh.to)&&!k(dk,dh.from)&&!k(dh.to,dk)){if(ai){cm.draggable=true}function dn(dv){if(ai){cm.draggable=false}ct=false;ds();dm();if(Math.abs(dt.clientX-dv.clientX)+Math.abs(dt.clientY-dv.clientY)<10){t(dv);bq(dk.line,dk.ch,true);b2()}}var ds=H(document,"mouseup",av(dn),true);var dm=H(cm,"drop",av(dn),true);ct=true;if(cm.dragDrop){cm.dragDrop()}return}t(dt);bq(dk.line,dk.ch,true);function di(dv){var dx=bk(dv,true);if(dx&&!al(dx,du)){if(!bi){aH()}du=dx;b3(dk,dx);ba=false;var dw=b0();if(dx.line>=dw.to||dx.line<dw.from){dl=setTimeout(av(function(){di(dv)}),150)}}}function dr(dv){clearTimeout(dl);var dw=bk(dv);if(dw){b3(dk,dw)}t(dv);b2();ba=true;dq();ds()}var dq=H(document,"mousemove",av(function(dv){clearTimeout(dl);t(dv);if(!X&&!S(dv)){dr(dv)}else{di(dv)}}),true);var ds=H(document,"mouseup",av(dr),true)}function bC(di){for(var dk=p(di);dk!=aM;dk=dk.parentNode){if(dk.parentNode==cK){return t(di)}}var dj=bk(di);if(!dj){return}bd={time:+new Date,pos:dj};t(di);bT(dj)}function aB(dm){if(bA.onDragEvent&&bA.onDragEvent(cA,w(dm))){return}dm.preventDefault();var dq=bk(dm,true),dj=dm.dataTransfer.files;if(!dq||bA.readOnly){return}if(dj&&dj.length&&window.FileReader&&window.File){function dl(ds,dr){var dt=new FileReader;dt.onload=function(){dn[dr]=dt.result;if(++dk==dp){dq=a3(dq);av(function(){var du=cc(dn.join(""),dq,dq);b3(dq,du)})()}};dt.readAsText(ds)}var dp=dj.length,dn=Array(dp),dk=0;for(var di=0;di<dp;++di){dl(dj[di],di)}}else{if(ct&&!(k(dq,dh.from)||k(dh.to,dq))){return}try{var dn=dm.dataTransfer.getData("Text");if(dn){bM(function(){var ds=dh.from,dr=dh.to;b3(dq,dq);if(ct){cc("",ds,dr)}bL(dn);b2()})}}catch(dm){}}}function c7(dk){var di=bx();dk.dataTransfer.setData("Text",di);if(aa||c||Y){var dj=document.createElement("img");dj.scr="data:image/gif;base64,R0lGODdhAgACAIAAAAAAAP///ywAAAAAAgACAAACAoRRADs=";dk.dataTransfer.setDragImage(dj,0,0)}}function by(dj,dk){if(typeof dj=="string"){dj=z[dj];if(!dj){return false}}var di=bj;try{if(bA.readOnly){cO=true}if(dk){bj=null}dj(cA)}catch(dl){if(dl!=ak){throw dl}return false}finally{bj=di;cO=false}return true}function c2(dn){var di=f(bA.keyMap),dl=di.auto;clearTimeout(bU);if(dl&&!ac(dn)){bU=setTimeout(function(){if(f(bA.keyMap)==di){bA.keyMap=(dl.call?dl.call(null,cA):dl)}},50)}var dj=ad[O(dn,"keyCode")],dm=false;if(dj==null||dn.altGraphKey){return false}if(O(dn,"altKey")){dj="Alt-"+dj}if(O(dn,"ctrlKey")){dj="Ctrl-"+dj}if(O(dn,"metaKey")){dj="Cmd-"+dj}var dp=false;function dk(){dp=true}if(O(dn,"shiftKey")){dm=v("Shift-"+dj,bA.extraKeys,bA.keyMap,function(dq){return by(dq,true)},dk)||v(dj,bA.extraKeys,bA.keyMap,function(dq){if(typeof dq=="string"&&/^go[A-Z]/.test(dq)){return by(dq)}},dk)}else{dm=v(dj,bA.extraKeys,bA.keyMap,by,dk)}if(dp){dm=false}if(dm){t(dn);aR();if(X){dn.oldKeyCode=dn.keyCode;dn.keyCode=0}}return dm}function bB(dk,di){var dj=v("'"+di+"'",bA.extraKeys,bA.keyMap,function(dl){return by(dl,true)});if(dj){t(dk);aR()}return dj}var aV=null,bU;function cC(dk){if(!bi){aH()}if(X&&dk.keyCode==27){dk.returnValue=false}if(cb){if(bS()){cb=false}}if(bA.onKeyEvent&&bA.onKeyEvent(cA,w(dk))){return}var di=O(dk,"keyCode");bn(di==16||O(dk,"shiftKey"));var dj=c2(dk);if(Y){aV=dj?di:null;if(!dj&&di==88&&O(dk,Z?"metaKey":"ctrlKey")){bL("")}}}function ch(dk){if(cb){bS()}if(bA.onKeyEvent&&bA.onKeyEvent(cA,w(dk))){return}var dl=O(dk,"keyCode"),di=O(dk,"charCode");if(Y&&dl==aV){aV=null;t(dk);return}if(((Y&&(!dk.which||dk.which<10))||x)&&c2(dk)){return}var dj=String.fromCharCode(di==null?dl:di);if(bA.electricChars&&cB.electricChars&&bA.smartIndent&&!bA.readOnly){if(cB.electricChars.indexOf(dj)>-1){setTimeout(av(function(){bR(dh.to.line,"smart")}),75)}}if(bB(dk,dj)){return}aY()}function be(di){if(bA.onKeyEvent&&bA.onKeyEvent(cA,w(di))){return}if(O(di,"keyCode")==16){bj=null}}function aH(){if(bA.readOnly=="nocursor"){return}if(!bi){if(bA.onFocus){bA.onFocus(cA)}bi=true;if(cm.className.search(/\bCodeMirror-focused\b/)==-1){cm.className+=" CodeMirror-focused"}if(!bv){a0(true)}}aA();aR()}function c9(){if(bi){if(bA.onBlur){bA.onBlur(cA)}bi=false;if(cv){av(function(){if(cv){cv();cv=null}})()}cm.className=cm.className.replace(" CodeMirror-focused","")}clearInterval(aN);setTimeout(function(){if(!bi){bj=null}},150)}function de(di){if(di>0&&di<1){return 1}else{if(di>-1&&di<0){return -1}else{return Math.round(di)}}}function aD(dl){var dj=0,dk=0;if(dl.type=="DOMMouseScroll"){var dm=-dl.detail*8;if(dl.axis==dl.HORIZONTAL_AXIS){dj=dm}else{if(dl.axis==dl.VERTICAL_AXIS){dk=dm}}}else{if(dl.wheelDeltaX!==undefined&&dl.wheelDeltaY!==undefined){dj=dl.wheelDeltaX/3;dk=dl.wheelDeltaY/3}else{if(dl.wheelDelta!==undefined){dk=dl.wheelDelta/3}}}var di=false;dj=de(dj);dk=de(dk);if((dj>0&&cm.scrollLeft>0)||(dj<0&&cm.scrollLeft+cm.clientWidth<cm.scrollWidth)){cm.scrollLeft-=dj;di=true}if((dk>0&&aQ.scrollTop>0)||(dk<0&&aQ.scrollTop+aQ.clientHeight<aQ.scrollHeight)){aQ.scrollTop-=dk;di=true}if(di){R(dl)}}function c0(dn,dm,dl,dj,di){if(cO){return}if(bs){var dk=[];cT.iter(dn.line,dm.line+1,function(dp){dk.push(dp.text)});bs.addChange(dn.line,dl.length,dk);while(bs.done.length>bA.undoDepth){bs.done.shift()}}ax(dn,dm,dl,dj,di)}function bo(dq,dp){if(!dq.length){return}var dn=dq.pop(),dj=[];for(var dk=dn.length-1;dk>=0;dk-=1){var dr=dn[dk];var dm=[],di=dr.start+dr.added;cT.iter(dr.start,di,function(ds){dm.push(ds.text)});dj.push({start:dr.start,added:dr.old.length,old:dm});var dl={line:dr.start+dr.old.length-1,ch:o(dm[dm.length-1],dr.old[dr.old.length-1])};ax({line:dr.start,ch:0},{line:di-1,ch:aX(di-1).text.length},dr.old,dl,dl)}ba=true;dp.push(dj)}function dd(){bo(bs.done,bs.undone)}function c1(){bo(bs.undone,bs.done)}function ax(dx,dk,dD,di,dE){if(cO){return}var dv=false,ds=bX.length;if(!bA.lineWrapping){cT.iter(dx.line,dk.line+1,function(dG){if(!dG.hidden&&dG.text.length==ds){dv=true;return true}})}if(dx.line!=dk.line||dD.length>1){a1=true}var dF=dk.line-dx.line,du=aX(dx.line),dt=aX(dk.line);if(dx.ch==0&&dk.ch==0&&dD[dD.length-1]==""){var dq=[],dl=null;if(dx.line){dl=aX(dx.line-1);dl.fixMarkEnds(dt)}else{dt.fixMarkStarts()}for(var dz=0,dC=dD.length-1;dz<dC;++dz){dq.push(j.inheritMarks(dD[dz],dl))}if(dF){cT.remove(dx.line,dF,a2)}if(dq.length){cT.insert(dx.line,dq)}}else{if(du==dt){if(dD.length==1){du.replace(dx.ch,dk.ch,dD[0])}else{dt=du.split(dk.ch,dD[dD.length-1]);du.replace(dx.ch,null,dD[0]);du.fixMarkEnds(dt);var dq=[];for(var dz=1,dC=dD.length-1;dz<dC;++dz){dq.push(j.inheritMarks(dD[dz],du))}dq.push(dt);cT.insert(dx.line+1,dq)}}else{if(dD.length==1){du.replace(dx.ch,null,dD[0]);dt.replace(null,dk.ch,"");du.append(dt);cT.remove(dx.line+1,dF,a2)}else{var dq=[];du.replace(dx.ch,null,dD[0]);dt.replace(null,dk.ch,dD[dD.length-1]);du.fixMarkEnds(dt);for(var dz=1,dC=dD.length-1;dz<dC;++dz){dq.push(j.inheritMarks(dD[dz],du))}if(dF>1){cT.remove(dx.line+1,dF-1,a2)}cT.insert(dx.line+1,dq)}}}if(bA.lineWrapping){var dr=Math.max(5,cm.clientWidth/bw()-3);cT.iter(dx.line,dx.line+dD.length,function(dG){if(dG.hidden){return}var dH=Math.ceil(dG.text.length/dr)||1;if(dH!=dG.height){cE(dG,dH)}})}else{cT.iter(dx.line,dx.line+dD.length,function(dH){var dG=dH.text;if(!dH.hidden&&dG.length>ds){bX=dG;ds=dG.length;cf=true;dv=false}});if(dv){aZ=true}}var dj=[],dp=dD.length-dF-1;for(var dz=0,dw=cF.length;dz<dw;++dz){var dA=cF[dz];if(dA<dx.line){dj.push(dA)}else{if(dA>dk.line){dj.push(dA+dp)}}}var dy=dx.line+Math.min(dD.length,500);cZ(dx.line,dy);dj.push(dy);cF=dj;bZ(100);aK.push({from:dx.line,to:dk.line+1,diff:dp});var dn={from:dx,to:dk,text:dD};if(aS){for(var dm=aS;dm.next;dm=dm.next){}dm.next=dn}else{aS=dn}function dB(dG){return dG<=Math.min(dk.line,dk.line+dp)?dG:dG+dp}b4(a3(di),a3(dE),dB(dh.from.line),dB(dh.to.line))}function aw(dk){var di=ca(),dj=Math.floor(cT.height*di+2*cN()),dl=cm.clientHeight;aQ.style.height=dl+"px";if(cm.clientHeight){bf.style.height=dj+"px"}if(dk!=null){aQ.scrollTop=dk}cG.style.top=(cq*di-aQ.scrollTop)+"px";aQ.style.display=(dj>dl)?"block":"none"}function bP(){var dk=document.createElement("div"),di=document.createElement("div");dk.className="CodeMirror-scrollbar";dk.style.cssText="position: absolute; left: -9999px; height: 100px;";di.className="CodeMirror-scrollbar-inner";di.style.height="200px";dk.appendChild(di);document.body.appendChild(dk);var dj=(dk.offsetWidth<=1);document.body.removeChild(dk);return dj}function bQ(){var di=0;bX="";cf=true;cT.iter(0,cT.size,function(dk){var dj=dk.text;if(!dk.hidden&&dj.length>di){di=dj.length;bX=dj}});aZ=false}function cc(dj,dm,dl){dm=a3(dm);if(!dl){dl=dm}else{dl=a3(dl)}dj=K(dj);function dk(dq){if(k(dq,dm)){return dq}if(!k(dl,dq)){return di}var dn=dq.line+dj.length-(dl.line-dm.line)-1;var dp=dq.ch;if(dq.line==dl.line){dp+=dj[dj.length-1].length-(dl.ch-(dl.line==dm.line?dm.ch:0))}return{line:dn,ch:dp}}var di;aL(dj,dm,dl,function(dn){di=dn;return{from:dk(dh.from),to:dk(dh.to)}});return di}function bL(di,dj){aL(K(di),dh.from,dh.to,function(dk){if(dj=="end"){return{from:dk,to:dk}}else{if(dj=="start"){return{from:dh.from,to:dh.from}}else{return{from:dh.from,to:dk}}}})}function aL(dk,dn,dm,dl){var di=dk.length==1?dk[0].length+dn.ch:dk[dk.length-1].length;var dj=dl({line:dn.line+dk.length-1,ch:di});c0(dn,dm,dk,dj.from,dj.to)}function c4(dm,dl){var dj=dm.line,di=dl.line;if(dj==di){return aX(dj).text.slice(dm.ch,dl.ch)}var dk=[aX(dj).text.slice(dm.ch)];cT.iter(dj+1,di,function(dn){dk.push(dn.text)});dk.push(aX(di).text.slice(0,dl.ch));return dk.join("\n")}function bx(){return c4(dh.from,dh.to)}var cb=false;function aA(){if(cb){return}cy.set(bA.pollInterval,function(){aT();bS();if(bi){aA()}aG()})}function aY(){var di=false;cb=true;function dj(){aT();var dk=bS();if(!dk&&!di){di=true;cy.set(60,dj)}else{cb=false;aA()}aG()}cy.set(20,dj)}var cu="";function bS(){if(bv||!bi||am(bD)||bA.readOnly){return false}var dj=bD.value;if(dj==cu){return false}bj=null;var dk=0,di=Math.min(cu.length,dj.length);while(dk<di&&cu[dk]==dj[dk]){++dk}if(dk<cu.length){dh.from={line:dh.from.line,ch:dh.from.ch-(cu.length-dk)}}else{if(bb&&al(dh.from,dh.to)){dh.to={line:dh.to.line,ch:Math.min(aX(dh.to.line).text.length,dh.to.ch+(dj.length-dk))}}}bL(dj.slice(dk),"end");if(dj.length>1000){bD.value=cu=""}else{cu=dj}return true}function a0(di){if(!al(dh.from,dh.to)){cu="";bD.value=bx();d(bD)}else{if(di){cu=bD.value=""}}}function b2(){if(bA.readOnly!="nocursor"){bD.focus()}}function aE(){if(!cs.getBoundingClientRect){return}var di=cs.getBoundingClientRect();if(X&&di.top==di.bottom){return}var dj=window.innerHeight||Math.max(document.body.offsetHeight,document.documentElement.offsetHeight);if(di.top<0||di.bottom>dj){bl()}}function bl(){var di=ce();return aJ(di.x,di.y,di.x,di.yBot)}function ce(){var dj=db(dh.inverted?dh.from:dh.to);var di=bA.lineWrapping?Math.min(dj.x,b9.offsetWidth):dj.x;return{x:di,y:dj.y,yBot:dj.yBot}}function aJ(dj,dm,di,dl){var dn=cJ(dj,dm,di,dl),dk=false;if(dn.scrollLeft!=null){cm.scrollLeft=dn.scrollLeft;dk=true}if(dn.scrollTop!=null){aQ.scrollTop=dn.scrollTop;dk=true}if(dk&&bA.onScroll){bA.onScroll(cA)}}function cJ(dk,du,dj,ds){var dm=cx(),dw=cN();du+=dw;ds+=dw;dk+=dm;dj+=dm;var dt=cm.clientHeight,dl=aQ.scrollTop,dr={};var di=du<cN()+10;if(du<dl){dr.scrollTop=di?0:Math.max(0,du)}else{if(ds>dl+dt){dr.scrollTop=ds-dt}}var dv=cm.clientWidth,dq=cm.scrollLeft;var dp=bA.fixedGutter?c8.clientWidth:0;var dn=dk<dp+dm+10;if(dk<dq+dp||dn){if(dn){dk=0}dr.scrollLeft=Math.max(0,dk-10-dp)}else{if(dj>dv+dq-3){dr.scrollLeft=dj+10-dv}}return dr}function b0(dm){var di=ca(),dl=(dm!=null?dm:aQ.scrollTop)-cN();var dk=Math.max(0,Math.floor(dl/di));var dj=Math.ceil((dl+cm.clientHeight)/di);return{from:n(cT,dk),to:n(cT,dj)}}function cD(du,dq,dm){if(!cm.clientWidth){da=bO=cq=0;return}var dp=b0(dm);if(du!==true&&du.length==0&&dp.from>da&&dp.to<bO){aw(dm);return}var dw=Math.max(dp.from-100,0),dv=Math.min(cT.size,dp.to+100);if(da<dw&&dw-da<20){dw=da}if(bO>dv&&bO-dv<20){dv=Math.min(cT.size,bO)}var dt=du===true?[]:ck([{from:da,to:bO,domStart:0}],du);var dn=0;for(var dr=0;dr<dt.length;++dr){var ds=dt[dr];if(ds.from<dw){ds.domStart+=(dw-ds.from);ds.from=dw}if(ds.to>dv){ds.to=dv}if(ds.from>=ds.to){dt.splice(dr--,1)}else{dn+=ds.to-ds.from}}if(dn==dv-dw&&dw==da&&dv==bO){aw(dm);return}dt.sort(function(dA,dz){return dA.domStart-dz.domStart});var dl=ca(),di=c8.style.display;au.style.display="none";cU(dw,dv,dt);au.style.display=c8.style.display="";var dk=dw!=da||dv!=bO||b8!=cm.clientHeight+dl;if(dk){b8=cm.clientHeight+dl}da=dw;bO=dv;cq=m(cT,dw);if(au.childNodes.length!=bO-da){throw new Error("BAD PATCH! "+JSON.stringify(dt)+" size="+(bO-da)+" nodes="+au.childNodes.length)}function dx(){var dA=au.firstChild,dz=false;cT.iter(da,bO,function(dB){if(!dB.hidden){var dC=Math.round(dA.offsetHeight/dl)||1;if(dB.height!=dC){cE(dB,dC);a1=dz=true}}dA=dA.nextSibling});return dz}if(bA.lineWrapping){var dy=Math.floor(cT.height*dl+2*cN()),dj=cm.clientHeight;if(dy>dj){aQ.style.display="block"}dx()}c8.style.display=di;if(dk||a1){c3()&&bA.lineWrapping&&dx()&&c3()}aF();aw(dm);if(!dq&&bA.onUpdate){bA.onUpdate(cA)}return true}function ck(dp,dq){for(var dm=0,dk=dq.length||0;dm<dk;++dm){var ds=dq[dm],di=[],dr=ds.diff||0;for(var dl=0,dj=dp.length;dl<dj;++dl){var dn=dp[dl];if(ds.to<=dn.from&&ds.diff){di.push({from:dn.from+dr,to:dn.to+dr,domStart:dn.domStart})}else{if(ds.to<=dn.from||ds.from>=dn.to){di.push(dn)}else{if(ds.from>dn.from){di.push({from:dn.from,to:ds.from,domStart:dn.domStart})}if(ds.to<dn.to){di.push({from:ds.to+dr,to:dn.to+dr,domStart:dn.domStart+(ds.to-dn.from)})}}}}dp=di}return dp}function cU(du,dt,ds){if(!ds.length){au.innerHTML=""}else{function dr(dx){var dw=dx.nextSibling;dx.parentNode.removeChild(dx);return dw}var dl=0,dk=au.firstChild,di;for(var dn=0;dn<ds.length;++dn){var dv=ds[dn];while(dv.domStart>dl){dk=dr(dk);dl++}for(var dm=0,dp=dv.to-dv.from;dm<dp;++dm){dk=dk.nextSibling;dl++}}while(dk){dk=dr(dk)}}var dj=ds.shift(),dk=au.firstChild,dm=du;var dq=document.createElement("div");cT.iter(du,dt,function(dw){if(dj&&dj.to==dm){dj=ds.shift()}if(!dj||dj.from>dm){if(dw.hidden){var dx=dq.innerHTML="<pre></pre>"}else{var dx="<pre"+(dw.className?' class="'+dw.className+'"':"")+">"+dw.getHTML(bu)+"</pre>";if(dw.bgClassName){dx='<div style="position: relative"><pre class="'+dw.bgClassName+'" style="position: absolute; left: 0; right: 0; top: 0; bottom: 0; z-index: -2">&#160;</pre>'+dx+"</div>"}}dq.innerHTML=dx;au.insertBefore(dq.firstChild,dk)}else{dk=dk.nextSibling}++dm})}function c3(){if(!bA.gutter&&!bA.lineNumbers){return}var di=cG.offsetHeight,dr=cm.clientHeight;c8.style.height=(di-dr<2?dr:di)+"px";var dq=[],dm=da,ds;cT.iter(da,Math.max(bO,da+1),function(dt){if(dt.hidden){dq.push("<pre></pre>")}else{var dv=dt.gutterMarker;var dw=bA.lineNumbers?dm+bA.firstLineNumber:null;if(dv&&dv.text){dw=dv.text.replace("%N%",dw!=null?dw:"")}else{if(dw==null){dw="\u00a0"}}dq.push((dv&&dv.style?'<pre class="'+dv.style+'">':"<pre>"),dw);for(var du=1;du<dt.height;++du){dq.push("<br/>&#160;")}dq.push("</pre>");if(!dv){ds=dm}}++dm});c8.style.display="none";cK.innerHTML=dq.join("");if(ds!=null&&bA.lineNumbers){var dl=cK.childNodes[ds-da];var dn=String(cT.size).length,dj=C(dl.firstChild),dk="";while(dj.length+dk.length<dn){dk+="\u00a0"}if(dk){dl.insertBefore(document.createTextNode(dk),dl.firstChild)}}c8.style.display="";var dp=Math.abs((parseInt(b9.style.marginLeft)||0)-c8.offsetWidth)>2;b9.style.marginLeft=c8.offsetWidth+"px";a1=false;return dp}function aF(){var dm=al(dh.from,dh.to);var ds=db(dh.from,true);var dr=dm?ds:db(dh.to,true);var dq=dh.inverted?ds:dr,dj=ca();var di=an(aM),dl=an(au);cj.style.top=Math.max(0,Math.min(cm.offsetHeight,dq.y+dl.top-di.top))+"px";cj.style.left=Math.max(0,Math.min(cm.offsetWidth,dq.x+dl.left-di.left))+"px";if(dm){cs.style.top=dq.y+"px";cs.style.left=(bA.lineWrapping?Math.min(dq.x,b9.offsetWidth):dq.x)+"px";cs.style.display="";co.style.display="none"}else{var du=ds.y==dr.y,dp="";var dv=b9.clientWidth||b9.offsetWidth;var dk=b9.clientHeight||b9.offsetHeight;function dw(dC,dB,dz,dA){var dy=U?"width: "+(!dz?dv:dv-dz-dC)+"px":"right: "+dz+"px";dp+='<div class="CodeMirror-selected" style="position: absolute; left: '+dC+"px; top: "+dB+"px; "+dy+"; height: "+dA+'px"></div>'}if(dh.from.ch&&ds.y>=0){var dt=du?dv-dr.x:0;dw(ds.x,ds.y,dt,dj)}var dn=Math.max(0,ds.y+(dh.from.ch?dj:0));var dx=Math.min(dr.y,dk)-dn;if(dx>0.2*dj){dw(0,dn,0,dx)}if((!du||!dh.from.ch)&&dr.y<dk-0.5*dj){dw(0,dr.y,dv-dr.x,dj)}co.innerHTML=dp;cs.style.display="none";co.style.display=""}}function bn(di){if(di){bj=bj||(dh.inverted?dh.to:dh.from)}else{bj=null}}function b3(dk,dj){var di=bj&&a3(bj);if(di){if(k(di,dk)){dk=di}else{if(k(dj,di)){dj=di}}}b4(dk,dj);bp=true}function b4(dq,dp,dm,dn){a5=null;if(dm==null){dm=dh.from.line;dn=dh.to.line}if(al(dh.from,dq)&&al(dh.to,dp)){return}if(k(dp,dq)){var dk=dp;dp=dq;dq=dk}if(dq.line!=dm){var dl=bJ(dq,dm,dh.from.ch);if(!dl){aU(dq.line,false)}else{dq=dl}}if(dp.line!=dn){dp=bJ(dp,dn,dh.to.ch)}if(al(dq,dp)){dh.inverted=false}else{if(al(dq,dh.to)){dh.inverted=false}else{if(al(dp,dh.from)){dh.inverted=true}}}if(bA.autoClearEmptyLines&&al(dh.from,dh.to)){var dj=dh.inverted?dq:dp;if(dj.line!=dh.from.line&&dh.from.line<cT.size){var di=aX(dh.from.line);if(/^\s+$/.test(di.text)){setTimeout(av(function(){if(di.parent&&/^\s+$/.test(di.text)){var dr=l(di);cc("",{line:dr,ch:0},{line:dr,ch:di.text.length})}},10))}}}dh.from=dq;dh.to=dp;aW=true}function bJ(dn,dk,dj){function dm(dr){var dt=dn.line+dr,dq=dr==1?cT.size:-1;while(dt!=dq){var dp=aX(dt);if(!dp.hidden){var ds=dn.ch;if(dl||ds>dj||ds>dp.text.length){ds=dp.text.length}return{line:dt,ch:ds}}dt+=dr}}var di=aX(dn.line);var dl=dn.ch==di.text.length&&dn.ch!=dj;if(!di.hidden){return dn}if(dn.line>=dk){return dm(1)||dm(-1)}else{return dm(-1)||dm(1)}}function bq(di,dk,dj){var dl=a3({line:di,ch:dk||0});(dj?b3:b4)(dl,dl)}function ci(di){return Math.max(0,Math.min(di,cT.size-1))}function a3(dk){if(dk.line<0){return{line:0,ch:0}}if(dk.line>=cT.size){return{line:cT.size-1,ch:aX(cT.size-1).text.length}}var di=dk.ch,dj=aX(dk.line).text.length;if(di==null||di>dj){return{line:dk.line,ch:dj}}else{if(di<0){return{line:dk.line,ch:0}}else{return dk}}}function bc(dl,dq){var dn=dh.inverted?dh.from:dh.to,dr=dn.line,di=dn.ch;var dp=aX(dr);function dj(){for(var ds=dr+dl,du=dl<0?-1:cT.size;ds!=du;ds+=dl){var dt=aX(ds);if(!dt.hidden){dr=ds;dp=dt;return true}}}function dm(ds){if(di==(dl<0?0:dp.text.length)){if(!ds&&dj()){di=dl<0?dp.text.length:0}else{return false}}else{di+=dl}return true}if(dq=="char"){dm()}else{if(dq=="column"){dm(true)}else{if(dq=="word"){var dk=false;for(;;){if(dl<0){if(!dm()){break}}if(a(dp.text.charAt(di))){dk=true}else{if(dk){if(dl<0){dl=1;dm()}break}}if(dl>0){if(!dm()){break}}}}}}return{line:dr,ch:di}}function cX(di,dj){var dk=di<0?dh.from:dh.to;if(bj||al(dh.from,dh.to)){dk=bc(di,dj)}bq(dk.line,dk.ch,true)}function cI(di,dj){if(!al(dh.from,dh.to)){cc("",dh.from,dh.to)}else{if(di<0){cc("",bc(di,dj),dh.to)}else{cc("",dh.from,bc(di,dj))}}bp=true}var a5=null;function cS(di,dj){var dk=0,dm=db(dh.inverted?dh.from:dh.to,true);if(a5!=null){dm.x=a5}if(dj=="page"){dk=Math.min(cm.clientHeight,window.innerHeight||document.documentElement.clientHeight)}else{if(dj=="line"){dk=ca()}}var dl=bY(dm.x,dm.y+dk*di+2);if(dj=="page"){aQ.scrollTop+=db(dl,true).y-dm.y}bq(dl.line,dl.ch,true);a5=dm.x}function bT(dl){var dj=aX(dl.line).text;var dk=dl.ch,di=dl.ch;while(dk>0&&a(dj.charAt(dk-1))){--dk}while(di<dj.length&&a(dj.charAt(di))){++di}b3({line:dl.line,ch:dk},{line:dl.line,ch:di})}function c6(di){b3({line:di,ch:0},a3({line:di+1,ch:0}))}function cV(dk){if(al(dh.from,dh.to)){return bR(dh.from.line,dk)}var dj=dh.to.line-(dh.to.ch?0:1);for(var di=dh.from.line;di<=dj;++di){bR(di,dk)}}function bR(dj,dr){if(!dr){dr="add"}if(dr=="smart"){if(!cB.indent){dr="prev"}else{var di=cP(dj)}}var dt=aX(dj),dl=dt.indentation(bA.tabSize),dm=dt.text.match(/^\s*/)[0],dp;if(dr=="smart"){dp=cB.indent(di,dt.text.slice(dm.length),dt.text);if(dp==ak){dr="prev"}}if(dr=="prev"){if(dj){dp=aX(dj-1).indentation(bA.tabSize)}else{dp=0}}else{if(dr=="add"){dp=dl+bA.indentUnit}else{if(dr=="subtract"){dp=dl-bA.indentUnit}}}dp=Math.max(0,dp);var ds=dp-dl;if(!ds){if(dh.from.line!=dj&&dh.to.line!=dj){return}var dq=dm}else{var dq="",dn=0;if(bA.indentWithTabs){for(var dk=Math.floor(dp/bA.tabSize);dk;--dk){dn+=bA.tabSize;dq+="\t"}}while(dn<dp){++dn;dq+=" "}}cc(dq,{line:dj,ch:0},{line:dj,ch:dm.length})}function cg(){cB=P.getMode(bA,bA.mode);cT.iter(0,cT.size,function(di){di.stateAfter=null});cF=[0];bZ()}function cp(){var di=bA.gutter||bA.lineNumbers;c8.style.display=di?"":"none";if(di){a1=true}else{au.parentNode.style.marginLeft=0}}function cY(dk,dj){if(bA.lineWrapping){aM.className+=" CodeMirror-wrap";var di=cm.clientWidth/bw()-3;cT.iter(0,cT.size,function(dl){if(dl.hidden){return}var dm=Math.ceil(dl.text.length/di)||1;if(dm!=1){cE(dl,dm)}});b9.style.width=b7.style.width="";br.style.left=""}else{aM.className=aM.className.replace(" CodeMirror-wrap","");bX="";cf=true;cT.iter(0,cT.size,function(dl){if(dl.height!=1&&!dl.hidden){cE(dl,1)}if(dl.text.length>bX.length){bX=dl.text}})}aK.push({from:0,to:cT.size})}function bu(dk){var di=bA.tabSize-dk%bA.tabSize,dj=ay[di];if(dj){return dj}for(var dm='<span class="cm-tab">',dl=0;dl<di;++dl){dm+=" "}return(ay[di]={html:dm+"</span>",width:di})}function cW(){cm.className=cm.className.replace(/\s*cm-s-\S+/g,"")+bA.theme.replace(/(^|\s)\s*/g," cm-s-")}function a6(){var di=Q[bA.keyMap].style;aM.className=aM.className.replace(/\s*cm-keymap-\S+/g,"")+(di?" cm-keymap-"+di:"")}function aC(){this.set=[]}aC.prototype.clear=av(function(){var dn=Infinity,dj=-Infinity;for(var dm=0,dq=this.set.length;dm<dq;++dm){var dk=this.set[dm],di=dk.marked;if(!di||!dk.parent){continue}var dp=l(dk);dn=Math.min(dn,dp);dj=Math.max(dj,dp);for(var dl=0;dl<di.length;++dl){if(di[dl].marker==this){di.splice(dl--,1)}}}if(dn!=Infinity){aK.push({from:dn,to:dj+1})}});aC.prototype.find=function(){var dp,dn;for(var dl=0,dm=this.set.length;dl<dm;++dl){var dr=this.set[dl],dk=dr.marked;for(var dj=0;dj<dk.length;++dj){var di=dk[dj];if(di.marker==this){if(di.from!=null||di.to!=null){var dq=l(dr);if(dq!=null){if(di.from!=null){dp={line:dq,ch:di.from}}if(di.to!=null){dn={line:dq,ch:di.to}}}}}}}return{from:dp,to:dn}};function bW(dp,dn,dj){dp=a3(dp);dn=a3(dn);var di=new aC();if(!k(dp,dn)){return di}function dm(dq,dt,ds,dr){aX(dq).addMark(new A(dt,ds,dr,di))}if(dp.line==dn.line){dm(dp.line,dp.ch,dn.ch,dj)}else{dm(dp.line,dp.ch,null,dj);for(var dk=dp.line+1,dl=dn.line;dk<dl;++dk){dm(dk,null,null,dj)}dm(dn.line,null,dn.ch,dj)}aK.push({from:dp.line,to:dn.line+1});return di}function cQ(dj){dj=a3(dj);var di=new W(dj.ch);aX(dj.line).addMark(di);return di}function bG(dn){dn=a3(dn);var dm=[],dj=aX(dn.line).marked;if(!dj){return dm}for(var dk=0,dl=dj.length;dk<dl;++dk){var di=dj[dk];if((di.from==null||di.from<=dn.ch)&&(di.to==null||di.to>=dn.ch)){dm.push(di.marker||di)}}return dm}function bF(di,dk,dj){if(typeof di=="number"){di=aX(ci(di))}di.gutterMarker={text:dk,style:dj};a1=true;return di}function ar(di){if(typeof di=="number"){di=aX(ci(di))}di.gutterMarker=null;a1=true}function cL(di,dl){var dk=di,dj=di;if(typeof di=="number"){dj=aX(ci(di))}else{dk=l(di)}if(dk==null){return null}if(dl(dj,dk)){aK.push({from:dk,to:dk+1})}else{return null}return dj}function cl(di,dj,dk){return cL(di,function(dl){if(dl.className!=dj||dl.bgClassName!=dk){dl.className=dj;dl.bgClassName=dk;return true}})}function aU(dj,di){return cL(dj,function(dl,dp){if(dl.hidden!=di){dl.hidden=di;if(!bA.lineWrapping){var dk=dl.text;if(di&&dk.length==bX.length){aZ=true}else{if(!di&&dk.length>bX.length){bX=dk;maxWidth=null;aZ=false}}}cE(dl,di?0:1);var dn=dh.from.line,dm=dh.to.line;if(di&&(dn==dp||dm==dp)){var dr=dn==dp?bJ({line:dn,ch:0},dn,0):dh.from;var dq=dm==dp?bJ({line:dm,ch:0},dm,0):dh.to;if(!dq){return}b4(dr,dq)}return(a1=true)}})}function a8(di){if(typeof di=="number"){if(!cd(di)){return null}var dk=di;di=aX(di);if(!di){return null}}else{var dk=l(di);if(dk==null){return null}}var dj=di.gutterMarker;return{line:dk,handle:di,text:di.text,markerText:dj&&dj.text,markerClass:dj&&dj.style,lineClass:di.className,bgClass:di.bgClassName}}function a7(di){az.innerHTML="<pre><span>x</span></pre>";az.firstChild.firstChild.firstChild.nodeValue=di;return az.firstChild.firstChild.offsetWidth||10}function aO(dv,dp){if(dp<=0){return 0}var dk=aX(dv),du=dk.text;function dt(dw){return bt(dk,dw).left}var ds=0,dq=0,dr=du.length,dn;var dl=Math.min(dr,Math.ceil(dp/bw()));for(;;){var dj=dt(dl);if(dj<=dp&&dl<dr){dl=Math.min(dr,Math.ceil(dl*1.2))}else{dn=dj;dr=dl;break}}if(dp>dn){return dr}dl=Math.floor(dr*0.8);dj=dt(dl);if(dj<dp){ds=dl;dq=dj}for(;;){if(dr-ds<=1){return(dn-dp>dp-dq)?ds:dr}var dm=Math.ceil((ds+dr)/2),di=dt(dm);if(di>dp){dr=dm;dn=di}else{ds=dm;dq=di}}}var a4="CodeMirror-temp-"+Math.floor(Math.random()*16777215).toString(16);function bt(dj,dm){if(dm==0){return{top:0,left:0}}var di=bA.lineWrapping&&dm<dj.text.length&&D.test(dj.text.slice(dm-1,dm+1));az.innerHTML="<pre>"+dj.getHTML(bu,dm,a4,di)+"</pre>";var dk=document.getElementById(a4);var dp=dk.offsetTop,dn=dk.offsetLeft;if(X&&dp==0&&dn==0){var dl=document.createElement("span");dl.innerHTML="x";dk.parentNode.insertBefore(dl,dk.nextSibling);dp=dl.offsetTop}return{top:dp,left:dn}}function db(dn,dl){var di,dj=ca(),dm=dj*(m(cT,dn.line)-(dl?cq:0));if(dn.ch==0){di=0}else{var dk=bt(aX(dn.line),dn.ch);di=dk.left;if(bA.lineWrapping){dm+=Math.max(0,dk.top)}}return{x:di,y:dm,yBot:dm+dj}}function bY(du,dt){if(dt<0){dt=0}var dq=ca(),dp=bw(),dz=cq+Math.floor(dt/dq);var dj=n(cT,dz);if(dj>=cT.size){return{line:cT.size-1,ch:aX(cT.size-1).text.length}}var dk=aX(dj),dv=dk.text;var dB=bA.lineWrapping,ds=dB?dz-m(cT,dj):0;if(du<=0&&ds==0){return{line:dj,ch:0}}function dA(dC){var dD=bt(dk,dC);if(dB){var dE=Math.round(dD.top/dq);return Math.max(0,dD.left+(dE-ds)*cm.clientWidth)}return dD.left}var dy=0,dw=0,dm=dv.length,dl;var di=Math.min(dm,Math.ceil((du+ds*cm.clientWidth*0.9)/dp));for(;;){var dr=dA(di);if(dr<=du&&di<dm){di=Math.min(dm,Math.ceil(di*1.2))}else{dl=dr;dm=di;break}}if(du>dl){return{line:dj,ch:dm}}di=Math.floor(dm*0.8);dr=dA(di);if(dr<du){dy=di;dw=dr}for(;;){if(dm-dy<=1){return{line:dj,ch:(dl-du>du-dw)?dy:dm}}var dx=Math.ceil((dy+dm)/2),dn=dA(dx);if(dn>du){dm=dx;dl=dn}else{dy=dx;dw=dn}}}function at(dk){var di=db(dk,true),dj=an(b9);return{x:dj.left+di.x,y:dj.top+di.y,yBot:dj.top+di.yBot}}var bg,df,bE;function ca(){if(bE==null){bE="<pre>";for(var dj=0;dj<49;++dj){bE+="x<br/>"}bE+="x</pre>"}var di=au.clientHeight;if(di==df){return bg}df=di;az.innerHTML=bE;bg=az.firstChild.offsetHeight/50||1;az.innerHTML="";return bg}var dc,bN=0;function bw(){if(cm.clientWidth==bN){return dc}bN=cm.clientWidth;return(dc=a7("x"))}function cN(){return b9.offsetTop}function cx(){return b9.offsetLeft}function bk(dm,dl){var dk=an(cm,true),di,dn;try{di=dm.clientX;dn=dm.clientY}catch(dm){return null}if(!dl&&(di-dk.left>cm.clientWidth||dn-dk.top>cm.clientHeight)){return null}var dj=an(b9,true);return bY(di-dj.left,dn-dj.top)}function bh(dj){var dp=bk(dj),dn=aQ.scrollTop;if(!dp||Y){return}if(al(dh.from,dh.to)||k(dp,dh.from)||!k(dp,dh.to)){av(bq)(dp.line,dp.ch)}var dm=bD.style.cssText;cj.style.position="absolute";bD.style.cssText="position: fixed; width: 30px; height: 30px; top: "+(dj.clientY-5)+"px; left: "+(dj.clientX-5)+"px; z-index: 1000; background: white; border-width: 0; outline: none; overflow: hidden; opacity: .05; filter: alpha(opacity=5);";bv=true;var dl=bD.value=bx();b2();d(bD);function di(){var dq=K(bD.value).join("\n");if(dq!=dl&&!bA.readOnly){av(bL)(dq,"end")}cj.style.position="relative";bD.style.cssText=dm;if(J){aQ.scrollTop=dn}bv=false;a0(true);aA()}if(aa){R(dj);var dk=H(window,"mouseup",function(){dk();setTimeout(di,20)},true)}else{setTimeout(di,50)}}function aR(){clearInterval(aN);var di=true;cs.style.visibility="";aN=setInterval(function(){cs.style.visibility=(di=!di)?"":"hidden"},650)}var bI={"(":")>",")":"(<","[":"]>","]":"[<","{":"}>","}":"{<"};function bm(dp){var dj=dh.inverted?dh.from:dh.to,dr=aX(dj.line),dk=dj.ch-1;var dq=(dk>=0&&bI[dr.text.charAt(dk)])||bI[dr.text.charAt(++dk)];if(!dq){return}var ds=dq.charAt(0),di=dq.charAt(1)==">",dC=di?1:-1,dx=dr.styles;for(var dD=dk+1,dz=0,dB=dx.length;dz<dB;dz+=2){if((dD-=dx[dz].length)<=0){var dA=dx[dz+1];break}}var dn=[dr.text.charAt(dk)],dw=/[(){}[\]]/;function du(dP,dL,dK){if(!dP.text){return}var dO=dP.styles,dJ=di?0:dP.text.length-1,dM;for(var dG=di?0:dO.length-2,dI=di?dO.length:-2;dG!=dI;dG+=2*dC){var dN=dO[dG];if(dO[dG+1]!=dA){dJ+=dC*dN.length;continue}for(var dF=di?0:dN.length-1,dE=di?dN.length:-1;dF!=dE;dF+=dC,dJ+=dC){if(dJ>=dL&&dJ<dK&&dw.test(dM=dN.charAt(dF))){var dH=bI[dM];if(dH.charAt(1)==">"==di){dn.push(dM)}else{if(dn.pop()!=dH.charAt(0)){return{pos:dJ,match:false}}else{if(!dn.length){return{pos:dJ,match:true}}}}}}}}for(var dz=dj.line,dB=di?Math.min(dz+100,cT.size):Math.max(-1,dz-100);dz!=dB;dz+=dC){var dr=aX(dz),dm=dz==dj.line;var dt=du(dr,dm&&di?dk+1:0,dm&&!di?dk:dr.text.length);if(dt){break}}if(!dt){dt={pos:null,match:false}}var dA=dt.match?"CodeMirror-matchingbracket":"CodeMirror-nonmatchingbracket";var dy=bW({line:dj.line,ch:dk},{line:dj.line,ch:dk+1},dA),dl=dt.pos!=null&&bW({line:dz,ch:dt.pos},{line:dz,ch:dt.pos+1},dA);var dv=av(function(){dy.clear();dl&&dl.clear()});if(dp){setTimeout(dv,800)}else{cv=dv}}function cw(dp){var dn,dk;for(var dj=dp,dl=dp-40;dj>dl;--dj){if(dj==0){return 0}var di=aX(dj-1);if(di.stateAfter){return dj}var dm=di.indentation(bA.tabSize);if(dk==null||dn>dm){dk=dj-1;dn=dm}}return dk}function cP(dk){var dj=cw(dk),di=dj&&aX(dj-1).stateAfter;if(!di){di=s(cB)}else{di=E(cB,di)}cT.iter(dj,dk,function(dl){dl.highlight(cB,di,bA.tabSize);dl.stateAfter=E(cB,di)});if(dj<dk){aK.push({from:dj,to:dk})}if(dk<cT.size&&!aX(dk).stateAfter){cF.push(dk)}return di}function cZ(dk,di){var dj=cP(dk);cT.iter(dk,di,function(dl){dl.highlight(cB,dj,bA.tabSize);dl.stateAfter=E(cB,dj)})}function bH(){var dn=+new Date+bA.workTime;var ds=cF.length;while(cF.length){if(!aX(da).stateAfter){var dl=da}else{var dl=cF.pop()}if(dl>=cT.size){continue}var dk=cw(dl),di=dk&&aX(dk-1).stateAfter;if(di){di=E(cB,di)}else{di=s(cB)}var dp=0,dj=cB.compareStates,dr=false,dq=dk,dm=false;cT.iter(dq,cT.size,function(dv){var du=dv.stateAfter;if(+new Date>dn){cF.push(dq);bZ(bA.workDelay);if(dr){aK.push({from:dl,to:dq+1})}return(dm=true)}var dw=dv.highlight(cB,di,bA.tabSize);if(dw){dr=true}dv.stateAfter=E(cB,di);var dt=null;if(dj){var dx=du&&dj(du,di);if(dx!=ak){dt=!!dx}}if(dt==null){if(dw!==false||!du){dp=0}else{if(++dp>3&&(!cB.indent||cB.indent(du,"")==cB.indent(di,""))){dt=true}}}if(dt){return true}++dq});if(dm){return}if(dr){aK.push({from:dl,to:dq+1})}}if(ds&&bA.onHighlightComplete){bA.onHighlightComplete(cA)}}function bZ(di){if(!cF.length){return}dg.set(di,av(bH))}function aT(){ba=bp=aS=null;aK=[];aW=false;a2=[]}function aG(){if(aZ){bQ()}if(cf&&!bA.lineWrapping){br.style.left=a7(bX)+"px";cf=false}var dl,dm;if(aW){var di=ce();dl=cJ(di.x,di.y,di.x,di.yBot)}if(aK.length){dm=cD(aK,true,(dl?dl.scrollTop:null))}else{if(aW){aF()}if(a1){c3()}}if(dl){bl()}if(aW){aE();aR()}if(bi&&!bv&&(ba===true||(ba!==false&&aW))){a0(bp)}if(aW&&bA.matchBrackets){setTimeout(av(function(){if(cv){cv();cv=null}if(al(dh.from,dh.to)){bm(false)}}),20)}var dn=aW,dj=a2;if(aS&&bA.onChange&&cA){bA.onChange(cA,aS)}if(dn&&bA.onCursorActivity){bA.onCursorActivity(cA)}for(var dk=0;dk<dj.length;++dk){dj[dk](cA)}if(dm&&bA.onUpdate){bA.onUpdate(cA)}}var cM=0;function av(di){return function(){if(!cM++){aT()}try{var dj=di.apply(this,arguments)}finally{if(!--cM){aG()}}return dj}}function bM(di){bs.startCompound();try{return di()}finally{bs.endCompound()}}for(var b1 in i){if(i.propertyIsEnumerable(b1)&&!cA.propertyIsEnumerable(b1)){cA[b1]=i[b1]}}return cA}P.defaults={value:"",mode:null,theme:"default",indentUnit:2,indentWithTabs:false,smartIndent:true,tabSize:4,keyMap:"default",extraKeys:null,electricChars:true,autoClearEmptyLines:false,onKeyEvent:null,onDragEvent:null,lineWrapping:false,lineNumbers:false,gutter:false,fixedGutter:false,firstLineNumber:1,readOnly:false,dragDrop:true,onChange:null,onCursorActivity:null,onGutterClick:null,onHighlightComplete:null,onUpdate:null,onFocus:null,onBlur:null,onScroll:null,matchBrackets:false,workTime:100,workDelay:200,pollInterval:100,undoDepth:40,tabindex:null,autofocus:null};var L=/AppleWebKit/.test(navigator.userAgent)&&/Mobile\/\w+/.test(navigator.userAgent);var Z=L||/Mac/.test(navigator.platform);var af=/Win/.test(navigator.platform);var ap=P.modes={},u=P.mimeModes={};P.defineMode=function(ar,au){if(!P.defaults.mode&&ar!="null"){P.defaults.mode=ar}if(arguments.length>2){au.dependencies=[];for(var at=2;at<arguments.length;++at){au.dependencies.push(arguments[at])}}ap[ar]=au};P.defineMIME=function(at,ar){u[at]=ar};P.resolveMode=function(ar){if(typeof ar=="string"&&u.hasOwnProperty(ar)){ar=u[ar]}else{if(typeof ar=="string"&&/^[\w\-]+\/[\w\-]+\+xml$/.test(ar)){return P.resolveMode("application/xml")}}if(typeof ar=="string"){return{name:ar}}else{return ar||{name:"null"}}};P.getMode=function(au,ar){var ar=P.resolveMode(ar);var at=ap[ar.name];if(!at){return P.getMode(au,"text/plain")}return at(au,ar)};P.listModes=function(){var at=[];for(var ar in ap){if(ap.propertyIsEnumerable(ar)){at.push(ar)}}return at};P.listMIMEs=function(){var at=[];for(var ar in u){if(u.propertyIsEnumerable(ar)){at.push({mime:ar,mode:u[ar]})}}return at};var i=P.extensions={};P.defineExtension=function(ar,at){i[ar]=at};var z=P.commands={selectAll:function(ar){ar.setSelection({line:0,ch:0},{line:ar.lineCount()-1})},killLine:function(ar){var av=ar.getCursor(true),au=ar.getCursor(false),at=!al(av,au);if(!at&&ar.getLine(av.line).length==av.ch){ar.replaceRange("",av,{line:av.line+1,ch:0})}else{ar.replaceRange("",av,at?au:{line:av.line})}},deleteLine:function(ar){var at=ar.getCursor().line;ar.replaceRange("",{line:at,ch:0},{line:at})},undo:function(ar){ar.undo()},redo:function(ar){ar.redo()},goDocStart:function(ar){ar.setCursor(0,0,true)},goDocEnd:function(ar){ar.setSelection({line:ar.lineCount()-1},null,true)},goLineStart:function(ar){ar.setCursor(ar.getCursor().line,0,true)},goLineStartSmart:function(ar){var au=ar.getCursor();var at=ar.getLine(au.line),av=Math.max(0,at.search(/\S/));ar.setCursor(au.line,au.ch<=av&&au.ch?0:av,true)},goLineEnd:function(ar){ar.setSelection({line:ar.getCursor().line},null,true)},goLineUp:function(ar){ar.moveV(-1,"line")},goLineDown:function(ar){ar.moveV(1,"line")},goPageUp:function(ar){ar.moveV(-1,"page")},goPageDown:function(ar){ar.moveV(1,"page")},goCharLeft:function(ar){ar.moveH(-1,"char")},goCharRight:function(ar){ar.moveH(1,"char")},goColumnLeft:function(ar){ar.moveH(-1,"column")},goColumnRight:function(ar){ar.moveH(1,"column")},goWordLeft:function(ar){ar.moveH(-1,"word")},goWordRight:function(ar){ar.moveH(1,"word")},delCharLeft:function(ar){ar.deleteH(-1,"char")},delCharRight:function(ar){ar.deleteH(1,"char")},delWordLeft:function(ar){ar.deleteH(-1,"word")},delWordRight:function(ar){ar.deleteH(1,"word")},indentAuto:function(ar){ar.indentSelection("smart")},indentMore:function(ar){ar.indentSelection("add")},indentLess:function(ar){ar.indentSelection("subtract")},insertTab:function(ar){ar.replaceSelection("\t","end")},defaultTab:function(ar){if(ar.somethingSelected()){ar.indentSelection("add")}else{ar.replaceSelection("\t","end")}},transposeChars:function(ar){var au=ar.getCursor(),at=ar.getLine(au.line);if(au.ch>0&&au.ch<at.length-1){ar.replaceRange(at.charAt(au.ch)+at.charAt(au.ch-1),{line:au.line,ch:au.ch-1},{line:au.line,ch:au.ch+1})}},newlineAndIndent:function(ar){ar.replaceSelection("\n","end");ar.indentLine(ar.getCursor().line)},toggleOverwrite:function(ar){ar.toggleOverwrite()}};var Q=P.keyMap={};Q.basic={Left:"goCharLeft",Right:"goCharRight",Up:"goLineUp",Down:"goLineDown",End:"goLineEnd",Home:"goLineStartSmart",PageUp:"goPageUp",PageDown:"goPageDown",Delete:"delCharRight",Backspace:"delCharLeft",Tab:"defaultTab","Shift-Tab":"indentAuto",Enter:"newlineAndIndent",Insert:"toggleOverwrite"};Q.pcDefault={"Ctrl-A":"selectAll","Ctrl-D":"deleteLine","Ctrl-Z":"undo","Shift-Ctrl-Z":"redo","Ctrl-Y":"redo","Ctrl-Home":"goDocStart","Alt-Up":"goDocStart","Ctrl-End":"goDocEnd","Ctrl-Down":"goDocEnd","Ctrl-Left":"goWordLeft","Ctrl-Right":"goWordRight","Alt-Left":"goLineStart","Alt-Right":"goLineEnd","Ctrl-Backspace":"delWordLeft","Ctrl-Delete":"delWordRight","Ctrl-S":"save","Ctrl-F":"find","Ctrl-G":"findNext","Shift-Ctrl-G":"findPrev","Shift-Ctrl-F":"replace","Shift-Ctrl-R":"replaceAll","Ctrl-[":"indentLess","Ctrl-]":"indentMore",fallthrough:"basic"};Q.macDefault={"Cmd-A":"selectAll","Cmd-D":"deleteLine","Cmd-Z":"undo","Shift-Cmd-Z":"redo","Cmd-Y":"redo","Cmd-Up":"goDocStart","Cmd-End":"goDocEnd","Cmd-Down":"goDocEnd","Alt-Left":"goWordLeft","Alt-Right":"goWordRight","Cmd-Left":"goLineStart","Cmd-Right":"goLineEnd","Alt-Backspace":"delWordLeft","Ctrl-Alt-Backspace":"delWordRight","Alt-Delete":"delWordRight","Cmd-S":"save","Cmd-F":"find","Cmd-G":"findNext","Shift-Cmd-G":"findPrev","Cmd-Alt-F":"replace","Shift-Cmd-Alt-F":"replaceAll","Cmd-[":"indentLess","Cmd-]":"indentMore",fallthrough:["basic","emacsy"]};Q["default"]=Z?Q.macDefault:Q.pcDefault;Q.emacsy={"Ctrl-F":"goCharRight","Ctrl-B":"goCharLeft","Ctrl-P":"goLineUp","Ctrl-N":"goLineDown","Alt-F":"goWordRight","Alt-B":"goWordLeft","Ctrl-A":"goLineStart","Ctrl-E":"goLineEnd","Ctrl-V":"goPageUp","Shift-Ctrl-V":"goPageDown","Ctrl-D":"delCharRight","Ctrl-H":"delCharLeft","Alt-D":"delWordRight","Alt-Backspace":"delWordLeft","Ctrl-K":"killLine","Ctrl-T":"transposeChars"};function f(ar){if(typeof ar=="string"){return Q[ar]}else{return ar}}function v(at,av,aw,ar,au){function ax(aC){aC=f(aC);var aA=aC[at];if(aA!=null&&ar(aA)){return true}if(aC.nofallthrough){if(au){au()}return true}var ay=aC.fallthrough;if(ay==null){return false}if(Object.prototype.toString.call(ay)!="[object Array]"){return ax(ay)}for(var az=0,aB=ay.length;az<aB;++az){if(ax(ay[az])){return true}}return false}if(av&&ax(av)){return true}return ax(aw)}function ac(at){var ar=ad[O(at,"keyCode")];return ar=="Ctrl"||ar=="Alt"||ar=="Shift"||ar=="Mod"}P.fromTextArea=function(ax,at){if(!at){at={}}at.value=ax.value;if(!at.tabindex&&ax.tabindex){at.tabindex=ax.tabindex}if(at.autofocus==null&&ax.getAttribute("autofocus")!=null){at.autofocus=true}function aw(){ax.value=ar.getValue()}if(ax.form){var av=H(ax.form,"submit",aw,true);if(typeof ax.form.submit=="function"){var au=ax.form.submit;function ay(){aw();ax.form.submit=au;ax.form.submit();ax.form.submit=ay}ax.form.submit=ay}}ax.style.display="none";var ar=P(function(az){ax.parentNode.insertBefore(az,ax.nextSibling)},at);ar.save=aw;ar.getTextArea=function(){return ax};ar.toTextArea=function(){aw();ax.parentNode.removeChild(ar.getWrapperElement());ax.style.display="";if(ax.form){av();if(typeof ax.form.submit=="function"){ax.form.submit=au}}};return ar};function E(av,ar){if(ar===true){return ar}if(av.copyState){return av.copyState(ar)}var au={};for(var aw in ar){var at=ar[aw];if(at instanceof Array){at=at.concat([])}au[aw]=at}return au}P.copyState=E;function s(au,at,ar){return au.startState?au.startState(at,ar):true}P.startState=s;function e(ar,at){this.pos=this.start=0;this.string=ar;this.tabSize=at||8}e.prototype={eol:function(){return this.pos>=this.string.length},sol:function(){return this.pos==0},peek:function(){return this.string.charAt(this.pos)},next:function(){if(this.pos<this.string.length){return this.string.charAt(this.pos++)}},eat:function(ar){var au=this.string.charAt(this.pos);if(typeof ar=="string"){var at=au==ar}else{var at=au&&(ar.test?ar.test(au):ar(au))}if(at){++this.pos;return au}},eatWhile:function(ar){var at=this.pos;while(this.eat(ar)){}return this.pos>at},eatSpace:function(){var ar=this.pos;while(/[\s\u00a0]/.test(this.string.charAt(this.pos))){++this.pos}return this.pos>ar},skipToEnd:function(){this.pos=this.string.length},skipTo:function(ar){var at=this.string.indexOf(ar,this.pos);if(at>-1){this.pos=at;return true}},backUp:function(ar){this.pos-=ar},column:function(){return y(this.string,this.start,this.tabSize)},indentation:function(){return y(this.string,null,this.tabSize)},match:function(at,au,ar){if(typeof at=="string"){function aw(ax){return ar?ax.toLowerCase():ax}if(aw(this.string).indexOf(aw(at),this.pos)==this.pos){if(au!==false){this.pos+=at.length}return true}}else{var av=this.string.slice(this.pos).match(at);if(av&&au!==false){this.pos+=av[0].length}return av}},current:function(){return this.string.slice(this.start,this.pos)}};P.StringStream=e;function A(av,au,ar,at){this.from=av;this.to=au;this.style=ar;this.marker=at}A.prototype={attach:function(ar){this.marker.set.push(ar)},detach:function(at){var ar=F(this.marker.set,at);if(ar>-1){this.marker.set.splice(ar,1)}},split:function(av,ar){if(this.to<=av&&this.to!=null){return null}var au=this.from<av||this.from==null?null:this.from-av+ar;var at=this.to==null?null:this.to-av+ar;return new A(au,at,this.style,this.marker)},dup:function(){return new A(null,null,this.style,this.marker)},clipTo:function(ar,aw,at,av,au){if(ar&&av>this.from&&(av<this.to||this.to==null)){this.from=null}else{if(this.from!=null&&this.from>=aw){this.from=Math.max(av,this.from)+au}}if(at&&(aw<this.to||this.to==null)&&(aw>this.from||this.from==null)){this.to=null}else{if(this.to!=null&&this.to>aw){this.to=av<this.to?this.to+au:aw}}},isDead:function(){return this.from!=null&&this.to!=null&&this.from>=this.to},sameSet:function(ar){return this.marker==ar.marker}};function W(ar){this.from=ar;this.to=ar;this.line=null}W.prototype={attach:function(ar){this.line=ar},detach:function(ar){if(this.line==ar){this.line=null}},split:function(at,ar){if(at<this.from){this.from=this.to=(this.from-at)+ar;return this}},isDead:function(){return this.from>this.to},clipTo:function(ar,aw,at,av,au){if((ar||aw<this.from)&&(at||av>this.to)){this.from=0;this.to=-1}else{if(this.from>aw){this.from=this.to=Math.max(av,this.from)+au}}},sameSet:function(ar){return false},find:function(){if(!this.line||!this.line.parent){return null}return{line:l(this.line),ch:this.from}},clear:function(){if(this.line){var ar=F(this.line.marked,this);if(ar!=-1){this.line.marked.splice(ar,1)}this.line=null}}};function j(at,ar){this.styles=ar||[at,null];this.text=at;this.height=1;this.marked=this.gutterMarker=this.className=this.bgClassName=this.handlers=null;this.stateAfter=this.parent=this.hidden=null}j.inheritMarks=function(aw,az){var av=new j(aw),ar=az&&az.marked;if(ar){for(var au=0;au<ar.length;++au){if(ar[au].to==null&&ar[au].style){var at=av.marked||(av.marked=[]),ay=ar[au];var ax=ay.dup();at.push(ax);ax.attach(av)}}}return av};j.prototype={replace:function(ay,av,az){var aA=[],at=this.marked,ax=av==null?this.text.length:av;ao(0,ay,this.styles,aA);if(az){aA.push(az,null)}ao(ax,this.text.length,this.styles,aA);this.styles=aA;this.text=this.text.slice(0,ay)+az+this.text.slice(ax);this.stateAfter=null;if(at){var aw=az.length-(ax-ay);for(var au=0;au<at.length;++au){var ar=at[au];ar.clipTo(ay==null,ay||0,av==null,ax,aw);if(ar.isDead()){ar.detach(this);at.splice(au--,1)}}}},split:function(az,ax){var av=[ax,null],at=this.marked;ao(az,this.text.length,this.styles,av);var au=new j(ax+this.text.slice(az),av);if(at){for(var aw=0;aw<at.length;++aw){var ay=at[aw];var ar=ay.split(az,ax.length);if(ar){if(!au.marked){au.marked=[]}au.marked.push(ar);ar.attach(au);if(ar==ay){at.splice(aw--,1)}}}}return au},append:function(at){var ay=this.text.length,ar=at.marked,av=this.marked;this.text+=at.text;ao(0,at.text.length,at.styles,this.styles);if(av){for(var aw=0;aw<av.length;++aw){if(av[aw].to==null){av[aw].to=ay}}}if(ar&&ar.length){if(!av){this.marked=av=[]}outer:for(var aw=0;aw<ar.length;++aw){var az=ar[aw];if(!az.from){for(var au=0;au<av.length;++au){var ax=av[au];if(ax.to==ay&&ax.sameSet(az)){ax.to=az.to==null?null:az.to+ay;if(ax.isDead()){ax.detach(this);ar.splice(aw--,1)}continue outer}}}av.push(az);az.attach(this);az.from+=ay;if(az.to!=null){az.to+=ay}}}},fixMarkEnds:function(at){var ar=this.marked,aw=at.marked;if(!ar){return}for(var av=0;av<ar.length;++av){var ay=ar[av],ax=ay.to==null;if(ax&&aw){for(var au=0;au<aw.length;++au){if(aw[au].sameSet(ay)){ax=false;break}}}if(ax){ay.to=this.text.length}}},fixMarkStarts:function(){var ar=this.marked;if(!ar){return}for(var at=0;at<ar.length;++at){if(ar[at].from==null){ar[at].from=0}}},addMark:function(ar){ar.attach(this);if(this.marked==null){this.marked=[]}this.marked.push(ar);this.marked.sort(function(au,at){return(au.from||0)-(at.from||0)})},highlight:function(ay,at,av){var aB=new e(this.text,av),aC=this.styles,az=0;var aw=false,au=aC[0],aA;if(this.text==""&&ay.blankLine){ay.blankLine(at)}while(!aB.eol()){var ar=ay.token(aB,at);var ax=this.text.slice(aB.start,aB.pos);aB.start=aB.pos;if(az&&aC[az-1]==ar){aC[az-2]+=ax}else{if(ax){if(!aw&&(aC[az+1]!=ar||(az&&aC[az-2]!=aA))){aw=true}aC[az++]=ax;aC[az++]=ar;aA=au;au=aC[az]}}if(aB.pos>5000){aC[az++]=this.text.slice(aB.pos);aC[az++]=null;break}}if(aC.length!=az){aC.length=az;aw=true}if(az&&aC[az-2]!=aA){aw=true}return aw||(aC.length<5&&this.text.length<10?null:false)},getTokenAt:function(ax,av,au){var ar=this.text,aw=new e(ar);while(aw.pos<au&&!aw.eol()){aw.start=aw.pos;var at=ax.token(aw,av)}return{start:aw.start,end:aw.pos,string:aw.current(),className:at||null,state:av}},indentation:function(ar){return y(this.text,null,ar)},getHTML:function(aR,aE,aA,au){var aB=[],ay=true,av=0;function aM(a2,a1){if(!a2){return}if(ay&&X&&a2.charAt(0)==" "){a2="\u00a0"+a2.slice(1)}ay=false;if(a2.indexOf("\t")==-1){av+=a2.length;var a4=ab(a2)}else{var a4="";for(var a3=0;;){var aZ=a2.indexOf("\t",a3);if(aZ==-1){a4+=ab(a2.slice(a3));av+=a2.length-a3;break}else{av+=aZ-a3;var a0=aR(av);a4+=ab(a2.slice(a3,aZ))+a0.html;av+=a0.width;a3=aZ+1}}}if(a1){aB.push('<span class="',a1,'">',a4,"</span>")}else{aB.push(a4)}}var aS=aM;if(aE!=null){var aW=0,aG='<span id="'+aA+'">';aS=function(a2,a0){var aZ=a2.length;if(aE>=aW&&aE<aW+aZ){if(aE>aW){aM(a2.slice(0,aE-aW),a0);if(au){aB.push("<wbr>")}}aB.push(aG);var a1=aE-aW;aM(Y?a2.slice(a1,a1+1):a2.slice(a1),a0);aB.push("</span>");if(Y){aM(a2.slice(a1+1),a0)}aE--;aW+=aZ}else{aW+=aZ;aM(a2,a0);if(aW==aE&&aW==aU){aB.push(aG+" </span>")}else{if(aW>aE+10&&/\s/.test(a2)){aS=function(){}}}}}}var aK=this.styles,ar=this.text,aX=this.marked;var aU=ar.length;function aw(aZ){if(!aZ){return null}return"cm-"+aZ.replace(/ +/g," cm-")}if(!ar&&aE==null){aS(" ")}else{if(!aX||!aX.length){for(var aQ=0,aC=0;aC<aU;aQ+=2){var aJ=aK[aQ],aT=aK[aQ+1],aL=aJ.length;if(aC+aL>aU){aJ=aJ.slice(0,aU-aC)}aC+=aL;aS(aJ,aw(aT))}}else{var ax=0,aQ=0,aF="",aT,aY=0;var aH=aX[0].from||0,aO=[],aV=0;function aP(){var aZ;while(aV<aX.length&&((aZ=aX[aV]).from==ax||aZ.from==null)){if(aZ.style!=null){aO.push(aZ)}++aV}aH=aV<aX.length?aX[aV].from:Infinity;for(var a0=0;a0<aO.length;++a0){var a1=aO[a0].to||Infinity;if(a1==ax){aO.splice(a0--,1)}else{aH=Math.min(a1,aH)}}}var aI=0;while(ax<aU){if(aH==ax){aP()}var aD=Math.min(aU,aH);while(true){if(aF){var at=ax+aF.length;var az=aT;for(var aN=0;aN<aO.length;++aN){az=(az?az+" ":"")+aO[aN].style}aS(at>aD?aF.slice(0,aD-ax):aF,az);if(at>=aD){aF=aF.slice(aD-ax);ax=aD;break}ax=at}aF=aK[aQ++];aT=aw(aK[aQ++])}}}}return aB.join("")},cleanUp:function(){this.parent=null;if(this.marked){for(var ar=0,at=this.marked.length;ar<at;++ar){this.marked[ar].detach(this)}}}};function ao(aA,az,aw,ay){for(var av=0,ax=0,ar=0;ax<az;av+=2){var at=aw[av],au=ax+at.length;if(ar==0){if(au>aA){ay.push(at.slice(aA-ax,Math.min(at.length,az-ax)),aw[av+1])}if(au>=aA){ar=1}}else{if(ar==1){if(au>az){ay.push(at.slice(0,az-ax),aw[av+1])}else{ay.push(at,aw[av+1])}}}ax=au}}function b(ar){this.lines=ar;this.parent=null;for(var at=0,av=ar.length,au=0;at<av;++at){ar[at].parent=this;au+=ar[at].height}this.height=au}b.prototype={chunkSize:function(){return this.lines.length},remove:function(ar,az,av){for(var ax=ar,ay=ar+az;ax<ay;++ax){var au=this.lines[ax];this.height-=au.height;au.cleanUp();if(au.handlers){for(var aw=0;aw<au.handlers.length;++aw){av.push(au.handlers[aw])}}}this.lines.splice(ar,az)},collapse:function(ar){ar.splice.apply(ar,[ar.length,0].concat(this.lines))},insertHeight:function(ar,au,aw){this.height+=aw;this.lines=this.lines.slice(0,ar).concat(au).concat(this.lines.slice(ar));for(var av=0,ax=au.length;av<ax;++av){au[av].parent=this}},iterN:function(ar,aw,av){for(var au=ar+aw;ar<au;++ar){if(av(this.lines[ar])){return true}}}};function q(au){this.children=au;var at=0,aw=0;for(var ar=0,ax=au.length;ar<ax;++ar){var av=au[ar];at+=av.chunkSize();aw+=av.height;av.parent=this}this.size=at;this.height=aw;this.parent=null}q.prototype={chunkSize:function(){return this.size},remove:function(av,aw,ar){this.size-=aw;for(var ax=0;ax<this.children.length;++ax){var au=this.children[ax],az=au.chunkSize();if(av<az){var ay=Math.min(aw,az-av),aA=au.height;au.remove(av,ay,ar);this.height-=aA-au.height;if(az==ay){this.children.splice(ax--,1);au.parent=null}if((aw-=ay)==0){break}av=0}else{av-=az}}if(this.size-aw<25){var aB=[];this.collapse(aB);this.children=[new b(aB)];this.children[0].parent=this}},collapse:function(ar){for(var at=0,au=this.children.length;at<au;++at){this.children[at].collapse(ar)}},insert:function(ar,au){var aw=0;for(var av=0,ax=au.length;av<ax;++av){aw+=au[av].height}this.insertHeight(ar,au,aw)},insertHeight:function(av,aB,aA){this.size+=aB.length;this.height+=aA;for(var aw=0,ax=this.children.length;aw<ax;++aw){var au=this.children[aw],ay=au.chunkSize();if(av<=ay){au.insertHeight(av,aB,aA);if(au.lines&&au.lines.length>50){while(au.lines.length>50){var ar=au.lines.splice(au.lines.length-25,25);var az=new b(ar);au.height-=az.height;this.children.splice(aw+1,0,az);az.parent=this}this.maybeSpill()}break}av-=ay}},maybeSpill:function(){if(this.children.length<=10){return}var av=this;do{var at=av.children.splice(av.children.length-5,5);var au=new q(at);if(!av.parent){var aw=new q(av.children);aw.parent=av;av.children=[aw,au];av=aw}else{av.size-=au.size;av.height-=au.height;var ar=F(av.parent.children,av);av.parent.children.splice(ar+1,0,au)}au.parent=av.parent}while(av.children.length>10);av.parent.maybeSpill()},iter:function(au,at,ar){this.iterN(au,at-au,ar)},iterN:function(ar,aA,az){for(var au=0,ax=this.children.length;au<ax;++au){var ay=this.children[au],aw=ay.chunkSize();if(ar<aw){var av=Math.min(aA,aw-ar);if(ay.iterN(ar,av,az)){return true}if((aA-=av)==0){break}ar=0}else{ar-=aw}}}};function T(ar,aw){while(!ar.lines){for(var at=0;;++at){var av=ar.children[at],au=av.chunkSize();if(aw<au){ar=av;break}aw-=au}}return ar.lines[aw]}function l(ar){if(ar.parent==null){return null}var ax=ar.parent,aw=F(ax.lines,ar);for(var at=ax.parent;at;ax=at,at=at.parent){for(var au=0,av=at.children.length;;++au){if(at.children[au]==ax){break}aw+=at.children[au].chunkSize()}}return aw}function n(ay,aw){var au=0;outer:do{for(var av=0,ax=ay.children.length;av<ax;++av){var at=ay.children[av],ar=at.height;if(aw<ar){ay=at;continue outer}aw-=ar;au+=at.chunkSize()}return au}while(!ay.lines);for(var av=0,ax=ay.lines.length;av<ax;++av){var aA=ay.lines[av],az=aA.height;if(aw<az){break}aw-=az}return au+av}function m(ar,ay){var au=0;outer:do{for(var at=0,aw=ar.children.length;at<aw;++at){var ax=ar.children[at],av=ax.chunkSize();if(ay<av){ar=ax;continue outer}ay-=av;au+=ax.height}return au}while(!ar.lines);for(var at=0;at<ay;++at){au+=ar.lines[at].height}return au}function ae(){this.time=0;this.done=[];this.undone=[];this.compound=0;this.closed=false}ae.prototype={addChange:function(ar,ax,at){this.undone.length=0;var au=+new Date,aA=this.done[this.done.length-1],az=aA&&aA[aA.length-1];var aw=au-this.time;if(this.compound&&aA&&!this.closed){aA.push({start:ar,added:ax,old:at})}else{if(aw>400||!az||this.closed||az.start>ar+at.length||az.start+az.added<ar){this.done.push([{start:ar,added:ax,old:at}]);this.closed=false}else{var ay=Math.max(0,az.start-ar),aB=Math.max(0,(ar+at.length)-(az.start+az.added));for(var av=ay;av>0;--av){az.old.unshift(at[av-1])}for(var av=aB;av>0;--av){az.old.push(at[at.length-av])}if(ay){az.start=ar}az.added+=ax-(at.length-ay-aB)}}this.time=au},startCompound:function(){if(!this.compound++){this.closed=true}},endCompound:function(){if(!--this.compound){this.closed=true}}};function B(){R(this)}function w(ar){if(!ar.stop){ar.stop=B}return ar}function t(ar){if(ar.preventDefault){ar.preventDefault()}else{ar.returnValue=false}}function I(ar){if(ar.stopPropagation){ar.stopPropagation()}else{ar.cancelBubble=true}}function R(ar){t(ar);I(ar)}P.e_stop=R;P.e_preventDefault=t;P.e_stopPropagation=I;function p(ar){return ar.target||ar.srcElement}function S(ar){if(ar.which){return ar.which}else{if(ar.button&1){return 1}else{if(ar.button&2){return 3}else{if(ar.button&4){return 2}}}}}function O(at,au){var ar=at.override&&at.override.hasOwnProperty(au);return ar?at.override[au]:at[au]}function H(av,au,at,ar){if(typeof av.addEventListener=="function"){av.addEventListener(au,at,false);if(ar){return function(){av.removeEventListener(au,at,false)}}}else{var aw=function(ax){at(ax||window.event)};av.attachEvent("on"+au,aw);if(ar){return function(){av.detachEvent("on"+au,aw)}}}}P.connect=H;function N(){this.id=null}N.prototype={set:function(ar,at){clearTimeout(this.id);this.id=setTimeout(at,ar)}};var ak=P.Pass={toString:function(){return"CodeMirror.Pass"}};var aa=/gecko\/\d{7}/i.test(navigator.userAgent);var X=/MSIE \d/.test(navigator.userAgent);var G=/MSIE [1-7]\b/.test(navigator.userAgent);var J=/MSIE [1-8]\b/.test(navigator.userAgent);var U=X&&document.documentMode==5;var ai=/WebKit\//.test(navigator.userAgent);var c=/Chrome\//.test(navigator.userAgent);var Y=/Opera\//.test(navigator.userAgent);var ag=/Apple Computer/.test(navigator.vendor);var x=/KHTML\//.test(navigator.userAgent);var ah=/Mac OS X 10\D([7-9]|\d\d)\D/.test(navigator.userAgent);var V=function(){if(J){return false}var ar=document.createElement("div");return"draggable" in ar||"dragDrop" in ar}();var h=function(){var ar=document.createElement("textarea");ar.value="foo\nbar";if(ar.value.indexOf("\r")>-1){return"\r\n"}return"\n"}();var D=/^$/;if(aa){D=/$'/}else{if(ag){D=/\-[^ \-?]|\?[^ !'\"\),.\-\/:;\?\]\}]/}else{if(c){D=/\-[^ \-\.?]|\?[^ \-\.?\]\}:;!'\"\),\/]|[\.!\"#&%\)*+,:;=>\]|\}~][\(\{\[<]|\$'/}}}function y(au,ar,aw){if(ar==null){ar=au.search(/[^\s\u00a0]/);if(ar==-1){ar=au.length}}for(var at=0,av=0;at<ar;++at){if(au.charAt(at)=="\t"){av+=aw-(av%aw)}else{++av}}return av}function M(ar){if(ar.currentStyle){return ar.currentStyle}return window.getComputedStyle(ar,null)}function an(at,aB){var av=at.ownerDocument.body;var aA=0,az=0,ax=false;for(var ar=at;ar;ar=ar.offsetParent){var ay=ar.offsetLeft,au=ar.offsetTop;if(ar==av){aA+=Math.abs(ay);az+=Math.abs(au)}else{aA+=ay,az+=au}if(aB&&M(ar).position=="fixed"){ax=true}}var aw=aB&&!ax?null:av;for(var ar=at.parentNode;ar!=aw;ar=ar.parentNode){if(ar.scrollLeft!=null){aA-=ar.scrollLeft;az-=ar.scrollTop}}return{left:aA,top:az}}if(document.documentElement.getBoundingClientRect!=null){an=function(av,at){try{var au=av.getBoundingClientRect();au={top:au.top,left:au.left}}catch(aw){au={top:0,left:0}}if(!at){if(window.pageYOffset==null){var ar=document.documentElement||document.body.parentNode;if(ar.scrollTop==null){ar=document.body}au.top+=ar.scrollTop;au.left+=ar.scrollLeft}else{au.top+=window.pageYOffset;au.left+=window.pageXOffset}}return au}}function C(ar){return ar.textContent||ar.innerText||ar.nodeValue||""}function d(ar){if(L){ar.selectionStart=0;ar.selectionEnd=ar.value.length}else{ar.select()}}function al(at,ar){return at.line==ar.line&&at.ch==ar.ch}function k(at,ar){return at.line<ar.line||(at.line==ar.line&&at.ch<ar.ch)}function aj(ar){return{line:ar.line,ch:ar.ch}}var aq=document.createElement("pre");function ab(ar){aq.textContent=ar;return aq.innerHTML}if(ab("a")=="\na"){ab=function(ar){aq.textContent=ar;return aq.innerHTML.slice(1)}}else{if(ab("\t")!="\t"){ab=function(ar){aq.innerHTML="";aq.appendChild(document.createTextNode(ar));return aq.innerHTML}}}P.htmlEscape=ab;function o(av,au){if(!au){return 0}if(!av){return au.length}for(var at=av.length,ar=au.length;at>=0&&ar>=0;--at,--ar){if(av.charAt(at)!=au.charAt(ar)){break}}return ar+1}function F(av,ar){if(av.indexOf){return av.indexOf(ar)}for(var at=0,au=av.length;at<au;++at){if(av[at]==ar){return at}}return -1}function a(ar){return/\w/.test(ar)||ar.toUpperCase()!=ar.toLowerCase()}var K="\n\nb".split(/\n/).length!=3?function(at){var av=0,ar,au=[];while((ar=at.indexOf("\n",av))>-1){au.push(at.slice(av,at.charAt(ar-1)=="\r"?ar-1:ar));av=ar+1}au.push(at.slice(av));return au}:function(ar){return ar.split(/\r?\n/)};P.splitLines=K;var am=window.getSelection?function(at){try{return at.selectionStart!=at.selectionEnd}catch(ar){return false}}:function(au){try{var ar=au.ownerDocument.selection.createRange()}catch(at){}if(!ar||ar.parentElement()!=au){return false}return ar.compareEndPoints("StartToEnd",ar)!=0};P.defineMode("null",function(){return{token:function(ar){ar.skipToEnd()}}});P.defineMIME("text/plain","null");var ad={3:"Enter",8:"Backspace",9:"Tab",13:"Enter",16:"Shift",17:"Ctrl",18:"Alt",19:"Pause",20:"CapsLock",27:"Esc",32:"Space",33:"PageUp",34:"PageDown",35:"End",36:"Home",37:"Left",38:"Up",39:"Right",40:"Down",44:"PrintScrn",45:"Insert",46:"Delete",59:";",91:"Mod",92:"Mod",93:"Mod",109:"-",107:"=",127:"Delete",186:";",187:"=",188:",",189:"-",190:".",191:"/",192:"`",219:"[",220:"\\",221:"]",222:"'",63276:"PageUp",63277:"PageDown",63275:"End",63273:"Home",63234:"Left",63232:"Up",63235:"Right",63233:"Down",63302:"Insert",63272:"Delete"};P.keyNames=ad;(function(){for(var ar=0;ar<10;ar++){ad[ar+48]=String(ar)}for(var ar=65;ar<=90;ar++){ad[ar]=String.fromCharCode(ar)}for(var ar=1;ar<=12;ar++){ad[ar+111]=ad[ar+63235]="F"+ar}})();return P})();if(!CodeMirror.modeExtensions){CodeMirror.modeExtensions={}}CodeMirror.defineExtension("getModeExt",function(){var b=CodeMirror.resolveMode(this.getOption("mode")).name;var a=CodeMirror.modeExtensions[b];if(!a){throw new Error("No extensions found for mode "+b)}return a});CodeMirror.defineExtension("getModeExtAtPos",function(b){var a=this.getTokenAt(b);if(a&&a.state&&a.state.mode){return CodeMirror.modeExtensions[a.state.mode=="html"?"htmlmixed":a.state.mode]}else{return this.getModeExt()}});CodeMirror.defineExtension("commentRange",function(a,i,h){var d=this.getModeExtAtPos(this.getCursor());if(a){var c=this.getRange(i,h);this.replaceRange(d.commentStart+this.getRange(i,h)+d.commentEnd,i,h);if(i.line==h.line&&i.ch==h.ch){this.setCursor(i.line,i.ch+d.commentStart.length)}}else{var f=this.getRange(i,h);var e=f.indexOf(d.commentStart);var b=f.lastIndexOf(d.commentEnd);if(e>-1&&b>-1&&b>e){f=f.substr(0,e)+f.substring(e+d.commentStart.length,b)+f.substr(b+d.commentEnd.length)}this.replaceRange(f,i,h)}});CodeMirror.defineExtension("autoIndentRange",function(c,b){var a=this;this.operation(function(){for(var d=c.line;d<=b.line;d++){a.indentLine(d,"smart")}})});CodeMirror.defineExtension("autoFormatRange",function(f,e){var b=this.indexFromPos(f);var d=this.indexFromPos(e);var c=this.getModeExt().autoFormatLineBreaks(this.getValue(),b,d);var a=this;this.operation(function(){a.replaceRange(c,f,e);var k=a.posFromIndex(b).line;var h=a.posFromIndex(b+c.length).line;for(var j=k;j<=h;j++){a.indentLine(j,"smart")}})});CodeMirror.modeExtensions.css={commentStart:"/*",commentEnd:"*/",wordWrapChars:[";","\\{","\\}"],autoFormatLineBreaks:function(c,a,b){c=c.substring(a,b);return c.replace(new RegExp("(;|\\{|\\})([^\r\n])","g"),"$1\n$2")}};CodeMirror.modeExtensions.javascript={commentStart:"/*",commentEnd:"*/",wordWrapChars:[";","\\{","\\}"],getNonBreakableBlocks:function(f){var e=[new RegExp("for\\s*?\\(([\\s\\S]*?)\\)"),new RegExp("'([\\s\\S]*?)('|$)"),new RegExp('"([\\s\\S]*?)("|$)'),new RegExp("//.*([\r\n]|$)")];var c=new Array();for(var d=0;d<e.length;d++){var b=0;while(b<f.length){var a=f.substr(b).match(e[d]);if(a!=null){c.push({start:b+a.index,end:b+a.index+a[0].length});b+=a.index+Math.max(1,a[0].length)}else{break}}}c.sort(function(i,h){return i.start-h.start});return c},autoFormatLineBreaks:function(j,d,h){j=j.substring(d,h);var b=0;var a=new RegExp("(;|\\{|\\})([^\r\n])","g");var c=this.getNonBreakableBlocks(j);if(c!=null){var f="";for(var e=0;e<c.length;e++){if(c[e].start>b){f+=j.substring(b,c[e].start).replace(a,"$1\n$2");b=c[e].start}if(c[e].start<=b&&c[e].end>=b){f+=j.substring(b,c[e].end);b=c[e].end}}if(b<j.length-1){f+=j.substr(b).replace(a,"$1\n$2")}return f}else{return j.replace(a,"$1\n$2")}}};CodeMirror.modeExtensions.xml={commentStart:"<!--",commentEnd:"-->",wordWrapChars:[">"],autoFormatLineBreaks:function(j,e,f){j=j.substring(e,f);var k=j.split("\n");var h=new RegExp("(^\\s*?<|^[^<]*?)(.+)(>\\s*?$|[^>]*?$)");var c=new RegExp("<","g");var a=new RegExp("(>)([^\r\n])","g");for(var d=0;d<k.length;d++){var b=k[d].match(h);if(b!=null&&b.length>3){k[d]=b[1]+b[2].replace(c,"\n$&").replace(a,"$1\n$2")+b[3];continue}}return k.join("\n")}};CodeMirror.modeExtensions.htmlmixed={commentStart:"<!--",commentEnd:"-->",wordWrapChars:[">",";","\\{","\\}"],getModeInfos:function(l,k){var j=new Array();j[0]={pos:0,modeExt:CodeMirror.modeExtensions.xml,modeName:"xml"};var h=new Array();h[0]={regex:new RegExp("<style[^>]*>([\\s\\S]*?)(</style[^>]*>|$)","i"),modeExt:CodeMirror.modeExtensions.css,modeName:"css"};h[1]={regex:new RegExp("<script[^>]*>([\\s\\S]*?)(<\/script[^>]*>|$)","i"),modeExt:CodeMirror.modeExtensions.javascript,modeName:"javascript"};var c=(typeof(k)!=="undefined"?k:l.length-1);for(var d=0;d<h.length;d++){var e=0;while(e<=c){var b=l.substr(e).match(h[d].regex);if(b!=null){if(b.length>1&&b[1].length>0){var f=e+b.index+b[0].indexOf(b[1]);j.push({pos:f,modeExt:h[d].modeExt,modeName:h[d].modeName});j.push({pos:f+b[1].length,modeExt:j[0].modeExt,modeName:j[0].modeName});e+=b.index+b[0].length;continue}else{e+=b.index+Math.max(b[0].length,1)}}else{break}}}j.sort(function a(m,i){return m.pos-i.pos});return j},autoFormatLineBreaks:function(m,e,f){var h=this.getModeInfos(m);var c=new RegExp("^\\s*?\n");var l=new RegExp("\n\\s*?$");var j="";if(h.length>1){for(var d=1;d<=h.length;d++){var b=h[d-1].pos;var a=(d<h.length?h[d].pos:f);if(b>=f){break}if(b<e){if(a<=e){continue}b=e}if(a>f){a=f}var k=m.substring(b,a);if(h[d-1].modeName!="xml"){if(!c.test(k)&&b>0){k="\n"+k}if(!l.test(k)&&a<m.length-1){k+="\n"}}j+=h[d-1].modeExt.autoFormatLineBreaks(k)}}else{j=h[0].modeExt.autoFormatLineBreaks(m.substring(e,f))}return j}};(function(){function a(b,c){var e=b.getWrapperElement();var d=e.insertBefore(document.createElement("div"),e.firstChild);d.className="CodeMirror-dialog";d.innerHTML="<div>"+c+"</div>";return d}CodeMirror.defineExtension("openDialog",function(b,h){var c=a(this,b);var d=false,f=this;function i(){if(d){return}d=true;c.parentNode.removeChild(c)}var e=c.getElementsByTagName("input")[0];if(e){CodeMirror.connect(e,"keydown",function(j){if(j.keyCode==13||j.keyCode==27){CodeMirror.e_stop(j);i();f.focus();if(j.keyCode==13){h(e.value)}}});e.focus();CodeMirror.connect(e,"blur",i)}return i});CodeMirror.defineExtension("openConfirm",function(m,d){var c=a(this,m);var k=c.getElementsByTagName("button");var e=false,j=this,h=1;function n(){if(e){return}e=true;c.parentNode.removeChild(c);j.focus()}k[0].focus();for(var f=0;f<k.length;++f){var l=k[f];(function(b){CodeMirror.connect(l,"click",function(i){CodeMirror.e_preventDefault(i);n();if(b){b(j)}})})(d[f]);CodeMirror.connect(l,"blur",function(){--h;setTimeout(function(){if(h<=0){n()}},200)});CodeMirror.connect(l,"focus",function(){++h})}})})();(function(){function a(b,e,h,d){this.atOccurrence=false;this.cm=b;if(d==null&&typeof e=="string"){d=false}h=h?b.clipPos(h):{line:0,ch:0};this.pos={from:h,to:h};if(typeof e!="string"){this.matches=function(k,o){if(k){var i=b.getLine(o.line).slice(0,o.ch),j=i.match(e),n=0;while(j){var l=i.indexOf(j[0]);n+=l;i=i.slice(l+1);var m=i.match(e);if(m){j=m}else{break}n++}}else{var i=b.getLine(o.line).slice(o.ch),j=i.match(e),n=j&&o.ch+i.indexOf(j[0])}if(j){return{from:{line:o.line,ch:n},to:{line:o.line,ch:n+j[0].length},match:j}}}}else{if(d){e=e.toLowerCase()}var c=d?function(i){return i.toLowerCase()}:function(i){return i};var f=e.split("\n");if(f.length==1){this.matches=function(l,m){var j=c(b.getLine(m.line)),i=e.length,k;if(l?(m.ch>=i&&(k=j.lastIndexOf(e,m.ch-i))!=-1):(k=j.indexOf(e,m.ch))!=-1){return{from:{line:m.line,ch:k},to:{line:m.line,ch:k+i}}}}}else{this.matches=function(n,p){var o=p.line,q=(n?f.length-1:0),m=f[q],s=c(b.getLine(o));var j=(n?s.indexOf(m)+m.length:s.lastIndexOf(m));if(n?j>=p.ch||j!=m.length:j<=p.ch||j!=s.length-m.length){return}for(;;){if(n?!o:o==b.lineCount()-1){return}s=c(b.getLine(o+=n?-1:1));m=f[n?--q:++q];if(q>0&&q<f.length-1){if(s!=m){return}else{continue}}var k=(n?s.lastIndexOf(m):s.indexOf(m)+m.length);if(n?k!=s.length-m.length:k!=m.length){return}var i={line:p.line,ch:j},l={line:o,ch:k};return{from:n?l:i,to:n?i:l}}}}}}a.prototype={findNext:function(){return this.find(false)},findPrevious:function(){return this.find(true)},find:function(d){var c=this,f=this.cm.clipPos(d?this.pos.from:this.pos.to);function b(h){var i={line:h,ch:0};c.pos={from:i,to:i};c.atOccurrence=false;return false}for(;;){if(this.pos=this.matches(d,f)){this.atOccurrence=true;return this.pos.match||true}if(d){if(!f.line){return b(0)}f={line:f.line-1,ch:this.cm.getLine(f.line-1).length}}else{var e=this.cm.lineCount();if(f.line==e-1){return b(e)}f={line:f.line+1,ch:0}}}},from:function(){if(this.atOccurrence){return this.pos.from}},to:function(){if(this.atOccurrence){return this.pos.to}},replace:function(c){var b=this;if(this.atOccurrence){b.pos.to=this.cm.replaceRange(c,b.pos.from,b.pos.to)}}};CodeMirror.defineExtension("getSearchCursor",function(c,d,b){return new a(this,c,d,b)})})();CodeMirror.defineMode("clike",function(i,d){var e=i.indentUnit,f=d.keywords||{},l=d.blockKeywords||{},h=d.atoms||{},q=d.hooks||{},b=d.multiLineStrings;var k=/[+\-*&%=<>!?|\/]/;var n;function c(w,u){var s=w.next();if(q[s]){var t=q[s](w,u);if(t!==false){return t}}if(s=='"'||s=="'"){u.tokenize=p(s);return u.tokenize(w,u)}if(/[\[\]{}\(\),;\:\.]/.test(s)){n=s;return null}if(/\d/.test(s)){w.eatWhile(/[\w\.]/);return"number"}if(s=="/"){if(w.eat("*")){u.tokenize=a;return a(w,u)}if(w.eat("/")){w.skipToEnd();return"comment"}}if(k.test(s)){w.eatWhile(k);return"operator"}w.eatWhile(/[\w\$_]/);var v=w.current();if(f.propertyIsEnumerable(v)){if(l.propertyIsEnumerable(v)){n="newstatement"}return"keyword"}if(h.propertyIsEnumerable(v)){return"atom"}return"word"}function p(s){return function(w,v){var x=false,u,t=false;while((u=w.next())!=null){if(u==s&&!x){t=true;break}x=!x&&u=="\\"}if(t||!(x||b)){v.tokenize=null}return"string"}}function a(v,u){var s=false,t;while(t=v.next()){if(t=="/"&&s){u.tokenize=null;break}s=(t=="*")}return"comment"}function o(w,s,t,v,u){this.indented=w;this.column=s;this.type=t;this.align=v;this.prev=u}function j(u,s,t){return u.context=new o(u.indented,s,t,null,u.context)}function m(u){var s=u.context.type;if(s==")"||s=="]"||s=="}"){u.indented=u.context.indented}return u.context=u.context.prev}return{startState:function(s){return{tokenize:null,context:new o((s||0)-e,0,"top",false),indented:0,startOfLine:true}},token:function(v,u){var s=u.context;if(v.sol()){if(s.align==null){s.align=false}u.indented=v.indentation();u.startOfLine=true}if(v.eatSpace()){return null}n=null;var t=(u.tokenize||c)(v,u);if(t=="comment"||t=="meta"){return t}if(s.align==null){s.align=true}if((n==";"||n==":")&&s.type=="statement"){m(u)}else{if(n=="{"){j(u,v.column(),"}")}else{if(n=="["){j(u,v.column(),"]")}else{if(n=="("){j(u,v.column(),")")}else{if(n=="}"){while(s.type=="statement"){s=m(u)}if(s.type=="}"){s=m(u)}while(s.type=="statement"){s=m(u)}}else{if(n==s.type){m(u)}else{if(s.type=="}"||s.type=="top"||(s.type=="statement"&&n=="newstatement")){j(u,v.column(),"statement")}}}}}}}u.startOfLine=false;return t},indent:function(w,u){if(w.tokenize!=c&&w.tokenize!=null){return 0}var s=w.context,v=u&&u.charAt(0);if(s.type=="statement"&&v=="}"){s=s.prev}var t=v==s.type;if(s.type=="statement"){return s.indented+(v=="{"?0:e)}else{if(s.align){return s.column+(t?0:1)}else{return s.indented+(t?0:e)}}},electricChars:"{}"}});(function(){function c(j){var f={},h=j.split(" ");for(var e=0;e<h.length;++e){f[h[e]]=true}return f}var a="auto if break int case long char register continue return default short do sizeof double static else struct entry switch extern typedef float union for unsigned goto while enum void const signed volatile";function d(f,e){if(!e.startOfLine){return false}f.skipToEnd();return"meta"}function b(h,f){var e;while((e=h.next())!=null){if(e=='"'&&!h.eat('"')){f.tokenize=null;break}}return"string"}CodeMirror.defineMIME("text/x-csrc",{name:"clike",keywords:c(a),blockKeywords:c("case do else for if switch while struct"),atoms:c("null"),hooks:{"#":d}});CodeMirror.defineMIME("text/x-c++src",{name:"clike",keywords:c(a+" asm dynamic_cast namespace reinterpret_cast try bool explicit new static_cast typeid catch operator template typename class friend private this using const_cast inline public throw virtual delete mutable protected wchar_t"),blockKeywords:c("catch class do else finally for if struct switch try while"),atoms:c("true false null"),hooks:{"#":d}});CodeMirror.defineMIME("text/x-java",{name:"clike",keywords:c("abstract assert boolean break byte case catch char class const continue default do double else enum extends final finally float for goto if implements import instanceof int interface long native new package private protected public return short static strictfp super switch synchronized this throw throws transient try void volatile while"),blockKeywords:c("catch class do else finally for if switch try while"),atoms:c("true false null"),hooks:{"@":function(f,e){f.eatWhile(/[\w\$_]/);return"meta"}}});CodeMirror.defineMIME("text/x-csharp",{name:"clike",keywords:c("abstract as base bool break byte case catch char checked class const continue decimal default delegate do double else enum event explicit extern finally fixed float for foreach goto if implicit in int interface internal is lock long namespace new object operator out override params private protected public readonly ref return sbyte sealed short sizeof stackalloc static string struct switch this throw try typeof uint ulong unchecked unsafe ushort using virtual void volatile while add alias ascending descending dynamic from get global group into join let orderby partial remove select set value var yield"),blockKeywords:c("catch class do else finally for foreach if struct switch try while"),atoms:c("true false null"),hooks:{"@":function(f,e){if(f.eat('"')){e.tokenize=b;return b(f,e)}f.eatWhile(/[\w\$_]/);return"meta"}}});CodeMirror.defineMIME("text/x-scala",{name:"clike",keywords:c("abstract case catch class def do else extends false final finally for forSome if implicit import lazy match new null object override package private protected return sealed super this throw trait try trye type val var while with yield _ : = => <- <: <% >: # @ assert assume require print println printf readLine readBoolean readByte readShort readChar readInt readLong readFloat readDouble AnyVal App Application Array BufferedIterator BigDecimal BigInt Char Console Either Enumeration Equiv Error Exception Fractional Function IndexedSeq Integral Iterable Iterator List Map Numeric Nil NotNull Option Ordered Ordering PartialFunction PartialOrdering Product Proxy Range Responder Seq Serializable Set Specializable Stream StringBuilder StringContext Symbol Throwable Traversable TraversableOnce Tuple Unit Vector :: #:: Boolean Byte Character CharSequence Class ClassLoader Cloneable Comparable Compiler Double Exception Float Integer Long Math Number Object Package Pair Process Runtime Runnable SecurityManager Short StackTraceElement StrictMath String StringBuffer System Thread ThreadGroup ThreadLocal Throwable Triple Void"),blockKeywords:c("catch class do else finally for forSome if match switch try while"),atoms:c("true false null"),hooks:{"@":function(f,e){f.eatWhile(/[\w\$_]/);return"meta"}}})}());CodeMirror.defineMode("css",function(e){var d=e.indentUnit,f;function c(j,k){f=k;return j}function i(l,k){var j=l.next();if(j=="@"){l.eatWhile(/[\w\\\-]/);return c("meta",l.current())}else{if(j=="/"&&l.eat("*")){k.tokenize=h;return h(l,k)}else{if(j=="<"&&l.eat("!")){k.tokenize=b;return b(l,k)}else{if(j=="="){c(null,"compare")}else{if((j=="~"||j=="|")&&l.eat("=")){return c(null,"compare")}else{if(j=='"'||j=="'"){k.tokenize=a(j);return k.tokenize(l,k)}else{if(j=="#"){l.eatWhile(/[\w\\\-]/);return c("atom","hash")}else{if(j=="!"){l.match(/^\s*\w*/);return c("keyword","important")}else{if(/\d/.test(j)){l.eatWhile(/[\w.%]/);return c("number","unit")}else{if(/[,.+>*\/]/.test(j)){return c(null,"select-op")}else{if(/[;{}:\[\]]/.test(j)){return c(null,j)}else{l.eatWhile(/[\w\\\-]/);return c("variable","variable")}}}}}}}}}}}}function h(m,l){var j=false,k;while((k=m.next())!=null){if(j&&k=="/"){l.tokenize=i;break}j=(k=="*")}return c("comment","comment")}function b(m,l){var j=0,k;while((k=m.next())!=null){if(j>=2&&k==">"){l.tokenize=i;break}j=(k=="-")?j+1:0}return c("comment","comment")}function a(j){return function(m,l){var n=false,k;while((k=m.next())!=null){if(k==j&&!n){break}n=!n&&k=="\\"}if(!n){l.tokenize=i}return c("string","string")}}return{startState:function(j){return{tokenize:i,baseIndent:j||0,stack:[]}},token:function(m,l){if(m.eatSpace()){return null}var k=l.tokenize(m,l);var j=l.stack[l.stack.length-1];if(f=="hash"&&j!="rule"){k="string-2"}else{if(k=="variable"){if(j=="rule"){k="number"}else{if(!j||j=="@media{"){k="tag"}}}}if(j=="rule"&&/^[\{\};]$/.test(f)){l.stack.pop()}if(f=="{"){if(j=="@media"){l.stack[l.stack.length-1]="@media{"}else{l.stack.push("{")}}else{if(f=="}"){l.stack.pop()}else{if(f=="@media"){l.stack.push("@media")}else{if(j=="{"&&f!="comment"){l.stack.push("rule")}}}}return k},indent:function(k,j){var l=k.stack.length;if(/^\}/.test(j)){l-=k.stack[k.stack.length-1]=="rule"?2:1}return k.baseIndent+l*d},electricChars:"}"}});CodeMirror.defineMIME("text/css","css");CodeMirror.defineMode("javascript",function(p,M){var w=p.indentUnit;var h=M.json;var b=function(){function Y(ab){return{type:ab,style:"keyword"}}var V=Y("keyword a"),aa=Y("keyword b"),Z=Y("keyword c");var W=Y("operator"),X={type:"atom",style:"atom"};return{"if":V,"while":V,"with":V,"else":aa,"do":aa,"try":aa,"finally":aa,"return":Z,"break":Z,"continue":Z,"new":Z,"delete":Z,"throw":Z,"var":Y("var"),"const":Y("var"),let:Y("var"),"function":Y("function"),"catch":Y("catch"),"for":Y("for"),"switch":Y("switch"),"case":Y("case"),"default":Y("default"),"in":W,"typeof":W,"instanceof":W,"true":X,"false":X,"null":X,"undefined":X,"NaN":X,"Infinity":X}}();var k=/[+\-*&%=<>!?|]/;function T(X,W,V){W.tokenize=V;return V(X,W)}function f(X,V){var Y=false,W;while((W=X.next())!=null){if(W==V&&!Y){return false}Y=!Y&&W=="\\"}return Y}var U,o;function C(X,W,V){U=X;o=V;return W}function O(Z,X){var V=Z.next();if(V=='"'||V=="'"){return T(Z,X,A(V))}else{if(/[\[\]{}\(\),;\:\.]/.test(V)){return C(V)}else{if(V=="0"&&Z.eat(/x/i)){Z.eatWhile(/[\da-f]/i);return C("number","number")}else{if(/\d/.test(V)||V=="-"&&Z.eat(/\d/)){Z.match(/^\d*(?:\.\d*)?(?:[eE][+\-]?\d+)?/);return C("number","number")}else{if(V=="/"){if(Z.eat("*")){return T(Z,X,R)}else{if(Z.eat("/")){Z.skipToEnd();return C("comment","comment")}else{if(X.reAllowed){f(Z,"/");Z.eatWhile(/[gimy]/);return C("regexp","string-2")}else{Z.eatWhile(k);return C("operator",null,Z.current())}}}}else{if(V=="#"){Z.skipToEnd();return C("error","error")}else{if(k.test(V)){Z.eatWhile(k);return C("operator",null,Z.current())}else{Z.eatWhile(/[\w\$_]/);var Y=Z.current(),W=b.propertyIsEnumerable(Y)&&b[Y];return(W&&X.kwAllowed)?C(W.type,W.style,Y):C("variable","variable",Y)}}}}}}}}function A(V){return function(X,W){if(!f(X,V)){W.tokenize=O}return C("string","string")}}function R(Y,X){var V=false,W;while(W=Y.next()){if(W=="/"&&V){X.tokenize=O;break}V=(W=="*")}return C("comment","comment")}var l={atom:true,number:true,variable:true,string:true,regexp:true};function D(aa,V,W,Z,X,Y){this.indented=aa;this.column=V;this.type=W;this.prev=X;this.info=Y;if(Z!=null){this.align=Z}}function y(X,W){for(var V=X.localVars;V;V=V.next){if(V.name==W){return true}}}function s(Z,X,W,Y,aa){var ab=Z.cc;v.state=Z;v.stream=aa;v.marked=null,v.cc=ab;if(!Z.lexical.hasOwnProperty("align")){Z.lexical.align=true}while(true){var V=ab.length?ab.pop():h?z:x;if(V(W,Y)){while(ab.length&&ab[ab.length-1].lex){ab.pop()()}if(v.marked){return v.marked}if(W=="variable"&&y(Z,Y)){return"variable-2"}return X}}}var v={state:null,column:null,marked:null,cc:null};function a(){for(var V=arguments.length-1;V>=0;V--){v.cc.push(arguments[V])}}function F(){a.apply(null,arguments);return true}function N(W){var X=v.state;if(X.context){v.marked="def";for(var V=X.localVars;V;V=V.next){if(V.name==W){return}}X.localVars={name:W,next:X.localVars}}}var t={name:"this",next:{name:"arguments"}};function E(){if(!v.state.context){v.state.localVars=t}v.state.context={prev:v.state.context,vars:v.state.localVars}}function G(){v.state.localVars=v.state.context.vars;v.state.context=v.state.context.prev}function P(V,X){var W=function(){var Y=v.state;Y.lexical=new D(Y.indented,v.stream.column(),V,null,Y.lexical,X)};W.lex=true;return W}function q(){var V=v.state;if(V.lexical.prev){if(V.lexical.type==")"){V.indented=V.lexical.indented}V.lexical=V.lexical.prev}}q.lex=true;function S(W){return function V(X){if(X==W){return F()}else{if(W==";"){return a()}else{return F(arguments.callee)}}}}function x(V){if(V=="var"){return F(P("vardef"),J,S(";"),q)}if(V=="keyword a"){return F(P("form"),z,x,q)}if(V=="keyword b"){return F(P("form"),x,q)}if(V=="{"){return F(P("}"),n,q)}if(V==";"){return F()}if(V=="function"){return F(Q)}if(V=="for"){return F(P("form"),S("("),P(")"),e,S(")"),q,x,q)}if(V=="variable"){return F(P("stat"),B)}if(V=="switch"){return F(P("form"),z,P("}","switch"),S("{"),n,q,q)}if(V=="case"){return F(z,S(":"))}if(V=="default"){return F(S(":"))}if(V=="catch"){return F(P("form"),E,S("("),H,S(")"),x,q,G)}return a(P("stat"),z,S(";"),q)}function z(V){if(l.hasOwnProperty(V)){return F(m)}if(V=="function"){return F(Q)}if(V=="keyword c"){return F(u)}if(V=="("){return F(P(")"),u,S(")"),q,m)}if(V=="operator"){return F(z)}if(V=="["){return F(P("]"),j(z,"]"),q,m)}if(V=="{"){return F(P("}"),j(L,"}"),q,m)}return F()}function u(V){if(V.match(/[;\}\)\],]/)){return a()}return a(z)}function m(V,W){if(V=="operator"&&/\+\+|--/.test(W)){return F(m)}if(V=="operator"||V==":"){return F(z)}if(V==";"){return}if(V=="("){return F(P(")"),j(z,")"),q,m)}if(V=="."){return F(i,m)}if(V=="["){return F(P("]"),z,S("]"),q,m)}}function B(V){if(V==":"){return F(q,x)}return a(m,S(";"),q)}function i(V){if(V=="variable"){v.marked="property";return F()}}function L(V){if(V=="variable"){v.marked="property"}if(l.hasOwnProperty(V)){return F(S(":"),z)}}function j(X,W){function V(Z){if(Z==","){return F(X,V)}if(Z==W){return F()}return F(S(W))}return function Y(Z){if(Z==W){return F()}else{return a(X,V)}}}function n(V){if(V=="}"){return F()}return a(x,n)}function J(V,W){if(V=="variable"){N(W);return F(I)}return F()}function I(V,W){if(W=="="){return F(z,I)}if(V==","){return F(J)}}function e(V){if(V=="var"){return F(J,d)}if(V==";"){return a(d)}if(V=="variable"){return F(K)}return a(d)}function K(V,W){if(W=="in"){return F(z)}return F(m,d)}function d(V,W){if(V==";"){return F(c)}if(W=="in"){return F(z)}return F(z,S(";"),c)}function c(V){if(V!=")"){F(z)}}function Q(V,W){if(V=="variable"){N(W);return F(Q)}if(V=="("){return F(P(")"),E,j(H,")"),q,x,G)}}function H(V,W){if(V=="variable"){N(W);return F()}}return{startState:function(V){return{tokenize:O,reAllowed:true,kwAllowed:true,cc:[],lexical:new D((V||0)-w,0,"block",false),localVars:M.localVars,context:M.localVars&&{vars:M.localVars},indented:0}},token:function(X,W){if(X.sol()){if(!W.lexical.hasOwnProperty("align")){W.lexical.align=false}W.indented=X.indentation()}if(X.eatSpace()){return null}var V=W.tokenize(X,W);if(U=="comment"){return V}W.reAllowed=!!(U=="operator"||U=="keyword c"||U.match(/^[\[{}\(,;:]$/));W.kwAllowed=U!=".";return s(W,V,U,o,X)},indent:function(aa,Y){if(aa.tokenize!=O){return 0}var Z=Y&&Y.charAt(0),W=aa.lexical;if(W.type=="stat"&&Z=="}"){W=W.prev}var X=W.type,V=Z==X;if(X=="vardef"){return W.indented+4}else{if(X=="form"&&Z=="{"){return W.indented}else{if(X=="stat"||X=="form"){return W.indented+w}else{if(W.info=="switch"&&!V){return W.indented+(/^(?:case|default)\b/.test(Y)?w:2*w)}else{if(W.align){return W.column+(V?0:1)}else{return W.indented+(V?0:w)}}}}}},electricChars:":{}"}});CodeMirror.defineMIME("text/javascript","javascript");CodeMirror.defineMIME("application/json",{name:"javascript",json:true});(function(){function c(h){var e={},f=h.split(" ");for(var d=0;d<f.length;++d){e[f[d]]=true}return e}function a(d){return function(f,e){if(f.match(d)){e.tokenize=null}else{f.skipToEnd()}return"string"}}var b={name:"clike",keywords:c("abstract and array as break case catch class clone const continue declare default do else elseif enddeclare endfor endforeach endif endswitch endwhile extends final for foreach function global goto if implements interface instanceof namespace new or private protected public static switch throw trait try use var while xor die echo empty exit eval include include_once isset list require require_once return print unset __halt_compiler self static parent"),blockKeywords:c("catch do else elseif for foreach if switch try while"),atoms:c("true false null TRUE FALSE NULL"),multiLineStrings:true,hooks:{"$":function(e,d){e.eatWhile(/[\w\$_]/);return"variable-2"},"<":function(e,d){if(e.match(/<</)){e.eatWhile(/[\w\.]/);d.tokenize=a(e.current().slice(3));return d.tokenize(e,d)}return false},"#":function(e,d){while(!e.eol()&&!e.match("?>",false)){e.next()}return"comment"},"/":function(e,d){if(e.eat("/")){while(!e.eol()&&!e.match("?>",false)){e.next()}return"comment"}return false}}};CodeMirror.defineMode("php",function(e,i){var j=CodeMirror.getMode(e,{name:"xml",htmlMode:true});var k=CodeMirror.getMode(e,"javascript");var f=CodeMirror.getMode(e,"css");var h=CodeMirror.getMode(e,b);function d(q,o){var n=o.mode=="php";if(q.sol()&&o.pending!='"'){o.pending=null}if(o.curMode==j){if(q.match(/^<\?\w*/)){o.curMode=h;o.curState=o.php;o.curClose="?>";o.mode="php";return"meta"}if(o.pending=='"'){while(!q.eol()&&q.next()!='"'){}var m="string"}else{if(o.pending&&q.pos<o.pending.end){q.pos=o.pending.end;var m=o.pending.style}else{var m=j.token(q,o.curState)}}o.pending=null;var p=q.current(),l=p.search(/<\?/);if(l!=-1){if(m=="string"&&/\"$/.test(p)&&!/\?>/.test(p)){o.pending='"'}else{o.pending={end:q.pos,style:m}}q.backUp(p.length-l)}else{if(m=="tag"&&q.current()==">"&&o.curState.context){if(/^script$/i.test(o.curState.context.tagName)){o.curMode=k;o.curState=k.startState(j.indent(o.curState,""));o.curClose=/^<\/\s*script\s*>/i;o.mode="javascript"}else{if(/^style$/i.test(o.curState.context.tagName)){o.curMode=f;o.curState=f.startState(j.indent(o.curState,""));o.curClose=/^<\/\s*style\s*>/i;o.mode="css"}}}}return m}else{if((!n||o.php.tokenize==null)&&q.match(o.curClose,n)){o.curMode=j;o.curState=o.html;o.curClose=null;o.mode="html";if(n){return"meta"}else{return d(q,o)}}else{return o.curMode.token(q,o.curState)}}}return{startState:function(){var l=j.startState();return{html:l,php:h.startState(),curMode:i.startOpen?h:j,curState:i.startOpen?h.startState():l,curClose:i.startOpen?/^\?>/:null,mode:i.startOpen?"php":"html",pending:null}},copyState:function(o){var m=o.html,n=CodeMirror.copyState(j,m),q=o.php,l=CodeMirror.copyState(h,q),p;if(o.curState==m){p=n}else{if(o.curState==q){p=l}else{p=CodeMirror.copyState(o.curMode,o.curState)}}return{html:n,php:l,curMode:o.curMode,curState:p,curClose:o.curClose,mode:o.mode,pending:o.pending}},token:d,indent:function(m,l){if((m.curMode!=h&&/^\s*<\//.test(l))||(m.curMode==h&&/^\?>/.test(l))){return j.indent(m.html,l)}return m.curMode.indent(m.curState,l)},electricChars:"/{}:"}},"xml","clike","javascript","css");CodeMirror.defineMIME("application/x-httpd-php","php");CodeMirror.defineMIME("application/x-httpd-php-open",{name:"php",startOpen:true});CodeMirror.defineMIME("text/x-php",b)})();CodeMirror.defineMode("ruby",function(k,h){function b(t){var s={};for(var p=0,q=t.length;p<q;++p){s[t[p]]=true}return s}var i=b(["alias","and","BEGIN","begin","break","case","class","def","defined?","do","else","elsif","END","end","ensure","false","for","if","in","module","next","not","or","redo","rescue","retry","return","self","super","then","true","undef","unless","until","when","while","yield","nil","raise","throw","catch","fail","loop","callcc","caller","lambda","proc","public","protected","private","require","load","require_relative","extend","autoload"]);var j=b(["def","class","case","for","while","do","module","then","catch","loop","proc","begin"]);var l=b(["end","until"]);var c={"[":"]","{":"}","(":")"};var m;function a(q,s,p){p.tokenize.push(q);return q(s,p)}function e(v,t){m=null;if(v.sol()&&v.match("=begin")&&v.eol()){t.tokenize.push(d);return"comment"}if(v.eatSpace()){return null}var s=v.next(),p;if(s=="`"||s=="'"||s=='"'||(s=="/"&&!v.eol()&&v.peek()!=" ")){return a(o(s,"string",s=='"'||s=="`"),v,t)}else{if(s=="%"){var q,w=false;if(v.eat("s")){q="atom"}else{if(v.eat(/[WQ]/)){q="string";w=true}else{if(v.eat(/[wxqr]/)){q="string"}}}var u=v.eat(/[^\w\s]/);if(!u){return"operator"}if(c.propertyIsEnumerable(u)){u=c[u]}return a(o(u,q,w,true),v,t)}else{if(s=="#"){v.skipToEnd();return"comment"}else{if(s=="<"&&(p=v.match(/^<-?[\`\"\']?([a-zA-Z_?]\w*)[\`\"\']?(?:;|$)/))){return a(f(p[1]),v,t)}else{if(s=="0"){if(v.eat("x")){v.eatWhile(/[\da-fA-F]/)}else{if(v.eat("b")){v.eatWhile(/[01]/)}else{v.eatWhile(/[0-7]/)}}return"number"}else{if(/\d/.test(s)){v.match(/^[\d_]*(?:\.[\d_]+)?(?:[eE][+\-]?[\d_]+)?/);return"number"}else{if(s=="?"){while(v.match(/^\\[CM]-/)){}if(v.eat("\\")){v.eatWhile(/\w/)}else{v.next()}return"string"}else{if(s==":"){if(v.eat("'")){return a(o("'","atom",false),v,t)}if(v.eat('"')){return a(o('"',"atom",true),v,t)}v.eatWhile(/[\w\?]/);return"atom"}else{if(s=="@"){v.eat("@");v.eatWhile(/[\w\?]/);return"variable-2"}else{if(s=="$"){v.next();v.eatWhile(/[\w\?]/);return"variable-3"}else{if(/\w/.test(s)){v.eatWhile(/[\w\?]/);if(v.eat(":")){return"atom"}return"ident"}else{if(s=="|"&&(t.varList||t.lastTok=="{"||t.lastTok=="do")){m="|";return null}else{if(/[\(\)\[\]{}\\;]/.test(s)){m=s;return null}else{if(s=="-"&&v.eat(">")){return"arrow"}else{if(/[=+\-\/*:\.^%<>~|]/.test(s)){v.eatWhile(/[=+\-\/*:\.^%<>~|]/);return"operator"}else{return null}}}}}}}}}}}}}}}}function n(){var p=1;return function(s,q){if(s.peek()=="}"){p--;if(p==0){q.tokenize.pop();return q.tokenize[q.tokenize.length-1](s,q)}}else{if(s.peek()=="{"){p++}}return e(s,q)}}function o(p,q,t,s){return function(w,v){var x=false,u;while((u=w.next())!=null){if(u==p&&(s||!x)){v.tokenize.pop();break}if(t&&u=="#"&&!x&&w.eat("{")){v.tokenize.push(n(arguments.callee));break}x=!x&&u=="\\"}return q}}function f(p){return function(s,q){if(s.match(p)){q.tokenize.pop()}else{s.skipToEnd()}return"string"}}function d(q,p){if(q.sol()&&q.match("=end")&&q.eol()){p.tokenize.pop()}q.skipToEnd();return"comment"}return{startState:function(){return{tokenize:[e],indented:0,context:{type:"top",indented:-k.indentUnit},continuedLine:false,lastTok:null,varList:false}},token:function(u,q){if(u.sol()){q.indented=u.indentation()}var p=q.tokenize[q.tokenize.length-1](u,q),t;if(p=="ident"){var s=u.current();p=i.propertyIsEnumerable(u.current())?"keyword":/^[A-Z]/.test(s)?"tag":(q.lastTok=="def"||q.lastTok=="class"||q.varList)?"def":"variable";if(j.propertyIsEnumerable(s)){t="indent"}else{if(l.propertyIsEnumerable(s)){t="dedent"}else{if((s=="if"||s=="unless")&&u.column()==u.indentation()){t="indent"}}}}if(m||(p&&p!="comment")){q.lastTok=s||m||p}if(m=="|"){q.varList=!q.varList}if(t=="indent"||/[\(\[\{]/.test(m)){q.context={prev:q.context,type:m||p,indented:q.indented}}else{if((t=="dedent"||/[\)\]\}]/.test(m))&&q.context.prev){q.context=q.context.prev}}if(u.eol()){q.continuedLine=(m=="\\"||p=="operator")}return p},indent:function(u,s){if(u.tokenize[u.tokenize.length-1]!=e){return 0}var t=s&&s.charAt(0);var q=u.context;var p=q.type==c[t]||q.type=="keyword"&&/^(?:end|until|else|elsif|when|rescue)\b/.test(s);return q.indented+(p?0:k.indentUnit)+(u.continuedLine?k.indentUnit:0)},electricChars:"}de"}});CodeMirror.defineMIME("text/x-ruby","ruby");CodeMirror.defineMode("htmlmixed",function(e,b){var h=CodeMirror.getMode(e,{name:"xml",htmlMode:true});var a=CodeMirror.getMode(e,"javascript");var j=CodeMirror.getMode(e,"css");function c(m,l){var k=h.token(m,l.htmlState);if(k=="tag"&&m.current()==">"&&l.htmlState.context){if(/^script$/i.test(l.htmlState.context.tagName)){l.token=i;l.localState=a.startState(h.indent(l.htmlState,""));l.mode="javascript"}else{if(/^style$/i.test(l.htmlState.context.tagName)){l.token=d;l.localState=j.startState(h.indent(l.htmlState,""));l.mode="css"}}}return k}function f(o,k,l){var n=o.current();var m=n.search(k);if(m>-1){o.backUp(n.length-m)}return l}function i(l,k){if(l.match(/^<\/\s*script\s*>/i,false)){k.token=c;k.localState=null;k.mode="html";return c(l,k)}return f(l,/<\/\s*script\s*>/,a.token(l,k.localState))}function d(l,k){if(l.match(/^<\/\s*style\s*>/i,false)){k.token=c;k.localState=null;k.mode="html";return c(l,k)}return f(l,/<\/\s*style\s*>/,j.token(l,k.localState))}return{startState:function(){var k=h.startState();return{token:c,localState:null,mode:"html",htmlState:k}},copyState:function(l){if(l.localState){var k=CodeMirror.copyState(l.token==d?j:a,l.localState)}return{token:l.token,localState:k,mode:l.mode,htmlState:CodeMirror.copyState(h,l.htmlState)}},token:function(l,k){return k.token(l,k)},indent:function(l,k){if(l.token==c||/^\s*<\//.test(k)){return h.indent(l.htmlState,k)}else{if(l.token==i){return a.indent(l.localState,k)}else{return j.indent(l.localState,k)}}},compareStates:function(l,k){if(l.mode!=k.mode){return false}if(l.localState){return CodeMirror.Pass}return h.compareStates(l.htmlState,k.htmlState)},electricChars:"/{}:"}},"xml","javascript","css");CodeMirror.defineMIME("text/html","htmlmixed");CodeMirror.defineMode("mysql",function(h){var e=h.indentUnit;var l;function c(n){return new RegExp("^(?:"+n.join("|")+")$","i")}var a=c(["str","lang","langmatches","datatype","bound","sameterm","isiri","isuri","isblank","isliteral","union","a"]);var f=c([("ACCESSIBLE"),("ALTER"),("AS"),("BEFORE"),("BINARY"),("BY"),("CASE"),("CHARACTER"),("COLUMN"),("CONTINUE"),("CROSS"),("CURRENT_TIMESTAMP"),("DATABASE"),("DAY_MICROSECOND"),("DEC"),("DEFAULT"),("DESC"),("DISTINCT"),("DOUBLE"),("EACH"),("ENCLOSED"),("EXIT"),("FETCH"),("FLOAT8"),("FOREIGN"),("GRANT"),("HIGH_PRIORITY"),("HOUR_SECOND"),("IN"),("INNER"),("INSERT"),("INT2"),("INT8"),("INTO"),("JOIN"),("KILL"),("LEFT"),("LINEAR"),("LOCALTIME"),("LONG"),("LOOP"),("MATCH"),("MEDIUMTEXT"),("MINUTE_SECOND"),("NATURAL"),("NULL"),("OPTIMIZE"),("OR"),("OUTER"),("PRIMARY"),("RANGE"),("READ_WRITE"),("REGEXP"),("REPEAT"),("RESTRICT"),("RIGHT"),("SCHEMAS"),("SENSITIVE"),("SHOW"),("SPECIFIC"),("SQLSTATE"),("SQL_CALC_FOUND_ROWS"),("STARTING"),("TERMINATED"),("TINYINT"),("TRAILING"),("UNDO"),("UNLOCK"),("USAGE"),("UTC_DATE"),("VALUES"),("VARCHARACTER"),("WHERE"),("WRITE"),("ZEROFILL"),("ALL"),("AND"),("ASENSITIVE"),("BIGINT"),("BOTH"),("CASCADE"),("CHAR"),("COLLATE"),("CONSTRAINT"),("CREATE"),("CURRENT_TIME"),("CURSOR"),("DAY_HOUR"),("DAY_SECOND"),("DECLARE"),("DELETE"),("DETERMINISTIC"),("DIV"),("DUAL"),("ELSEIF"),("EXISTS"),("FALSE"),("FLOAT4"),("FORCE"),("FULLTEXT"),("HAVING"),("HOUR_MINUTE"),("IGNORE"),("INFILE"),("INSENSITIVE"),("INT1"),("INT4"),("INTERVAL"),("ITERATE"),("KEYS"),("LEAVE"),("LIMIT"),("LOAD"),("LOCK"),("LONGTEXT"),("MASTER_SSL_VERIFY_SERVER_CERT"),("MEDIUMINT"),("MINUTE_MICROSECOND"),("MODIFIES"),("NO_WRITE_TO_BINLOG"),("ON"),("OPTIONALLY"),("OUT"),("PRECISION"),("PURGE"),("READS"),("REFERENCES"),("RENAME"),("REQUIRE"),("REVOKE"),("SCHEMA"),("SELECT"),("SET"),("SPATIAL"),("SQLEXCEPTION"),("SQL_BIG_RESULT"),("SSL"),("TABLE"),("TINYBLOB"),("TO"),("TRUE"),("UNIQUE"),("UPDATE"),("USING"),("UTC_TIMESTAMP"),("VARCHAR"),("WHEN"),("WITH"),("YEAR_MONTH"),("ADD"),("ANALYZE"),("ASC"),("BETWEEN"),("BLOB"),("CALL"),("CHANGE"),("CHECK"),("CONDITION"),("CONVERT"),("CURRENT_DATE"),("CURRENT_USER"),("DATABASES"),("DAY_MINUTE"),("DECIMAL"),("DELAYED"),("DESCRIBE"),("DISTINCTROW"),("DROP"),("ELSE"),("ESCAPED"),("EXPLAIN"),("FLOAT"),("FOR"),("FROM"),("GROUP"),("HOUR_MICROSECOND"),("IF"),("INDEX"),("INOUT"),("INT"),("INT3"),("INTEGER"),("IS"),("KEY"),("LEADING"),("LIKE"),("LINES"),("LOCALTIMESTAMP"),("LONGBLOB"),("LOW_PRIORITY"),("MEDIUMBLOB"),("MIDDLEINT"),("MOD"),("NOT"),("NUMERIC"),("OPTION"),("ORDER"),("OUTFILE"),("PROCEDURE"),("READ"),("REAL"),("RELEASE"),("REPLACE"),("RETURN"),("RLIKE"),("SECOND_MICROSECOND"),("SEPARATOR"),("SMALLINT"),("SQL"),("SQLWARNING"),("SQL_SMALL_RESULT"),("STRAIGHT_JOIN"),("THEN"),("TINYTEXT"),("TRIGGER"),("UNION"),("UNSIGNED"),("USE"),("UTC_TIME"),("VARBINARY"),("VARYING"),("WHILE"),("XOR"),("FULL"),("COLUMNS"),("MIN"),("MAX"),("STDEV"),("COUNT")]);var d=/[*+\-<>=&|]/;function b(s,p){var o=s.next();l=null;if(o=="$"||o=="?"){s.match(/^[\w\d]*/);return"variable-2"}else{if(o=="<"&&!s.match(/^[\s\u00a0=]/,false)){s.match(/^[^\s\u00a0>]*>?/);return"atom"}else{if(o=='"'||o=="'"){p.tokenize=m(o);return p.tokenize(s,p)}else{if(o=="`"){p.tokenize=j(o);return p.tokenize(s,p)}else{if(/[{}\(\),\.;\[\]]/.test(o)){l=o;return null}else{if(o=="-"){ch2=s.next();if(ch2=="-"){s.skipToEnd();return"comment"}}else{if(d.test(o)){s.eatWhile(d);return null}else{if(o==":"){s.eatWhile(/[\w\d\._\-]/);return"atom"}else{s.eatWhile(/[_\w\d]/);if(s.eat(":")){s.eatWhile(/[\w\d_\-]/);return"atom"}var q=s.current(),n;if(a.test(q)){return null}else{if(f.test(q)){return"keyword"}else{return"variable"}}}}}}}}}}}function m(n){return function(q,p){var s=false,o;while((o=q.next())!=null){if(o==n&&!s){p.tokenize=b;break}s=!s&&o=="\\"}return"string"}}function j(n){return function(q,p){var s=false,o;while((o=q.next())!=null){if(o==n&&!s){p.tokenize=b;break}s=!s&&o=="\\"}return"variable-2"}}function i(p,o,n){p.context={prev:p.context,indent:p.indent,col:n,type:o}}function k(n){n.indent=n.context.indent;n.context=n.context.prev}return{startState:function(n){return{tokenize:b,context:null,indent:0,col:0}},token:function(p,o){if(p.sol()){if(o.context&&o.context.align==null){o.context.align=false}o.indent=p.indentation()}if(p.eatSpace()){return null}var n=o.tokenize(p,o);if(n!="comment"&&o.context&&o.context.align==null&&o.context.type!="pattern"){o.context.align=true}if(l=="("){i(o,")",p.column())}else{if(l=="["){i(o,"]",p.column())}else{if(l=="{"){i(o,"}",p.column())}else{if(/[\]\}\)]/.test(l)){while(o.context&&o.context.type=="pattern"){k(o)}if(o.context&&l==o.context.type){k(o)}}else{if(l=="."&&o.context&&o.context.type=="pattern"){k(o)}else{if(/atom|string|variable/.test(n)&&o.context){if(/[\}\]]/.test(o.context.type)){i(o,"pattern",p.column())}else{if(o.context.type=="pattern"&&!o.context.align){o.context.align=true;o.context.col=p.column()}}}}}}}}return n},indent:function(s,p){var q=p&&p.charAt(0);var o=s.context;if(/[\]\}]/.test(q)){while(o&&o.type=="pattern"){o=o.prev}}var n=o&&q==o.type;if(!o){return 0}else{if(o.type=="pattern"){return o.col}else{if(o.align){return o.col+(n?0:1)}else{return o.indent+(n?0:e)}}}}}});CodeMirror.defineMIME("text/x-mysql","mysql");CodeMirror.defineMode("python",function(p,t){var f="error";function q(B){return new RegExp("^(("+B.join(")|(")+"))\\b")}var c=new RegExp("^[\\+\\-\\*/%&|\\^~<>!]");var A=new RegExp("^[\\(\\)\\[\\]\\{\\}@,:`=;\\.]");var a=new RegExp("^((==)|(!=)|(<=)|(>=)|(<>)|(<<)|(>>)|(//)|(\\*\\*))");var m=new RegExp("^((\\+=)|(\\-=)|(\\*=)|(%=)|(/=)|(&=)|(\\|=)|(\\^=))");var s=new RegExp("^((//=)|(>>=)|(<<=)|(\\*\\*=))");var j=new RegExp("^[_A-Za-z][_A-Za-z0-9]*");var l=q(["and","or","not","is","in"]);var u=["as","assert","break","class","continue","def","del","elif","else","except","finally","for","from","global","if","import","lambda","pass","raise","return","try","while","with","yield"];var x=["abs","all","any","bin","bool","bytearray","callable","chr","classmethod","compile","complex","delattr","dict","dir","divmod","enumerate","eval","filter","float","format","frozenset","getattr","globals","hasattr","hash","help","hex","id","input","int","isinstance","issubclass","iter","len","list","locals","map","max","memoryview","min","next","object","oct","open","ord","pow","property","range","repr","reversed","round","set","setattr","slice","sorted","staticmethod","str","sum","super","tuple","type","vars","zip","__import__","NotImplemented","Ellipsis","__debug__"];var e={builtins:["apply","basestring","buffer","cmp","coerce","execfile","file","intern","long","raw_input","reduce","reload","unichr","unicode","xrange","False","True","None"],keywords:["exec","print"]};var b={builtins:["ascii","bytes","exec","print"],keywords:["nonlocal","False","True","None"]};if(!!t.version&&parseInt(t.version,10)===3){u=u.concat(b.keywords);x=x.concat(b.builtins);var o=new RegExp("^(([rb]|(br))?('{3}|\"{3}|['\"]))","i")}else{u=u.concat(e.keywords);x=x.concat(e.builtins);var o=new RegExp("^(([rub]|(ur)|(br))?('{3}|\"{3}|['\"]))","i")}var n=q(u);var k=q(x);var w=null;function z(H,G){if(H.sol()){var F=G.scopes[0].offset;if(H.eatSpace()){var D=H.indentation();if(D>F){w="indent"}else{if(D<F){w="dedent"}}return null}else{if(F>0){i(H,G)}}}if(H.eatSpace()){return null}var E=H.peek();if(E==="#"){H.skipToEnd();return"comment"}if(H.match(/^[0-9\.]/,false)){var C=false;if(H.match(/^\d*\.\d+(e[\+\-]?\d+)?/i)){C=true}if(H.match(/^\d+\.\d*/)){C=true}if(H.match(/^\.\d+/)){C=true}if(C){H.eat(/J/i);return"number"}var B=false;if(H.match(/^0x[0-9a-f]+/i)){B=true}if(H.match(/^0b[01]+/i)){B=true}if(H.match(/^0o[0-7]+/i)){B=true}if(H.match(/^[1-9]\d*(e[\+\-]?\d+)?/)){H.eat(/J/i);B=true}if(H.match(/^0(?![\dx])/i)){B=true}if(B){H.eat(/L/i);return"number"}}if(H.match(o)){G.tokenize=v(H.current());return G.tokenize(H,G)}if(H.match(s)||H.match(m)){return null}if(H.match(a)||H.match(c)||H.match(l)){return"operator"}if(H.match(A)){return null}if(H.match(n)){return"keyword"}if(H.match(k)){return"builtin"}if(H.match(j)){return"variable"}H.next();return f}function v(E){while("rub".indexOf(E.charAt(0).toLowerCase())>=0){E=E.substr(1)}var D=E.length==1;var C="string";return function B(G,F){while(!G.eol()){G.eatWhile(/[^'"\\]/);if(G.eat("\\")){G.next();if(D&&G.eol()){return C}}else{if(G.match(E)){F.tokenize=z;return C}else{G.eat(/['"]/)}}}if(D){if(t.singleLineStringErrors){return f}else{F.tokenize=z}}return C}}function d(F,E,D){D=D||"py";var B=0;if(D==="py"){if(E.scopes[0].type!=="py"){E.scopes[0].offset=F.indentation();return}for(var C=0;C<E.scopes.length;++C){if(E.scopes[C].type==="py"){B=E.scopes[C].offset+p.indentUnit;break}}}else{B=F.column()+F.current().length}E.scopes.unshift({offset:B,type:D})}function i(G,F,E){E=E||"py";if(F.scopes.length==1){return}if(F.scopes[0].type==="py"){var D=G.indentation();var B=-1;for(var C=0;C<F.scopes.length;++C){if(D===F.scopes[C].offset){B=C;break}}if(B===-1){return true}while(F.scopes[0].offset!==D){F.scopes.shift()}return false}else{if(E==="py"){F.scopes[0].offset=G.indentation();return false}else{if(F.scopes[0].type!=E){return true}F.scopes.shift();return false}}}function y(F,D){w=null;var C=D.tokenize(F,D);var E=F.current();if(E==="."){C=F.match(j,false)?null:f;if(C===null&&D.lastToken==="meta"){C="meta"}return C}if(E==="@"){return F.match(j,false)?"meta":f}if((C==="variable"||C==="builtin")&&D.lastToken==="meta"){C="meta"}if(E==="pass"||E==="return"){D.dedent+=1}if(E==="lambda"){D.lambda=true}if((E===":"&&!D.lambda&&D.scopes[0].type=="py")||w==="indent"){d(F,D)}var B="[({".indexOf(E);if(B!==-1){d(F,D,"])}".slice(B,B+1))}if(w==="dedent"){if(i(F,D)){return f}}B="])}".indexOf(E);if(B!==-1){if(i(F,D,E)){return f}}if(D.dedent>0&&F.eol()&&D.scopes[0].type=="py"){if(D.scopes.length>1){D.scopes.shift()}D.dedent-=1}return C}var h={startState:function(B){return{tokenize:z,scopes:[{offset:B||0,type:"py"}],lastToken:null,lambda:false,dedent:0}},token:function(D,C){var B=y(D,C);C.lastToken=B;if(D.eol()&&D.lambda){C.lambda=false}return B},indent:function(C,B){if(C.tokenize!=z){return 0}return C.scopes[0].offset}};return h});CodeMirror.defineMIME("text/x-python","python");(function(){function l(){this.posFrom=this.posTo=this.query=null;this.marked=[]}function f(p){return p._searchState||(p._searchState=new l())}function n(p,q,s){return p.getSearchCursor(q,s,typeof q=="string"&&q==q.toLowerCase())}function a(p,t,q,s){if(p.openDialog){p.openDialog(t,s)}else{s(prompt(q,""))}}function m(q,t,s,p){if(q.openConfirm){q.openConfirm(t,p)}else{if(confirm(s)){p[0]()}}}function h(q){var p=q.match(/^\/(.*)\/([a-z]*)$/);return p?new RegExp(p[1],p[2].indexOf("i")==-1?"":"i"):q}var k='Search: <input type="text" style="width: 10em"/> <span style="color: #888">(Use /re/ syntax for regexp search)</span>';function j(p,q){var s=f(p);if(s.query){return d(p,q)}a(p,k,"Search for:",function(t){p.operation(function(){if(!t||s.query){return}s.query=h(t);if(p.lineCount()<2000){for(var u=n(p,t);u.findNext();){s.marked.push(p.markText(u.from(),u.to(),"CodeMirror-searching"))}}s.posFrom=s.posTo=p.getCursor();d(p,q)})})}function d(p,q){p.operation(function(){var s=f(p);var t=n(p,s.query,q?s.posFrom:s.posTo);if(!t.find(q)){t=n(p,s.query,q?{line:p.lineCount()-1}:{line:0,ch:0});if(!t.find(q)){return}}p.setSelection(t.from(),t.to());s.posFrom=t.from();s.posTo=t.to()})}function o(p){p.operation(function(){var s=f(p);if(!s.query){return}s.query=null;for(var q=0;q<s.marked.length;++q){s.marked[q].clear()}s.marked.length=0})}var e='Replace: <input type="text" style="width: 10em"/> <span style="color: #888">(Use /re/ syntax for regexp search)</span>';var c='With: <input type="text" style="width: 10em"/>';var i="Replace? <button>Yes</button> <button>No</button> <button>Stop</button>";function b(p,q){a(p,e,"Replace:",function(s){if(!s){return}s=h(s);a(p,c,"Replace with:",function(w){if(q){p.compoundChange(function(){p.operation(function(){for(var y=n(p,s);y.findNext();){if(typeof s!="string"){var x=p.getRange(y.from(),y.to()).match(s);y.replace(w.replace(/\$(\d)/,function(z,A){return x[A]}))}else{y.replace(w)}}})})}else{o(p);var v=n(p,s,p.getCursor());function t(){var y=v.from(),x;if(!(x=v.findNext())){v=n(p,s);if(!(x=v.findNext())||(y&&v.from().line==y.line&&v.from().ch==y.ch)){return}}p.setSelection(v.from(),v.to());m(p,i,"Replace?",[function(){u(x)},t])}function u(x){v.replace(typeof s=="string"?w:w.replace(/\$(\d)/,function(y,z){return x[z]}));t()}t()}})})}CodeMirror.commands.find=function(p){o(p);j(p)};CodeMirror.commands.findNext=j;CodeMirror.commands.findPrev=function(p){j(p,true)};CodeMirror.commands.clearSearch=o;CodeMirror.commands.replace=b;CodeMirror.commands.replaceAll=function(p){b(p,true)}})();CodeMirror.defineMode("xml",function(t,i){var s=t.indentUnit;var z=i.htmlMode?{autoSelfClosers:{area:true,base:true,br:true,col:true,command:true,embed:true,frame:true,hr:true,img:true,input:true,keygen:true,link:true,meta:true,param:true,source:true,track:true,wbr:true},implicitlyClosed:{dd:true,li:true,optgroup:true,option:true,p:true,rp:true,rt:true,tbody:true,td:true,tfoot:true,th:true,tr:true},contextGrabbers:{dd:{dd:true,dt:true},dt:{dd:true,dt:true},li:{li:true},option:{option:true,optgroup:true},optgroup:{optgroup:true},p:{address:true,article:true,aside:true,blockquote:true,dir:true,div:true,dl:true,fieldset:true,footer:true,form:true,h1:true,h2:true,h3:true,h4:true,h5:true,h6:true,header:true,hgroup:true,hr:true,menu:true,nav:true,ol:true,p:true,pre:true,section:true,table:true,ul:true},rp:{rp:true,rt:true},rt:{rp:true,rt:true},tbody:{tbody:true,tfoot:true},td:{td:true,th:true},tfoot:{tbody:true},th:{td:true,th:true},thead:{tbody:true,tfoot:true},tr:{tr:true}},doNotIndent:{pre:true},allowUnquoted:true,allowMissing:false}:{autoSelfClosers:{},implicitlyClosed:{},contextGrabbers:{},doNotIndent:{},allowUnquoted:false,allowMissing:false};var q=i.alignCDATA;var l,d;function b(G,F){function D(I){F.tokenize=I;return I(G,F)}var E=G.next();if(E=="<"){if(G.eat("!")){if(G.eat("[")){if(G.match("CDATA[")){return D(x("atom","]]>"))}else{return null}}else{if(G.match("--")){return D(x("comment","-->"))}else{if(G.match("DOCTYPE",true,true)){G.eatWhile(/[\w\._\-]/);return D(B(1))}else{return null}}}}else{if(G.eat("?")){G.eatWhile(/[\w\._\-]/);F.tokenize=x("meta","?>");return"meta"}else{d=G.eat("/")?"closeTag":"openTag";G.eatSpace();l="";var H;while((H=G.eat(/[^\s\u00a0=<>\"\'\/?]/))){l+=H}F.tokenize=o;return"tag"}}}else{if(E=="&"){var C;if(G.eat("#")){if(G.eat("x")){C=G.eatWhile(/[a-fA-F\d]/)&&G.eat(";")}else{C=G.eatWhile(/[\d]/)&&G.eat(";")}}else{C=G.eatWhile(/[\w\.\-:]/)&&G.eat(";")}return C?"atom":"error"}else{G.eatWhile(/[^&<]/);return null}}}function o(E,D){var C=E.next();if(C==">"||(C=="/"&&E.eat(">"))){D.tokenize=b;d=C==">"?"endTag":"selfcloseTag";return"tag"}else{if(C=="="){d="equals";return null}else{if(/[\'\"]/.test(C)){D.tokenize=f(C);return D.tokenize(E,D)}else{E.eatWhile(/[^\s\u00a0=<>\"\'\/?]/);return"word"}}}}function f(C){return function(E,D){while(!E.eol()){if(E.next()==C){D.tokenize=o;break}}return"string"}}function x(D,C){return function(F,E){while(!F.eol()){if(F.match(C)){E.tokenize=b;break}F.next()}return D}}function B(C){return function(F,E){var D;while((D=F.next())!=null){if(D=="<"){E.tokenize=B(C+1);return E.tokenize(F,E)}else{if(D==">"){if(C==1){E.tokenize=b;break}else{E.tokenize=B(C-1);return E.tokenize(F,E)}}}}return"meta"}}var j,e;function a(){for(var C=arguments.length-1;C>=0;C--){j.cc.push(arguments[C])}}function c(){a.apply(null,arguments);return true}function h(C,E){var D=z.doNotIndent.hasOwnProperty(C)||(j.context&&j.context.noIndent);j.context={prev:j.context,tagName:C,indent:j.indented,startOfLine:E,noIndent:D}}function v(){if(j.context){j.context=j.context.prev}}function n(C){if(C=="openTag"){j.tagName=l;return c(k,m(j.startOfLine))}else{if(C=="closeTag"){var D=false;if(j.context){if(j.context.tagName!=l){if(z.implicitlyClosed.hasOwnProperty(j.context.tagName.toLowerCase())){v()}D=!j.context||j.context.tagName!=l}}else{D=true}if(D){e="error"}return c(y(D))}}return c()}function m(C){return function(D){if(D=="selfcloseTag"||(D=="endTag"&&z.autoSelfClosers.hasOwnProperty(j.tagName.toLowerCase()))){A(j.tagName.toLowerCase());return c()}if(D=="endTag"){A(j.tagName.toLowerCase());h(j.tagName,C);return c()}return c()}}function y(C){return function(D){if(C){e="error"}if(D=="endTag"){v();return c()}e="error";return c(arguments.callee)}}function A(C){var D;while(true){if(!j.context){return}D=j.context.tagName.toLowerCase();if(!z.contextGrabbers.hasOwnProperty(D)||!z.contextGrabbers[D].hasOwnProperty(C)){return}v()}}function k(C){if(C=="word"){e="attribute";return c(p,k)}if(C=="endTag"||C=="selfcloseTag"){return a()}e="error";return c(k)}function p(C){if(C=="equals"){return c(w,k)}if(!z.allowMissing){e="error"}return(C=="endTag"||C=="selfcloseTag")?a():c()}function w(C){if(C=="string"){return c(u)}if(C=="word"&&z.allowUnquoted){e="string";return c()}e="error";return(C=="endTag"||C=="selfCloseTag")?a():c()}function u(C){if(C=="string"){return c(u)}else{return a()}}return{startState:function(){return{tokenize:b,cc:[],indented:0,startOfLine:true,tagName:null,context:null}},token:function(F,E){if(F.sol()){E.startOfLine=true;E.indented=F.indentation()}if(F.eatSpace()){return null}e=d=l=null;var D=E.tokenize(F,E);E.type=d;if((D||d)&&D!="comment"){j=E;while(true){var C=E.cc.pop()||n;if(C(d||D)){break}}}E.startOfLine=false;return e||D},indent:function(F,D,E){var C=F.context;if((F.tokenize!=o&&F.tokenize!=b)||C&&C.noIndent){return E?E.match(/^(\s*)/)[0].length:0}if(q&&/<!\[CDATA\[/.test(D)){return 0}if(C&&/^<\//.test(D)){C=C.prev}while(C&&!C.startOfLine){C=C.prev}if(C){return C.indent+s}else{return 0}},compareStates:function(F,D){if(F.indented!=D.indented||F.tokenize!=D.tokenize){return false}for(var E=F.context,C=D.context;;E=E.prev,C=C.prev){if(!E||!C){return E==C}if(E.tagName!=C.tagName){return false}}},electricChars:"/"}});CodeMirror.defineMIME("application/xml","xml");if(!CodeMirror.mimeModes.hasOwnProperty("text/html")){CodeMirror.defineMIME("text/html",{name:"xml",htmlMode:true})}var ansispan=function(c){var b=c.split("\033[0m");for(var a in b){if(!b[a].match(/\033\[[^m]*m/)){b[a]="<span>"+b[a]}else{b[a]=b[a].replace(/\033\[([^m]*)m/,function(d,i){var e=i.split(";");var h='<span style="';for(var f in e){h+=ansispan.styles[e[f]]||""}h+='">';return h})}}return b.join("</span>")+"</span>"};var validANSI=function(b){var a=b.split("\033[0m");return !a[a.length-1].match(/\033\[[^m]*m/)};ansispan.styles={"30":"color: black; ","31":"color: red; ","32":"color: green; ","33":"color: yellow; ","35":"color: purple; ","36":"color: cyan; ","37":"color: white; ","1":"font-weight: bold; ","3":"font-style: italic; ","4":"text-decoration: underline; "};if(typeof module=="object"&&typeof window=="undefined"){module.exports=ansispan}var CS50=CS50||{};CS50.Run=function(b){this.options=b;if(!this.options.container){throw"Error: You must define a container for run50!"}this.options.defaultCode=(b.defaultCode===undefined)?false:b.defaultCode;this.options.defaultLanguage=(b.defaultLanguage===undefined)?"C":b.defaultLanguage;this.options.endpoint=(b.endpoint===undefined)?"https://run.cs50.net/":b.endpoint;this.options.languages=(b.languages===undefined)?["C","Java","PHP","Python","Ruby"]:b.languages;this.options.onCreate=(b.onCreate===undefined)?false:b.onCreate;this.options.onDownload=(b.onDownload===undefined)?false:b.onDownload;this.options.onLoadFromHistory=(b.onLoadFromHistory===undefined)?false:b.onLoadFromHistory;this.options.onSave=(b.onSave===undefined)?false:b.onSave;this.options.prompt=(b.prompt===undefined)?"jharvard@run.cs50.net (~):":b.prompt;this.options.endpoint=this.options.endpoint.replace(/\/+$/,"");if(!this.options.endpoint.match(/^https?:\/\//)){this.options.endpoint=[window.location.protocol,"//",window.location.host].join("")+this.options.endpoint}if(!this.options.endpoint.match(/:\d+$/)){if(this.options.endpoint.match(/^https:\/\//)){this.options.endpoint+=":443"}else{this.options.endpoint+=":80"}}this.commands={"text/x-csrc":[{command:"clang file.c",args:"-std=c99 -Wall -Werror -fcolor-diagnostics -lcs50 -lm"},{command:"./a.out",args:""}],"text/x-java":[{command:"javac -J-Xmx128M file.java",args:""},{command:"java -Xmx64M",args:"Main"}],"text/x-php":[{command:"php file.php",args:""}],"text/x-python":[{command:"python file.py",args:""}],"text/x-ruby":[{command:"ruby file.rb",args:""}]};this.extensions={"text/x-csrc":"c","text/x-java":"java","text/x-php":"php","text/x-python":"py","text/x-ruby":"rb"};this.languageNames={C:"text/x-csrc",Java:"text/x-java",PHP:"text/x-php",Python:"text/x-python",Ruby:"text/x-ruby"};this.samples={"text/x-csrc":'#include <cs50.h>\n#include <stdio.h>\n\nint main(int argc, char* argv[])\n{\n    printf("Enter your name: ");\n    string s = GetString();\n    printf("Hello, %s!\\n", s);\n    return 0;\n}\n',"text/x-java":'class Main {\n    public static void main(String[] args) {\n        System.out.println("Hello, run50!");\n    }\n}\n',"text/x-php":'<?php\n\necho "Hello, run50!\\n";\n\n?>\n',"text/x-python":'print "Hello, run50!"',"text/x-ruby":'puts "Hello, run50!"'};var c={editor:'             <div class="run50-container">                 <form class="form-download" method="post" action="<%= endpoint %>/save">                     <input type="hidden" />                 </form>                 <div class="run50-controls">                     <button class="btn-run">                        <div class="run-img"></div>                        <div class="paused-img"></div>                     </button>                     <div class="run50-lang-wrapper">                         <select class="run50-lang chzn-select">                             <% for (var i in languages) { %>                                 <option value="<%= languageNames[languages[i]] %>"><%= languages[i] %></option>                             <% } %>                         </select>                    </div>                     <div class="btn-options">                         <div class="gear-btn"></div>                     </div>                     <div class="btn-history-group">                         <button class="btn-download">                             <div class="download-icon"></i>                         </button>                         <button class="btn-save disabled btn-left">                             <div class="save-icon"></i>                         </button><button class="btn-save-star disabled btn-middle">                             <div class="save-icon-star"></i>                         </button><button class="btn-history btn-right">                             <div class="history-icon"></i>                         </button>                     </div>                     <div class="run50-status">                         <span class="status-text"></span>                         <div class="status-loader"></div>                     </div>                     <div class="run50-options"></div>                 </div>                 <div class="run50-history-wrapper">                     <ul class="run50-history">                     </ul>                 </div>                 <div class="run50-split-container">                     <div class="run50-code-container">                         <textarea class="run50-code"><%= samples[languageNames[defaultLanguage]] %></textarea>                     </div>                     <div class="run50-splitter">&equiv;&equiv;&equiv;</div>                     <div class="run50-console-container">                         <div class="run50-console-clear">&times;</div>                         <pre class="run50-console"><div contenteditable="false" class="run50-input active"></div></pre>                     </div>                 </div>             </div>         ',runOption:'             <div data-id-command="<%= cmd.command %>" spellcheck="false"><%= cmd.command %></div>             <div type="text" contenteditable="true" spellcheck="false"><%= cmd.args %></div>             <div class="divider"></div>         ',historyItem:'             <li class="history-item">                 <div class="revision">                     Revision <%= revision %>                 </div>                 <div class="timestamp">                     <%= new Date(item.timestamp).toString("ddd, MMM d yyyy, h:mm:ss tt") %>                 </div>                 <%= item.starred ? \'<span class="star-icon"></span>\' : \'\' %>             </li>         '};this.templates={};for(var a in c){this.templates[a]=_.template(c[a])}this.createEditor()};CS50.Run.prototype.createEditor=function(){var d=this;var h=$(this.options.container);function a(){h.show();$(window).trigger("resize")}h.hide();h.html(this.templates.editor({defaultLanguage:this.options.defaultLanguage,endpoint:this.options.endpoint,languages:this.options.languages,languageNames:this.languageNames,samples:this.samples}));this.editor=CodeMirror.fromTextArea(h.find(".run50-code")[0],{indentUnit:4,lineNumbers:true,lineWrapping:true,onKeyEvent:function(){d.dirty();h.find(".run50-history .history-item.active").removeClass("active")}});var b=function(){var j=h.height();h.find(".run50-controls, .run50-splitter, .run50-console-container").each(function(k,l){j-=$(l).outerHeight()});var i=h.width();h.find(".CodeMirror").width(i).height(j);h.find(".CodeMirror-gutter, .CodeMirror-scrollbar, .CodeMirror-scroll").height(j);h.find(".run50-container, .run50-controls, .run50-console-container, .run50-splitter").width(i)};b();$(window).on("resize",function(){b()});$(window).on("beforeunload",function(){if(!$(d.options.container).find(".btn-save").hasClass("disabled")){d.save(false,false)}});h.on("click",".btn-run",function(){if($(this).hasClass("running")){d.socket.emit("SIGINT");h.find(".run50-input.active").after("^C\n")}else{if(!$(this).hasClass("uploading")){$(this).addClass("uploading");$(".run50-status .status-loader").fadeIn();$(".run50-controls").removeClass(".success, .error");d.run()}}});h.on("click",".btn-save",function(){if(!$(this).is(".disabled")){d.save()}});h.on("click",".btn-save-star",function(){if(!$(this).is(".disabled")){d.save(true)}});h.on("click",".btn-download",function(){d.download()});h.on("click",".run50-history .history-item",function(){if(!$(this).is(".active")){d.loadFromHistory($(this).index())}});h.on("click",".btn-history",function(i){if($(this).is(".active")){$(this).removeClass("active");h.find(".run50-history-wrapper").fadeOut(200)}else{$(this).addClass("active");h.find(".run50-history-wrapper").fadeIn(200)}});h.on("keyup",".run50-input",function(i){if(i.ctrlKey){if(i.which==67){d.socket.emit("SIGINT");h.find(".run50-input.active").after("^C\n")}else{if(i.which==68){d.socket.emit("EOF")}}}if(i.which==9){return false}});h.on("change",".run50-lang",function(){d.setLanguage($(this).val())});h.on("click",".btn-options",function(){$options=h.find(".run50-options");function j(m){m.focus();if(typeof window.getSelection!="undefined"&&typeof document.createRange!="undefined"){var l=document.createRange();l.selectNodeContents(m);l.collapse(false);var n=window.getSelection();n.removeAllRanges();n.addRange(l)}else{if(typeof document.body.createTextRange!="undefined"){var k=document.body.createTextRange();k.moveToElementText(m);k.collapse(false);k.select()}}}var i=h.find(".run50-options").height();if($options.is(":visible")){h.find(".run50-options").slideUp(150);h.find(".CodeMirror").animate({height:"+="+i},150);h.find(".CodeMirror-gutter, .CodeMirror-scrollbar, .CodeMirror-scroll").animate({height:"+="+i},150);h.find(".btn-options").removeClass("active")}else{h.find(".run50-options").slideDown(150,function(){j($(this).find("[contenteditable]").first()[0])});h.find(".CodeMirror").animate({height:"-="+i},150);h.find(".CodeMirror-gutter, .CodeMirror-scrollbar, .CodeMirror-scroll").animate({height:"-="+i},150);h.find(".btn-options").addClass("active")}});h.on("keydown",".run50-options div",function(i){if(i.which==13){i.preventDefault();return false}});$(window).click(function(i){if($(i.target).closest(h.find(".btn-history, .btn-save, .btn-save-star")).length>0){return false}if($(i.target).closest(h.find(".run50-history-wrapper")).length==0){h.find(".run50-history-wrapper").fadeOut(200);h.find(".btn-history").removeClass("active")}});var e=0;var c=0;h.find(".run50-splitter").draggable({axis:"y",drag:function(j,l){var i=e+l.position.top;var k=c-l.position.top;if(i>100&&k>50){h.find(".CodeMirror, .CodeMirror-gutter, .CodeMirror-scrollbar, .CodeMirror-scroll").height(e+l.position.top);h.find(".run50-console-container").height(c-l.position.top)}else{return false}},start:function(i,j){e=h.find(".CodeMirror").height();c=h.find(".run50-console-container").height()}});h.on("blur",".run50-options [contenteditable]",function(){var i=this;h.find(".run50-options [contenteditable]").each(function(j,k){if(i==this){d.commands[d.language][j].args=$(this).text()}})});h.on("click",".run50-console",function(){$(this).find(".run50-input").focus()});h.on("click",".run50-console-clear",function(){var j=h.find(".run50-input.active");var i=h.find(".run50-console").empty();j.appendTo(i).focus()});h.on("keypress",".run50-input.active",function(i){if(i.which==13){i.preventDefault();if($(this).text().length+1>1048576){d.socket.emit("SIGINT");return false}else{d.socket.emit("stdin",$(this).text()+"\n");$(this).removeClass("active").attr("contenteditable",false).after("\n");$console=$(this).parents(".run50-console");$console.append('<div class="run50-input active" contenteditable="true"></div>');$console.find(".run50-input.active").focus()}}});if(this.options.onCreate){this.options.onCreate(this,a)}else{var f=this.getHistory();if(f.length&&f[0].content&&f[0].language){this.renderHistory(f);this.setCode(f[0].content);this.setLanguage(f[0].language);h.find(".run50-history .history-item:first-child").addClass("active")}else{this.setCode(this.options.defaultCode||this.samples[this.languageNames[this.options.defaultLanguage]]);this.setLanguage(this.languageNames[this.options.defaultLanguage])}a()}};CS50.Run.prototype.dirty=function(){$(this.options.container).find(".btn-save, .btn-save-star").removeClass("disabled")};CS50.Run.prototype.download=function(){var a=$(this.options.container).find(".form-download");a.find("input").attr("name","file."+this.extensions[this.language]).attr("value",this.getCode());a.submit();if(this.options.onDownload){this.options.onDownload()}};CS50.Run.prototype.escape=function(b){var a=b.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;");return a};CS50.Run.prototype.execute=function(d){var h=d.shift();if(h){this.socket=io.connect(this.options.endpoint,{"force new connection":true});var f=$(this.options.container);var e=f.find(".run50-console");var a=f.find(".run50-status .status-text");a.text((d.length)?"Building...":"Running...");f.find(".run50-input.active").text(h).removeClass("active").after("\n");f.find(".run50-console").append('<div class="run50-input active" contenteditable="true"></div>');f.find(".run50-input.active").focus();this.scroll(f);var c=this;this.socket.on("success",function(i){c.socket.disconnect();if(i.code!==0){c.failure($(c.options.container))}else{c.newline(f,d.length===0);if(d.length===0){a.text("Run successful!");setTimeout(function(){f.find(".btn-run").removeClass("uploading running");f.find(".run50-status .status-loader").fadeOut();f.find(".run50-status").addClass("success")},300);setTimeout(function(){if(a.text()=="Run successful!"){$(".run50-status").removeClass("success")}a.fadeOut(function(){a.text("");a.show()})},2000)}else{c.sandbox=i.sandbox;c.execute(d)}}});this.socket.on("error",function(i){c.socket.disconnect();c.failure($(c.options.container),i.error.code)});this.socket.on("stdout",function(k){var i=$("<span>").text(c.escape(k));var l=f.find(".run50-input.active").before(i);var j=i.position().left-parseInt($(c.options.container).find(".run50-console").css("padding-left"))+i.width();l.css({"text-indent":j,"min-width":j,"margin-left":-j});i.replaceWith(i.text());c.scroll(f)});var b="";this.socket.on("stderr",function(i){b+=c.escape(i);if(validANSI(b)){var j=ansispan(b).replace(/\r\n<\/span>/g,"</span><br/>").replace(/\n<\/span>/g,"</span><br/>").replace(/<span>\r\n/g,"<br/><span>").replace(/<span>\n/g,"<br/><span>");f.find(".run50-input.active").before(j);c.scroll(f);b=""}});this.socket.emit("run",{cmd:h,sandbox:this.sandbox})}};CS50.Run.prototype.loadFromHistory=function(a,b){if(this.options.onLoadFromHistory){this.options.onLoadFromHistory(a)}else{var c=this.getHistory();this.setCode(c[a].content);this.setLanguage(c[a].language)}var d=$(this.options.container);d.find(".run50-history .active").removeClass("active");d.find(".run50-history li:nth-child("+parseInt(a+1)+")").addClass("active");if(!b){this.dirty()}};CS50.Run.prototype.failure=function(d,b){var a=this;var c="An error occurred.";switch(b){case"E_EXCESS":c="Your program generated too much output!";break;case"E_TIMEOUT":c="Your program took too long to run!";break;case"E_KILLED":c="Your program was terminated!";break;case"E_USAGE":c="CS50 Run was used incorrectly";break;case"E_USER_SERVER_DOWN":c="CS50 Run seems to be down. Wait and try again?";break;case"E_USER_UPLOAD_ERROR":c="Upload failed! Wait and try again?";break}d.find(".run50-status .status-text").text(c);d.find(".run50-status").addClass("error");setTimeout(function(){$(".run50-status").removeClass("error success")},2000);d.find(".btn-run").removeClass("uploading running");d.find(".run50-status .status-loader").fadeOut();a.newline(d,true)};CS50.Run.prototype.getCode=function(){return this.editor.getValue()};CS50.Run.prototype.getHistory=function(){var a=sessionStorage[this.getNamespace()];if(!a){return[]}a=JSON.parse(a);return(a&&a.history)?a.history:[]};CS50.Run.prototype.getNamespace=function(){return window.location.href.replace(/#/g,"")};CS50.Run.prototype.newline=function(d,c){d.find(".run50-input.active").removeClass("active").attr("contenteditable",false);var e=$('<div class="run50-input active" contenteditable="false"></div>');if(!c){var a=$("<span>"+this.options.prompt+" </span>");d.find(".run50-console").append(a);var b=a.position().left-parseInt($(this.options.container).find(".run50-console").css("padding-left"))+a.width();e.css({"text-indent":b,"min-width":b,"margin-left":-b});a.replaceWith(a.text())}d.find(".run50-console").append(e);this.scroll(d)};CS50.Run.prototype.run=function(){var a=_.map(this.commands[this.language].slice(0),function(b){return b.command+" "+b.args});this.upload("file."+this.extensions[this.language],a)};CS50.Run.prototype.save=function(h,b){if(b===undefined){b=true}var c=this;function e(){var i=$(c.options.container).find(".run50-history");i.find(".active").removeClass("active");i.find(".history-item:first-child").addClass("active");$(c.options.container).find(".btn-save, .btn-save-star").addClass("disabled")}var a="file."+this.extensions[this.language];if(this.options.onSave){this.options.onSave(this.language,a,this.getCode(),!!h,e,b)}else{var d=this.getHistory();d.unshift({content:this.getCode(),file:a,language:this.language,timestamp:(new Date()).toString(),starred:!!h});this.setHistory(d);e()}var f=$(this.options.container);f.find(".run50-status .status-text").text("Revision saved!");f.find(".run50-status").addClass("success");setTimeout(function(){f.find(".run50-status .status-text").text("");f.find(".run50-status").removeClass("error success")},2000)};CS50.Run.prototype.setCode=function(b){var a=this;setTimeout(function(){a.editor.setValue(b)},1)};CS50.Run.prototype.setHistory=function(b){var a=sessionStorage[this.getNamespace()];a=(a)?JSON.parse(a):{};a.history=b;sessionStorage[this.getNamespace()]=JSON.stringify(a);this.renderHistory(b);$(this.options.container).find(".run50-history .history-item:first-child").addClass("active")};CS50.Run.prototype.renderHistory=function(d){var c=this;var b=$(this.options.container).find(".run50-history");b.empty();var a=d.length;$.each(d,function(f,h){var e=c.templates.historyItem({item:h,revision:a--,});b.append(e)})};CS50.Run.prototype.setLanguage=function(c){var d=$(this.options.container);this.language=c;this.editor.setOption("mode",c);d.find(".run50-lang").val(c);var b=this;var a=d.find(".run50-options").empty();_.each(this.commands[c],function(f){a.append(b.templates.runOption({cmd:f}))})};CS50.Run.prototype.scroll=function(a){a.find(".run50-console").scrollTop(999999)};CS50.Run.prototype.upload=function(d,b){var e=this;var i=$(e.options.container).find(".run50-status .status-text");i.text("Uploading source code...");var e=this;var a={};a[d]=this.editor.getValue();var j=$(this.options.container);var f=j.find(".btn-run");var c=function(k){h.abort()};var h=$.ajax({data:a,dataType:"json",type:"post",url:this.options.endpoint+"/upload",xhrFields:{withCredentials:true},beforeSend:function(k){f.click(c);setTimeout(function(){if(k.readyState==0){k.abort()}},10000)},success:function(n,p,l){var k=$("<span>"+e.options.prompt+" </span>");var o=$(e.options.container).find(".run50-input.active").before(k);var m=k.position().left-parseInt($(e.options.container).find(".run50-console").css("padding-left"))+k.width();o.css({"text-indent":m,"min-width":m,"margin-left":-m});k.replaceWith(k.text());f.removeClass("uploading").addClass("running");e.sandbox={homedir:n.id};e.execute(b)},error:function(n,l,m){var k;if(n.readyState===0||(n.readyState==4&&n.status!==200)){e.failure($(e.options.container),"E_USER_SERVER_DOWN")}else{e.failure($(e.options.container),"E_USER_UPLOAD_ERROR")}},complete:function(k,l){f.unbind("click",c)}});return false};